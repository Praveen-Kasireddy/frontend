...
mxVertexHandler.prototype.resizeCell = function(cell, dx, dy, index, gridEnabled, constrained, recurse) {
    ...
    if (geo != null) {
        if (index == mxEvent.LABEL_HANDLE) {
            ...
            // // 06.06.2018 KDEV_CT
            // if (this.unscaledBounds.x < 250) {
            //     this.unscaledBounds.x = 200;
            // }
            // if (this.unscaledBounds.x > 250 && this.unscaledBounds.x < 450) {
            //     this.unscaledBounds.x = 400;
            // }

            // Graph.prototype.fireEvent(
            //     new mxEventObject(
            //         'VertexResizeCell',
            //         'cell',
            //         cell,
