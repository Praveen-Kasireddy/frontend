(function(stylesheet, stencils) {
    ...
    mxGraph.prototype.getImageFromBundles = function(key) {
        if (key != null) {
            if (
                key.substring(0, 7) != 'http://' &&
                key.substring(0, 8) != 'https://' &&
                key.substring(0, 10) != 'data:image'
            ) {
                if (key.charAt(0) == '/') {
        ...
        function initGraph(container) {
            try {
                ...
                if (xmlDocument.documentElement != null && xmlDocument.documentElement.nodeName == 'mxGraphModel') {
                    ...
                    if (
                        (container.style.width != '100%' && fit != '1' && resize != '0') ||
                    ...
                    if (links != '0' || tooltips != '0') {
                        ...
                        graph.addMouseListener({
                            ...
                            currentLink: null,
                            highlight:
                                hl != null && hl != '' && hl != mxConstants.NONE
                                    ? new mxCellHighlight(graph, hl, 2)
                                    : null,
                            startX: 0,
                            startY: 0,
                    ...
                    if (url != null) {
                        try {
                            ...
                            var xhr =
                                navigator.userAgent.indexOf('MSIE 9') > 0 ? new XDomainRequest() : new XMLHttpRequest();
                            xhr.open('GET', url);
