...
/* Header */
const headerTL = element(by.xpath('(//div[@_ngcontent-c13=""]/div[@class="header-subtitle"])'));
const headerTL_text = "Task List ";

/* assigned tasks */
const task01 = element(by.xpath('(//kosmos-task[@_ngcontent-c42=""])[1]'));
const task02 = element(by.xpath('(//kosmos-task[@_ngcontent-c42=""])[2]'));
const task03 = element(by.xpath('(//kosmos-task[@_ngcontent-c42=""])[3]')); // P&L overview: click here
const task04 = element(by.xpath('(//kosmos-task[@_ngcontent-c42=""])[4]'));
...
const saveSelectionArrow = element(by.xpath('(//i _ngcontent - c54="" class="kpmg-icon kpmg-icon-arrow-down" > </i>
const saveItem01 = element(by.xpath('(//kosmos-menu-item[@_ngcontent-c51=""])[1]')); // Save
const saveItem02 = element(by.xpath('(//kosmos-menu-item[@_ngcontent-c51=""])[2]')); // Save as template
...
const notStartedItem01 = element(by.xpath('(//div[@_ngcontent-c17=""]/span[@_ngcontent-c12=""])[1]')); // Not started
const notStartedItem02 = element(by.xpath('(//div[@_ngcontent-c17=""]/span[@_ngcontent-c12=""])[2]')); // in progress
const notStartedItem03 = element(by.xpath('(//div[@_ngcontent-c17=""]/span[@_ngcontent-c12=""])[3]')); // Submitted for review
const notStartedItem04 = element(by.xpath('(//div[@_ngcontent-c17=""]/span[@_ngcontent-c12=""])[4]')); // Done

const previewButton = element(by.xpath('(//div[@class="dx-button-content"]/span[text() = "Preview"])'));
const addPageButton = element(by.xpath('(//button[@_ngcontent-c12=""]/span[@class="kpmg-icon kpmg-icon-toolbar-page-add"])'));
const toolbarTextButton = element(by.xpath('(//div[@class="dx-button-content"]/i[@class="dx-icon kpmg-icon kpmg-icon-toolbar-text"])'));

const addNewAnalysisButton = element(by.xpath('(//button[@_ngcontent-c12=""]/span[@class="kpmg-icon kpmg-icon-table-chart"])'));
const newAnalysisItem01 = element(by.xpath('(//kosmos-menu-item[@class="analysis ng-tns-c17-12 ng-star-inserted"])'));
...
const deletePageButton = element(by.xpath('(//dx-button[@aria-label="kpmg-icon kpmg-icon-delete-page"])'));
...
const TaskListPage = Object.create(NavigationPage, {
    ...
    /* Navigation */
    getnavTaskListButton: { get: function () { return navTaskListButton; } },
