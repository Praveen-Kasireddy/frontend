...
(c) XB Software Ltd.
*/
window.webix||(webix={}),webix.version="5.4.0",webix.codebase="./",webix.name="core",webix.cdn="//cdn.webix.com",webix.clone=function(t){var e=webix.clone.a;return e.prototype=t,new e},webix.clone.a=function(){},webix.extend=function(t,e,i){if(t.$protoWait)return webix.PowerArray.insertAt.call(t.$protoWait,e,1),
...
var i=this.gd.$getSize(0,0),s=this.s.Ob;s&&(t+=(s.left?0:1)+(s.right?0:1),e+=(s.top?0:1)+(s.bottom?0:1));var n=0,a=webix.ui.baseview.prototype.$getSize.call(this,0,0);a[0]=(a[0]||i[0])+t,a[1]>=1e5&&(a[1]=i[1]),a[1]+=t,a[2]=(a[2]||i[2])+e;var r=a[3]<1e5;return r||(a[3]=i[3]),a[3]+=e,this.getParentView().mc?this.s.collapsed?a[2]=a[3]=this.hd():this.s.header&&(n=this.s.headerHeight):(this.s.collapsed&&(a[0]=a[1]=this.hd()),
...
pe:function(){var t=this.s,e=this.re().childNodes[1],i=e.previousSibling,s="next"==t.type?"right":"left",n=t.aheight-2*webix.skin.$active.inputPadding-2*this.ZE,a=n*this.ue/2;e.style.width=a+"px",e.style.height=a+"px",e.style.top=(n-a)/2+webix.skin.$active.inputPadding+"px",e.style[s]=(n-a)/2+this.ue/2+"px",
...
name:"text",$allowsClear:!0,De:function(){this.$allowsClear&&(this._E||webix.UE(this.getInputNode(),"change",this.Xy,{bind:this}),this.s.suggest&&webix.$$(this.s.suggest).linkInput(this))},Xy:function(){var t=this.getValue();t!=this.s.value?this.setValue(t,!0):this.nH&&this.$setValue(t)},$skin:function(){
...
var e=webix.$$(t);if(e)return webix.$$(t).s.id;t={body:{url:t,dataFeed:t}}}else webix.isArray(t)?t={body:{data:this.Be(t)}}:t.body||(t.body={});webix.extend(t,{view:"suggest"});var i=webix.ui(t);return this.Ns.push(i),i.s.id}return!1}},webix.ui.button),webix.protoUI({name:"segmented",$allowsClear:!1,
$init:function(){this.attachEvent("onChange",function(t){this.s.multiview&&this.aF(t)}),this.attachEvent("onAfterRender",webix.once(function(){this.s.multiview&&this.s.value&&this.aF(this.s.value)}))},aF:function(t){var e=this.getTopParentView(),i=null;e&&e.$$&&(i=e.$$(t)),i||(i=webix.$$(t)),i&&i.show&&i.show();
},defaults:{template:function(t,e){!t.options;var i=t.options;e.Be(i),i=e.yC(i);var s=e.Ee(t),n=webix.uid(),a="<div style='width:"+s+"px' class='webix_all_segments' role='tablist' aria-label='"+webix.template.escape(t.label)+"'>",r=t.optionWidth||Math.floor(s/i.length);t.value||(t.value=i[0].id);for(var h=0;h<i.length;h++)a+="<button type='button' style='width:"+(i[h].width||r)+"px' role='tab' aria-selected='"+(t.value==i[h].id?"true":"false")+"' tabindex='"+(t.value==i[h].id?"0":"-1")+"'",
a+="class='webix_segment_"+(h==i.length-1?"N":h>0?1:0)+(t.value==i[h].id?" webix_selected ":"")+"' button_id='"+i[h].id+"' "+(i[h].tooltip?"title='"+i[h].tooltip+"'":"")+">",a+=i[h].value+"</button>";return e.$renderInput(t,a+"</div>",n)}},Ie:function(){return this.$view.getElementsByTagName("BUTTON");
...
on_click:{webix_input_icon:function(t){this.getInputNode().focus(),this.callEvent("onSearchIconClick",[t])}},$skin:function(){this.defaults.inputPadding=webix.skin.$active.inputPadding},defaults:{type:"text",icon:"search"}},webix.ui.text),webix.protoUI({name:"toggle",$allowsClear:!0,$init:function(){
this.attachEvent("onItemClick",function(){this.toggle()})},$setValue:function(t){var e=this.getInputNode(),i=this.s,s=t&&"0"!=t,n=(s?i.onLabel:i.offLabel)||i.label,a=e.lastChild;e.setAttribute("aria-pressed",s?"true":!1),e.value=n,a&&((a.firstChild||a).nodeValue=" "+n),e.firstChild&&"SPAN"===e.firstChild.nodeName&&i.onIcon&&i.offIcon&&i.onIcon!==i.offIcon&&(e.firstChild.className=e.firstChild.className.replace(s?i.offIcon:i.onIcon,s?i.onIcon:i.offIcon));
...
defaults:{template:function(t,e){var i=e.Be(t.options),s="x"+webix.uid(),n=e.qt("select")+"id='"+s+"' style='width:"+e.Ee(t)+"px;'>",a=webix.$$(i);if(a&&a.data&&a.data.each)a.data.each(function(e){n+="<option"+(e.id==t.value?" selected='true'":"")+" value='"+e.id+"'>"+e.value+"</option>"});else for(var r=0;r<i.length;r++)n+="<option"+(i[r].id==t.value?" selected='true'":"")+" value='"+i[r].id+"'>"+i[r].value+"</option>";
...
return t.label&&(a="<label style='"+n+"text-align: "+i+";' onclick='' for='"+e+"' class='webix_inp_"+(s?"top_":"")+"label "+(t.required?"webix_required":"")+"'>"+(t.label||"")+"</label>"),a},getInputNode:function(){return this.y.getElementsByTagName("textarea")[0]}},webix.ui.text),webix.protoUI({name:"counter",
...
var n=t.checkValue==t.value,a=Math.floor((e.s.aheight-16)/2),r=e.qt("input")+"style='margin-top:"+a+"px;"+(t.customCheckbox?"display:none":"")+"' id='"+i+"' type='checkbox' "+(n?"checked='1'":"")+(t.labelRight?" aria-label='"+webix.template.escape(t.labelRight)+"'":"")+"/>",h="webix_inp_checkbox_border webix_el_group webix_checkbox_"+(n?"1":"0"),o=t.customCheckbox||"";
...
e=!0,t&&("object"==typeof t?(t.hidden===!1&&(e=i.isVisible()),e&&t.disabled===!1&&(e=i.isEnabled())):e=t.call(this,i)),e?s[n]=i.getValue():delete s[n];return s},clear:function(){this.Yf=!1;var t={};for(var e in this.elements)this.elements[e].$allowsClear&&(t[e]=this.elements[e].s.defaultValue||"");this.Zf(t);
...
},$setSize:function(t,e){if(webix.ui.view.prototype.$setSize.call(this,t,e)){if(this.jg(),this.s.autoheight){var i=this.getTopParentView();clearTimeout(i.kg),i.kg=webix.delay(this.resize,this)}return!0}},$getSize:function(t,e){return this.s.autoheight&&!this.s.type&&(this.s.height=this.lg()),webix.ui.view.prototype.$getSize.call(this,t,e);
...
t.$count=0,t.$level=n?n.$level+1:1,t.$parent=n?n.id:0,this.Mg){var a=this.Mg[i||0];if(a||(a=this.Mg[i]=this.order),this.order!==a){var r=a.length;!e&&this.branch[i||0].length&&(r=0),a=webix.toArray(a),t.id=t.id||webix.uid(),a.insertAt(t.id,r)}}var h=webix.DataStore.prototype.add.call(this,t,e);return s&&this.refresh(i),
...
var e=t.prerender||this.defaults.prerender||t.type&&"auto"==t.type.width;(e===!1||e!==!0&&!t.autoheight)&&webix.extend(this,webix.VirtualRenderStack,!0),t.autoheight&&(t.scroll=!1),this.w.className+=" webix_dataview",this.x.setAttribute("role","listbox")},Mi:function(){var t=webix.html.create("DIV",0,this.type.template({}));
...
this.Vi(t,!0),!0):void 0},Ri:function(){var t=this.x["x"==this.s.scroll?"scrollLeft":"scrollTop"];Math.floor(t)!=Math.floor(this.s.scrollPos)&&this.Vi(t,!1)},Vi:function(t,e){var i=this.s.scrollWidth||this.s.scrollHeight;t>=i-this.Si/(e?this.s.zoom:1)&&(t=i-this.Si/this.s.zoom),this.s.scrollPos=t||0,
...
column:e.column},i)},pl:function(t,e,i){var s=this.s.columns;if(e){for(var n=[],a=0;a<s.length;a++)s[a].$selected&&n.push(s[a]);s=n}for(var r=this.data.order,h=0,a=0;a<r.length;a++){var o=this.getItem(r[a]);if(o){var l=this.data.getMark(o.id,"webix_selected");if(l||e){for(var c=0,u=0;u<s.length;u++){
...
},{capture:!0})}function e(t){t.down="touchstart",t.move="touchmove",t.up="touchend",t.context=i.gm}var i=webix.Touch={config:{longTouchDelay:1e3,scrollDelay:150,gravity:500,deltaStep:30,speed:"0ms",finish:1500,ellastic:!0},limit:function(t){i.cm=t!==!1},disable:function(){i.Xf=!0},enable:function(){
...
if(!i.Xf&&!i.cm&&webix.env.isSafari){var e=t.srcElement.tagName.toLowerCase();return"input"==e||"textarea"==e||"select"==e||"label"==e?!0:(i.im=!0,webix.html.preventEvent(t))}}),i.Of(),i.jm=[null,null],i.$active=!0},Of:function(){i.km=i.lm=i.mm=i.bC=null,i.nm=i.om=i.pm=this.qm=null,i.rm={sm:0,tm:0,um:0
},i.vm&&(webix.html.removeCss(i.vm,"webix_touch"),i.vm=null),window.clearTimeout(i.wm),i.xm=!0,i.ym=!0,i.zm=!0,i.Am||i.Pf()},fm:function(t){if(i.km){if(i.nm){var e=i.Mf(i.om),s=e.e,n=e.f,a=i.config.finish,r=i.Bm(t,!0),h=webix.$$(i.om),o=h&&h.$scroll?h.$scroll.gravity:i.config.gravity;if(r.um){var l=s+o*r.sm/r.um,c=n+o*r.tm/r.um,u=i.jm[0]?i.Cm(l,!1,!1,i.pm.dx,i.pm.px):s,d=i.jm[1]?i.Cm(c,!1,!1,i.pm.dy,i.pm.py):n,f=Math.max(Math.abs(u-s),Math.abs(d-n));
150>f&&(a=a*f/150),(u!=s||d!=n)&&(a=Math.round(a*Math.max((u-s)/(l-s),(d-n)/(c-n))));var b={e:u,f:d},h=webix.$$(i.om);h&&h.adjustScroll&&h.adjustScroll(b),a=Math.max(100,a),s!=b.e||n!=b.f?(i.Nf(i.om,b.e,b.f,a+"ms"),i.Dm&&i.Dm.Em(b.e,b.f,a+"ms"),i.Fm(b.e,b.f,a+"ms")):i.Pf()}else i.Pf()}else if(!this.qm)if(i.zm&&!i.ym)i.Gm("onSwipeX");else if(i.ym&&!i.zm)i.Gm("onSwipeY");else if(webix.env.isSafari&&i.im){
...
i.jm[0]&&(t.e=i.Cm(t.e-e.x+i.lm.x,n,t.e,i.pm.dx,i.pm.px)),i.jm[1]&&(t.f=i.Cm(t.f-e.y+i.lm.y,n,t.f,i.pm.dy,i.pm.py)),i.Nf(i.om,t.e,t.f,"0ms"),i.Dm&&i.Dm.Em(t.e,t.f,"0ms"),i.Fm(t.e,t.f,"0ms")}},Fm:function(t,e,s){var n=i.pm.px/i.pm.dx*-t,a=i.pm.py/i.pm.dy*-e;i.jm[0]&&i.Nf(i.jm[0],n,0,s),i.jm[1]&&i.Nf(i.jm[1],0,a,s);
},scrollTo:function(t,e,s,n){i.Nf(t,e,s,n)},Nf:function(t,e,s,n){if(!i.tt&&window.setAnimationFrame&&window.setAnimationFrame(function(){return i.tt=!0,i.Nf(t,e,s,n)}),i.tt=null,i.Am=!0,t){var a=i.config.translate||webix.env.translate;t.style[webix.env.transform]=a+"("+Math.round(e)+"px, "+Math.round(s)+"px"+("translate3d"==a?", 0":"")+")",
...
n=n.split(",");for(var e={},a=["a","b","c","d","e","f"],r=0;r<a.length;r++)e[a[r]]=parseInt(n[r],10)}return i.Dm&&i.Dm.Mm(e),e},Cm:function(t,e,i,s,n){if(t===i)return t;var a=Math.abs(t-i),r=a/(t-i);if(t>0)return e?i+r*Math.sqrt(a):0;var h=s-n;return 0>h+t?e?i-Math.sqrt(-(t-i)):-h:t},Nm:function(t){if(!t.scroll_enabled){
...
-1!=i.nm.indexOf("y")&&(i.jm[1]=i.Om("y",i.pm.dy,i.pm.py,"height")),i.Nm(i.om),window.setTimeout(i.Hm,1)},Om:function(t,e,s,n){if(2>e-s){var a=i.Mf(i.om),r="y"==t?a.e:0,h="y"==t?0:a.f;return i.Dm||i.Nf(i.om,r,h,"0ms"),i.nm=i.nm.replace(t,""),""}var o=webix.html.create("DIV",{"class":"webix_scroll_"+t
...
Rm:function(t,e){i.pk(e);var n=i.jm[0]||i.jm[1];if(n){var a=i.Km("onBeforeScroll",!0);a&&a.callEvent("onBeforeScroll",[i.km,i.lm])}!n||i.om&&n.parentNode==i.om.parentNode||(i.Of(),i.Pf(),i.km=s.context(t)),i.em(t)},Bm:function(t,e){return i.mm=i.lm,i.lm=s.context(t),i.rm.Jm=Math.abs(i.km.x-i.lm.x),i.rm.Ei=Math.abs(i.km.y-i.lm.y),
...
},cn:function(t,e){var i=this.s.columns;if(i){var s=this.bc-this.oj,n=!1;if(s>0){for(var a=0;a<i.length;a++)t[a]||(s-=i[a].width||this.config.columnWidth);for(var a=0;a<t.length;a++)if(t[a]){var r=Math.min(s,Math.round(s*t[a]/e));n=this.Xs(a,r,!0)||n,s-=i[a].width,e-=t[a]}n&&this.rk(!0)}}},dn:function(t,e){
var i=this.s.columns[t],s=i.minColumnWidth||10;if("header"!=e){var n=this.data.order.length;i.adjustBatch&&i.adjustBatch<n&&(n=i.adjustBatch);for(var a=this.data.order.slice(0,n),r=0;n>r;r++)a[r]=a[r]?this.Ek(this.getItem(a[r]),i,0):"";s=Math.max(s,webix.html.getTextSize(a,"webix_table_cell webix_cell").width);
}if("data"!=e)for(var r=0;r<i.header.length;r++){var h=i.header[r];if(h){var o=0;if(h.rotate)for(var l=0;l<(h.rowspan||1);l++)o+=this.Mt[l];var c="webix_table_cell webix_cell "+(h.css||"")+(h.rotate?"webix_measure_rotate":""),u=webix.html.getTextSize([h.text],c,o);s=Math.max(s,h.rotate?u.height:u.width);
...
t.$height=Math.max(n.scrollHeight,this.s.rowHeight)},this),n=webix.html.remove(n),i&&webix.html.remove(i)}else{var a=new Array(this.data.order.length),r=this.config.columns,h=0;for(var o in this.data.pull)a[h]=0,h++;for(var l=0;l<r.length;l++){this.adjustRowHeight(r[l].id,!0);var h=0;this.data.each(function(t,e){
t.$height>a[h]&&(a[h]=t.$height),t.$height=a[h],h++})}}e||this.refresh()}}),webix.extend(webix.ui.datatable,{math_setter:function(t){return t&&this.en(),t},fn:"$",en:function(){webix.env.strict||(this.data.attachEvent("onStoreUpdated",webix.bind(this.gn,this)),this.data.attachEvent("onStoreLoad",webix.bind(this.hn,this)),
...
h&&(n=0,"bottom"==t&&(n=this.config.columns.length-1),h=this.columnId(n));else if("up"==t||"down"==t||"pgup"==t||"pgdown"==t){if(r){var n=this.getIndexById(r),o="pgup"==t||"pgdown"==t?Math.round(this.Vj/this.s.rowHeight):1;"up"==t||"pgup"==t?n-=o:("down"==t||"pgdown"==t)&&(n+=o),0>n&&(n=0),n>=this.data.order.length&&(n=this.data.order.length-1),
r=this.getIdByIndex(n),!r&&this.s.pager&&this.showItemByIndex(n)}}else{if("right"!=t&&"left"!=t)return;if(h&&"row"!=this.config.select){var n=this.getColumnIndex(h);"right"==t?n++:"left"==t&&n--,0>n&&(n=0),n>=this.config.columns.length&&(n=this.config.columns.length-1),h=this.columnId(n)}else{if((this.open||this.oA)&&"right"==t)return this.open?this.open(r):this.openSub(r);
if((this.close||this.oA)&&"left"==t)return this.close?this.close(r):this.closeSub(r)}}if(r){this.showCell(r,h),this.select||(webix.extend(this,this._k.$k,!0),this.s.select=this.open||this.oA?"row":"cell",webix.extend(this,this._k[this.s.select],!0));var l={row:r,column:h};if(a&&"area"==this.s.select){
var c=this.el[this.el.length-1];this.gC(l,c,t,e)}else this.hl(l,a);if(!this.s.clipboard&&i!==!1){var u=this.getItemNode(l);u&&u.focus()}}}return!1}}}),webix.extend(webix.ui.datatable,webix.KeysNavigation),webix.extend(webix.ui.datatable,webix.DataMove),webix.extend(webix.ui.datatable,{drag_setter:function(t){
return this.attachEvent("onBeforeDrag",function(t){return this.RD(t.source)}),this.attachEvent("onBeforeDragIn",function(t){return this.RD(t.target)}),this.attachEvent("onBeforeDropOrder",function(t,e){return 0>e||e>=this.s.topSplit}),webix.DragItem.drag_setter.call(this,t)},RD:function(t){var e,i,s=!1;
if(this.s.topSplit&&t)for(webix.isArray(t)||(t=[t]),e=0;!s&&e<t.length;e++)i=this.getIndexById(t[e]),s=i<this.s.topSplit;return!s},$dragHTML:function(t,e){for(var i=this.bc-this.oj,s="<div class='webix_dd_drag' style='width:"+(i-2)+"px;'>",n=this.s.columns,a=0;a<n.length;a++){var r=this.Ek(t,n[a]);s+="<div style='width:"+n[a].width+"px;'>"+r+"</div>";
}return s+"</div>"},getHeaderNode:function(t,e){return this.nG(t,e,this.I)},getFooterNode:function(t,e){return this.nG(t,e,this.cj)},nG:function(t,e,i){if(this.isColumnVisible(t)){var s=this.getColumnIndex(t),n=this.s.leftSplit>s?0:this.Fj<=s?2:1;e=e||0;var a=i.childNodes[n].getElementsByTagName("TR");
if(a.length)for(var r=a[e+1].childNodes,h=0;h<r.length;h++)if(r[h].getAttribute("column")==s)return r[h].firstChild}return null},getItemNode:function(t,e){if(t&&!t.header){var i=t.row||t,s=this.getIndexById(i),n=this.Sj(),a=n[0]-this.s.topSplit;if(a>s&&s>n[1])return;var r=this.Xj(),h=this.s.leftSplit?0:r[0];
if(t.column&&(h=this.getColumnIndex(t.column),h<this.Fj&&h>=this.s.leftSplit&&(h<r[0]||h>r[1])))return;var o=this.s.columns[h];if(o.attached&&o.node){var l=s<this.s.topSplit?s:s-a;return o.node.childNodes[l]}}},dragColumn_setter:function(t){var e;"order"==t?e={$drag:webix.bind(function(t,i){var s=this.locate(i);
...
i.config.hidden=!1,i.Qd());else{var n,a=this.s.subview;"function"==typeof a?i=a.call(this,t,e.firstChild):(n=webix.copy(a),i=webix.ui(n,e.firstChild)),i.getMasterView=webix.bind(function(){return this},this),t.$subContent=i.config.id,this.oA[t.$subContent]=i.$view,i.attachEvent("onResize",webix.bind(function(e,i,s,n){
...
}},jp:function(t,e,i,s,n){return t+(n-i)*(e-t)/(s-i)},lp:function(t,e,i,s,n,a,r){var h=this.s.item,o=parseInt(h.radius.call(this,s),10)||0,l=this.kp;if(o){if(t.save(),h.shadow){t.lineWidth=1,t.strokeStyle="#bdbdbd",t.fillStyle="#bdbdbd";for(var c=[.1,.2,.3],u=c.length-1;u>=0;u--)t.globalAlpha=c[u],t.strokeStyle="#d0d0d0",
...
this.elements={};for(var a=0;a<n.length;a++){var r=n[a],h=e(r,"name");if(h){var o="button"===t(r),l=e(r,"type"),c=o||"button"===l||"submit"===l;if("radio"===l){var u=this.elements[h]||[];u.tagName="radio",u.push(r),r=u}this.elements[h]=r,r.getValue=i,r.setValue=s,r.$allowsClear=!c,r.s={defaultValue:r.getValue()
...
if(s.className||(s=s.parentNode),-1!=s.className.indexOf("webix_popup_button")){var n=s.getAttribute("result");n="true"==n||("false"==n?!1:n),t(e,n)}i.cancelBubble=!0},e.box=a,(i||n||e.buttons)&&(d=e),a}function r(t,s,n){var r=t.tagName?t:a(t,s,n);t.hidden||i(!0),webix.toNode(t.container||document.body).appendChild(r);
var h=t.left||Math.abs(Math.floor(((window.innerWidth||document.documentElement.offsetWidth)-r.offsetWidth)/2)),o=t.top||Math.abs(Math.floor(((window.innerHeight||document.documentElement.offsetHeight)-r.offsetHeight)/2));return"top"==t.position?r.style.top="-3px":r.style.top=o+"px",r.style.left=h+"px",
r.onkeydown=e,r.focus(),t.hidden&&webix.modalbox.hide(r),r}function h(t){return r(t,!0,!1)}function o(t){return r(t,!0,!0)}function l(t){return r(t)}function c(t,e,i){return"object"!=typeof t&&("function"==typeof e&&(i=e,e=""),t={text:t,type:e,callback:i}),t}function u(t,e,i,s){return"object"!=typeof t&&(t={
...
t.type=t.type||"info";var a=t.type.split("-")[0];switch(a){case"alert":return h(t);case"confirm":return o(t);case"modalbox":return l(t);default:return n(t)}};f.seed=(new Date).valueOf(),f.uid=function(){return f.seed++},f.expire=4e3,f.keyboard=!0,f.position="top",f.pull={},f.timers={},f.hideAll=function(){
...
t=n.name,e=n.size);var a=this.ks(e);i=i||t.split(".").pop();var r={file:n,name:t,id:webix.uid(),size:e,sizetext:a,type:i,context:this.es,status:"client"};if(n.webkitRelativePath&&(r.name=n.webkitRelativePath),s&&webix.extend(r,s,!0),this.callEvent("onBeforeFileAdd",[r])){this.s.multiple||this.files.clearAll();
...
a=setTimeout(function(){webix.html.removeCss(i,n)},150)}),webix.UE(i,"drop",webix.bind(function(t){return webix.html.removeCss(i,n),this.bs(t),webix.html.preventEvent(t)},this))},ks:function(t){for(var e=0;t>1024;)e++,t/=1024;return Math.round(100*t)/100+" "+webix.i18n.fileSize[e]},js:function(t,e){var i=this.files.getItem(t);
webix.extend(i,e,!0),i.status="server",i.progress=100,this.callEvent("onFileUpload",[i,e]),this.callEvent("onChange",[]),this.files.updateItem(t),this.isUploaded()&&this.gs(e)},gs:function(t){this.callEvent("onUploadComplete",[t]),this.fs&&(this.fs.call(this,t),this.fs=0)},isUploaded:function(){for(var t=this.files.data.order,e=0;e<t.length;e++)if("server"!=this.files.getItem(t[e]).status)return!1;
return!0},$onUploadComplete:function(){},$updateProgress:function(t,e){var i=this.files.getItem(t);i.percent=Math.round(e),this.files.updateItem(t)},setValue:function(t){"string"==typeof t&&t&&(t={value:t,status:"server"}),this.files.clearAll(),t&&this.files.parse(t),this.callEvent("onChange",[])},getValue:function(){
var t=[];return this.files.data.each(function(e){"server"==e.status&&t.push(e.value||e.name)}),t.join(",")}},webix.ui.button),webix.html.addMeta=function(t,e){document.getElementsByTagName("head").item(0).appendChild(webix.html.create("meta",{name:t,content:e}))},function(){var t=function(){var t=!!(window.orientation%180);
webix.ui.orientation!==t&&(webix.ui.orientation=t,webix.callEvent("onRotate",[t]))};webix.env.touch&&(webix.ui.orientation=!!((webix.isUndefined(window.orientation)?90:window.orientation)%180),webix.event(window,"onorientationchange"in window?"orientationchange":"resize",t)),webix.ui.fullScreen=function(){
if(webix.env.touch){webix.html.addMeta("apple-mobile-web-app-capable","yes"),webix.html.addMeta("viewport","initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no");var e=function(){var t=window.innerWidth,e=window.innerHeight;e&&(document.body.style.height=e+"px",document.body.style.width=t+"px"),
webix.ui.PG=!1,webix.ui.resize()},i=function(){webix.ui.PG=!0,webix.delay(e,null,[],500)};webix.attachEvent("onRotate",i),t(),webix.delay(i)}}}(),webix.history={track:function(t,e){if(this.ls(t,e),this.cG&&webix.$$(this.dG).detachEvent(this.cG),t){this.dG=t;var i=webix.$$(t),s=function(){webix.history.ms||i.getValue&&webix.history.push(t,i.getValue());
...
this.Ny(h);return h?i[h]=Math.max(Math.min(r,e.max),i[0]):i[h]=Math.max(Math.min(r,i[1]),e.min),i}},webix.ui.slider),webix.proxy.offline={$proxy:!0,storage:webix.storage.local,cache:!1,data:"",zs:function(){this.cache||webix.env.offline||(webix.callEvent("onOfflineMode",[]),webix.env.offline=!0)},As:function(){
...
},Bs:function(){return this.source.$proxy?this.source.source+"_$proxy$_data":this.source+"_$proxy$_data"},saveAll:function(t,e,i,s){this.setCache(t.serialize()),webix.ajax.$callback(t,s,"",e)},result:function(t,e,i,s,n){for(var a=0;a<n.length;a++)i.processResult({id:n[a].id,status:n[a].operation},{},{});
...
this[t]=this.Js(t);this.attachEvent("onBeforeRender",function(){this.type.masterUI=this}),this.type.masterUI=this}},Js:function(t){return function(e){for(var i=this.Hs[t],s=i.s.id,n=this.getItemNode(e).getElementsByTagName("DIV"),a=0;a<n.length;a++)if(n[a].getAttribute("view_id")==s){i.x=i.y=n[a];break;
}return i}},Ks:function(t,e,i){return function(s){if(s)for(var n=s.target||s.srcElement;n;){if(n.getAttribute&&n.getAttribute("view_id")){if(i.vE(t,n),i.locate){var a=i.locate(n.parentNode),r=i.Gs[e][a];t.s.value=r,t.s.$masterId=a}return n}n=n.parentNode}return t.x}},Ls:function(t,e){return function(i){
var s=e.data;if(e.filter){var n=e.locate(this.x.parentNode);s=e.getItem(n),this.refresh(),e.Fs[t][n]=this.x.outerHTML||(new XMLSerializer).serializeToString(this.x),e.Gs[t][n]=i}s&&(s[t]=i)}},Is:function(t){return function(e,i,s){var n=i.Es?i:i.masterUI;if(!n.Es[t]){var a=document.createElement("DIV");
s=s||n.s.activeContent;var r=webix.ui(s[t],a);a.firstChild.setAttribute("onclick","event.processed = true; if (webix.env.isIE8) event.srcElement.w_view = '"+r.s.id+"';"),r.getNode=n.Ks(r,t,n),r.attachEvent("onChange",n.Ls(t,n)),n.Hs[t]=r,n.Es[t]=a.innerHTML,n.Fs[t]={},n.Gs[t]={},r.$activeEl=r.$view}if(n.filter&&e[t]!=n.Gs[t]&&!webix.isUndefined(e[t])){
var r=n.Hs[t];r.blockEvent(),n.vE(r,r.$activeEl),r.$view.firstChild||r.refresh(),r.setValue(e[t]),r.refresh(),r.unblockEvent(),n.Gs[t][e.id]=e[t],n.Fs[t][e.id]=r.x.outerHTML||(new XMLSerializer).serializeToString(r.x)}return n.Fs[t][e.id]||n.Es[t]}},vE:function(t,e){t.y=t.x=t.$view=e}},webix.ProgressBar={
...
30*i==t.delay?window.clearInterval(a.Oy):(a.cu&&a.cu.firstChild&&(a.cu.firstChild.style.width=s+i*n*e*100+"%"),i++)},30)}else this.cu.firstChild.style.width=100*e+"%",t.delay&&(this.cu.firstChild.style[webix.env.transitionDuration]=t.delay+"ms");t.hide&&webix.delay(this.hideProgress,this,[1],t.delay);
...
var r=(s.y-i.y)*n.zu/n.yu;a?a.Wj.scrollTo(a.jk+r):t.Bu(e,"scrollTop",r)}e.su=s,t.sk(e)},ju:function(t){var e={};return t.Zj&&t.s.scrollX&&(e.dx=t.Zj.s.scrollWidth,e.px=t.Zj.Si||1,e.ec=e.dx-e.px>1),t.Wj&&t.s.scrollY&&(e.dy=t.Wj.s.scrollHeight,e.py=t.Wj.Si||1,e.cc=e.dy-e.py>1),e},lu:function(){clearTimeout(this.tu),
...
}for(var g=0;g<h.length;g++){var v=h[g],c=v.id;if(!v.noExport){r&&t.Aj[c]&&(v=webix.extend(webix.extend({},v),t.Aj[c]));var m={id:v.id,template:o||!v.template?e(c,v,o):v.template,width:(v.width||200)*("excel"===i.export_mode?8.43/70:1),header:v.header!==!1?v.header||c:""};"excel"===i.export_mode&&webix.extend(m,{
...
text:y}]:webix.copy(y);for(var d=0;d<y.length;d++)y[d]?y[d]=y[d].contentId?t.getHeaderContent(y[d].contentId).getValue():y[d].text:y[d]="";m.footer=y,a=Math.max(a,m.footer.length)}s.push(m)}}for(var d=0;d<s.length;d++){for(var $=n-s[d].header.length,_=0;$>_;_++)s[d].header.push("");if(t.s.footer){$=a-s[d].footer.length;
for(var _=0;$>_;_++)s[d].footer.push("")}}return s}function s(t,e,i){var s,n,a=!!e.filterHTML,r=/<[^>]*>/gi,h=[];if("excel"===e.export_mode&&e.docHeader&&(h=[[(e.docHeader.text||e.docHeader).toString()],[""]],e.docHeader.height&&(i.heights[0]=e.docHeader.height)),e.header!==!1&&i.length)for(var o=0;o<i[0].header.length;o++){
n=[];for(var l=0;l<i.length;l++)s="",i[l].header[o]&&(s=i[l].header[o],a&&(s=i[l].header[o]=s.replace(r,""))),n.push(s);"excel"!=e.export_mode||!t.fj||e.heights===!1||t.Mt[o]===webix.skin.$active.barHeight&&"all"!=e.heights||(i.heights[h.length]=t.Mt[o]),"pdf"!==e.export_mode&&(h[h.length]=n)}e.yCorrection=(e.yCorrection||0)-h.length;
...
var f=this.getSpan(s.id,l.id);f&&f[4]&&f[0]==s.id&&f[1]==l.id&&(d=f[4],a&&"string"==typeof d&&(d=d.replace(r,"")))}d||(d=l.template(s,t.type,s[l.id],l,o),d||0===d||(d=""),a&&"string"==typeof d&&(c&&(d=d.replace(/<div class=.webix_tree_none.><\/div>/,u)),d=d.replace(r,"")),"string"==typeof d&&"csv"===e.export_mode&&(d=d.trim()),
...
t.SheetNames.push(g),t.Sheets[g]=w,t.Workbook.Names=t.Workbook.Names.concat(p)}var v=XLSX.write(t,{bookType:"xlsx",bookSST:!1,type:"binary"}),m=(e.filename||a.join(","))+".xlsx",y=new Blob([u(v)],{type:"application/xlsx"});e.download!==!1&&webix.html.download(y,m),l.resolve(y)}),l},webix.toCSV=function(e,n){
...
};var b;webix.toPDF=function(t,e){var n=webix.promise.defer();return webix.require(webix.cdn+"/extras/pdfjs.js",function(){e=e||{};var a=webix.$$(t);if(a&&a.$exportView&&(a=a.$exportView(e)),!a)return n.reject();e.export_mode="pdf",e.hB=b,e.fontName=e.fontName||"pt-sans.regular";var r=i(a,e),h=s(a,e,r),o=function(t,e){
var i=(e.filename||"Data")+".pdf",s=new Blob([t.toString()],{type:"application/pdf"});e.download!==!1&&webix.html.download(s,i),n.resolve(s)};e.hB?d(r,h,e,o):pdfjs.load(webix.cdn+"/extras/"+e.fontName+".ttf",function(t,i){if(t)throw t;b=e.hB=new pdfjs.TTFFont(i),d(r,h,e,o)})}),n};var p={number:"n",date:"n",
