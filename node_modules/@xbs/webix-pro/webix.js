...
(c) XB Software Ltd.
*/
window.webix||(webix={}),webix.version="5.4.6",webix.codebase="./",webix.name="core",webix.cdn="//cdn.webix.com",webix.clone=function(t){var e=webix.clone.a;return e.prototype=t,new e},webix.clone.a=function(){},webix.extend=function(t,e,i){if(t.$protoWait)return webix.PowerArray.insertAt.call(t.$protoWait,e,1),
t;for(var s in e)s in t&&!i||(t[s]=e[s]);return e.defaults&&webix.extend(t.defaults,e.defaults),e.$init&&e.$init.call(t),t},webix.copy=function(t){var e,i=webix.env.esModern&&!!window.Map&&!!window.Set&&!!window.WeakMap&&!!window.WeakSet;arguments.length>1?(e=arguments[0],t=arguments[1]):e=webix.isArray(t)?[]:{};
...
}i&&s.push(e.$init),e.$init=function(){for(var t=0;t<s.length;t++)s[t].apply(this,arguments)},e.$skin&&e.$skin();var o=function(t){this.$ready=[],this.$init(t),this.e&&this.e(t,this.defaults);for(var e=0;e<this.$ready.length;e++)this.$ready[e].call(this)};return o.prototype=e,e=t=null,o},webix.bind=function(t,e){
return function(){return t.apply(e,arguments)}},webix.require=function(t,e,i){var s=webix.promise.defer();if(e&&e!==!0&&(s=s.then(function(){e.call(i||this)})),webix.require.disabled)return s.resolve(),s;if("string"!=typeof t){var n=t.length||0;if(n){var a=function(){n?(n--,webix.require(t[t.length-n-1],a,i)):s.resolve();
};a()}else{for(var r in t)n++;var a=function(){n--,0===n&&s.resolve()};for(var r in t)webix.require(r,a,i)}return s}if(webix.f[t]!==!0){var h=t;if(t.toString().match(/^([a-z]+\:)*\/\//i)||(h=webix.codebase+t),".css"==t.substr(t.length-4)){var o=webix.html.create("LINK",{type:"text/css",rel:"stylesheet",
href:h});return document.getElementsByTagName("head")[0].appendChild(o),s.resolve(),s}if(e===!0)webix.exec(webix.ajax().sync().get(h).responseText),webix.f[t]=!0;else if(webix.f[t])webix.f[t].push(s);else{webix.f[t]=[s];var l=document.createElement("script"),c=webix.f[t];l.onerror=function(){webix.f[t]=!1;
for(var e=0;e<c.length;e++)c[e].reject()},l.onload=function(){webix.f[t]=!0;for(var e=0;e<c.length;e++)c[e].resolve()},document.getElementsByTagName("head")[0].appendChild(l),l.src=h}}else s.resolve();return s},webix.f={},webix.exec=function(t){window.execScript?window.execScript(t):window.eval(t)},webix.wrap=function(t,e){
return t?function(){var i=t.apply(this,arguments);return e.apply(this,arguments),i}:e},webix.isUndefined=function(t){return"undefined"==typeof t},webix.delay=function(t,e,i,s){return window.setTimeout(function(){if(!e||!e.$destructed){var s=t.apply(e,i||[]);return t=e=i=null,s}},s||1)},webix.once=function(t){
var e=!0;return function(){e&&(e=!1,t.apply(this,arguments))}},webix.uid=function(){return this.g||(this.g=(new Date).valueOf()),this.g++,this.g},webix.toNode=function(t){return"string"==typeof t?document.getElementById(t):t},webix.toArray=function(t){return webix.extend(t||[],webix.PowerArray,!0)},webix.toFunctor=function(str,scope){
if("string"==typeof str){var method=str.replace("()","");return scope&&scope[method]?scope[method]:window[method]||eval(str)}return str},webix.isArray=function(t){return Array.isArray?Array.isArray(t):"[object Array]"===Object.prototype.toString.call(t)},webix.isDate=function(t){return t instanceof Date;
},webix.stringify=function(t){var e=Date.prototype.toJSON;Date.prototype.toJSON=function(){return webix.i18n.parseFormatStr(this)};var i;return i=t instanceof Date?t.toJSON():JSON.stringify(t),Date.prototype.toJSON=e,i},webix.h={},webix.UE=function(t,e,i,s){s=s||{},s.inner=!0,webix.event(t,e,i,s)},webix.event=function(t,e,i,s){
s=s||{},t=webix.toNode(t);var n=s.id||webix.uid();s.bind&&(i=webix.bind(i,s.bind));var a=[t,e,i,s.capture];return s.inner||(webix.h[n]=a),t.addEventListener?t.addEventListener(e,i,!!s.capture):t.attachEvent&&t.attachEvent("on"+e,a[2]=function(){return i.apply(t,arguments)}),n},webix.eventRemove=function(t){
if(t){var e=webix.h[t];e[0].removeEventListener?e[0].removeEventListener(e[1],e[2],!!e[3]):e[0].detachEvent&&e[0].detachEvent("on"+e[1],e[2]),delete this.h[t]}},webix.EventSystem={$init:function(){this.i||(this.i={},this.j={},this.k={})},blockEvent:function(){this.i.l=!0},unblockEvent:function(){this.i.l=!1;
},mapEvent:function(t){webix.extend(this.k,t,!0)},on_setter:function(t){if(t)for(var e in t){var i=webix.toFunctor(t[e],this.$scope),s=e.indexOf("->");-1!==s?this[e.substr(0,s)].attachEvent(e.substr(s+2),webix.bind(i,this)):this.attachEvent(e,i)}},callEvent:function(t,e){if(this.i.l)return!0;t=t.toLowerCase();
var i=this.i[t.toLowerCase()],s=!0;if(i)for(var n=0;n<i.length;n++)i[n].apply(this,e||[])===!1&&(s=!1);if(this.k[t]){var a=this.k[t];a.$eventSource=this,a.callEvent(t,e)||(s=!1),a.$eventSource=null}return s},attachEvent:function(t,e,i){t=t.toLowerCase(),i=i||webix.uid(),e=webix.toFunctor(e,this.$scope);
var s=this.i[t]||webix.toArray();return arguments[3]?s.unshift(e):s.push(e),this.i[t]=s,this.j[i]={f:e,t:t},i},detachEvent:function(t){if(!this.j[t]){var e=(t+"").toLowerCase();return void(this.i[e]&&(this.i[e]=webix.toArray()))}var i=this.j[t].t,s=this.j[t].f,n=this.i[i];n.remove(s),delete this.j[t];
},hasEvent:function(t){t=t.toLowerCase();var e=this.i[t];if(e&&e.length)return!0;var i=this.k[t];return i?i.hasEvent(t):!1}},webix.extend(webix,webix.EventSystem,!0),webix.PowerArray={removeAt:function(t,e){t>=0&&this.splice(t,e||1)},remove:function(t){this.removeAt(this.find(t))},insertAt:function(t,e){
if(e||0===e){var i=this.splice(e,this.length-e);this[e]=t,this.push.apply(this,i)}else this.push(t)},find:function(t){for(var e=0;e<this.length;e++)if(t==this[e])return e;return-1},each:function(t,e){for(var i=0;i<this.length;i++)t.call(e||this,this[i])},map:function(t,e){for(var i=0;i<this.length;i++)this[i]=t.call(e||this,this[i]);
return this},filter:function(t,e){for(var i=0;i<this.length;i++)t.call(e||this,this[i])||(this.splice(i,1),i--);return this}},webix.env={},function(){webix.env.strict=!!window.webix_strict,webix.env.https="https:"===document.location.protocol;var t=navigator.userAgent;if(webix.env.isMac=-1!=t.indexOf("Mac"),
(-1!=t.indexOf("Mobile")||-1!=t.indexOf("Windows Phone"))&&(webix.env.mobile=!0),(webix.env.mobile||-1!=t.indexOf("iPad")||-1!=t.indexOf("Android"))&&(webix.env.touch=!0),-1!=t.indexOf("Opera"))webix.env.isOpera=!0;else{if(webix.env.isIE=!!document.all||-1!==t.indexOf("Trident"),webix.env.isIE){var e=parseFloat(navigator.appVersion.split("MSIE")[1]);
8==e&&(webix.env.isIE8=!0)}webix.env.isEdge=-1!=t.indexOf("Edge"),webix.env.isFF=-1!=t.indexOf("Firefox"),webix.env.isWebKit=-1!=t.indexOf("KHTML"),webix.env.isSafari=webix.env.isWebKit&&webix.env.isMac&&-1==t.indexOf("Chrome"),(webix.env.isIE||webix.env.isEdge||webix.env.isFF)&&(webix.env.maxHTMLElementSize=1e7),
webix.env.isSafari&&(webix.env.maxHTMLElementSize=1e8)}-1!=t.toLowerCase().indexOf("android")&&(webix.env.isAndroid=!0,-1!=t.toLowerCase().indexOf("trident")&&(webix.env.isAndroid=!1,webix.env.isIEMobile=!0)),webix.env.transform=!1,webix.env.transition=!1;for(var i=-1,s=["","webkit","Moz","O","ms"],n=["","-webkit-","-Moz-","-o-","-ms-"],a=document.createElement("DIV"),r=0;r<s.length;r++){
var h=s[r]?s[r]+"Transform":"transform";if("undefined"!=typeof a.style[h]){i=r;break}}if(i>-1){webix.env.cssPrefix=n[i];var o=webix.env.jsPrefix=s[i];webix.env.transform=o?o+"Transform":"transform",webix.env.transition=o?o+"Transition":"transition",webix.env.transitionDuration=o?o+"TransitionDuration":"transitionDuration",
...
e["class"]&&(s.className=e["class"]),i&&(s.innerHTML=i),s},getValue:function(t){return t=webix.toNode(t),t?webix.isUndefined(t.value)?t.innerHTML:t.value:""},remove:function(t){if(t instanceof Array)for(var e=0;e<t.length;e++)this.remove(t[e]);else t&&t.parentNode&&t.parentNode.removeChild(t)},insertBefore:function(t,e,i){
t&&(e&&e.parentNode?e.parentNode.insertBefore(t,e):i.appendChild(t))},locate:function(t,e){var i;for(t.tagName?i=t:(t=t||event,i=t.target||t.srcElement);i;){if(i.getAttribute){var s=i.getAttribute(e);if(s)return s}i=i.parentNode}return null},offset:function(t){if(t.getBoundingClientRect){var e=t.getBoundingClientRect(),i=document.body,s=document.documentElement,n=window.pageYOffset||s.scrollTop||i.scrollTop,a=window.pageXOffset||s.scrollLeft||i.scrollLeft,r=s.clientTop||i.clientTop||0,h=s.clientLeft||i.clientLeft||0,o=e.top+n-r,l=e.left+a-h;
...
t[e]}})}),h.sort(function(t,e){return t.pos>e.pos?1:-1}),h.length){for(var o=0,l=function(t,i,s){e[t].push(function(){return t.slice(i,s)})},c=0;c<h.length;c++){var u=h[c].pos;l(a,o,u),e[a].push(h[c].fn),o=u+h[c].str.length}l(a,o,a.length)}else e[a].push(function(){return a})}return function(){for(var t="",i=0;i<e[a].length;i++)t+=e[a][i].apply(this,arguments);
...
a.resolve(e)},error:function(t,e){a.reject(r)}});var h=this.I||{};if(webix.callEvent("onBeforeAjax",[s,t,e,r,h,null,a])){var o=!1;if("GET"!==s){var l=!1;for(var c in h)"content-type"==c.toString().toLowerCase()&&(l=!0,"application/json"==h[c]&&(o=!0));l||window.FormData&&e instanceof window.FormData||(h["Content-Type"]="application/x-www-form-urlencoded");
...
for(var s=[],n=t.evaluate(e,i,null,XPathResult.ANY_TYPE,null),a=n.iterateNext();a;)s.push(a),a=n.iterateNext();return s}var r=!0;try{"undefined"==typeof t.selectNodes&&(r=!1)}catch(h){}if(r)return t.selectNodes(e);var o=e.split("/").pop();return t.getElementsByTagName(o)},assignTypes:function(t){for(var e in t){
var i=t[e];if("object"==typeof i)this.assignTypes(i);else if("string"==typeof i){if(""===i)continue;"true"==i?t[e]=!0:"false"==i?t[e]=!1:i==1*i&&(t[e]=1*t[e])}}return t},tagToObject:function(t,e){var i=1==t.nodeType&&t.getAttribute("stack"),s=0;if(i){e=[];for(var n=t.childNodes,a=0;a<n.length;a++)1==n[a].nodeType&&e.push(this.tagToObject(n[a],{}));
}else{e=e||{};var r=t.attributes;if(r&&r.length)for(var a=0;a<r.length;a++)e[r[a].name]=r[a].value,s=1;for(var n=t.childNodes,a=0;a<n.length;a++)if(1==n[a].nodeType){var h=n[a].tagName;e[h]?("function"!=typeof e[h].push&&(e[h]=[e[h]]),e[h].push(this.tagToObject(n[a],{}))):e[h]=this.tagToObject(n[a],{}),
...
},1)},getTop:function(t){for(var e,i=webix.$$(t);i&&(e=i.getParentView());)i=e;return i},getNext:function(t,e){var i=t.getChildViews();if(i.length&&!e)return i[0];var s=t.getParentView();if(!s)return t;var n=s.getChildViews();if(n.length)for(var a=webix.PowerArray.find.call(n,t)+1;a<n.length;){if(this.canFocus(n[a]))return n[a];
a++}return this.getNext(s,!0)},getPrev:function(t,e){var i=t.getChildViews();if(i.length&&e)return this.getPrev(i[i.length-1],!0);if(e)return t;var s=t.getParentView();if(!s)return this.getPrev(t,!0);var n=s.getChildViews();if(n)for(var a=webix.PowerArray.find.call(n,t)-1;a>=0;){if(this.canFocus(n[a]))return this.getPrev(n[a],!0);
...
},Db:function(t,e,i){for(var s=0;s<t.length;s++){var n=t[s];if(null===n.view||e===n.view||"string"==typeof n.view&&e&&e.name===n.view){var a=n.handler(e,i);if(!!a===a)return a}}return!0},Cb:function(t){var e,i,s,n,a=this.nb,r=t.toLowerCase().split(/[\+\-_]/);e=i=s=n=0;for(var h="",o=0;o<r.length;o++)if("ctrl"===r[o])e=1;else if("shift"===r[o])i=1;else if("alt"===r[o])s=1;else if("command"===r[o])n=1;else if(a[r[o]]){
var l=a[r[o]];h=this.BA(l)?l.toString():String.fromCharCode(l)}else h=r[o];return{letter:h.toUpperCase(),ctrl:e,shift:i,alt:s,meta:n}}},webix.ready(function(){webix.UIManager.ob(),webix.UIManager.addHotKey("enter",function(t,e){if(t&&t.callEvent&&t.callEvent("onEnter",[e]),t&&t.editStop&&t.Eb)return t.editStop(),
...
!webix.ui){e=webix.ui=function(t,e,s){var n;webix.Nb++;try{n=i(t,e,s)}finally{webix.Nb--}return n};var i=function(t,i,a){var r=webix.isArray(t),h=webix.toNode(t.container||i||document.body);h.s&&(a=n(h,r,a));var o,l=!1,c=h==document.body;if(t.s||h&&r?(o=t,l=!0):(h&&c&&(t.$topView=!0),t.Ob||(t.Ob={}),
i&&i.getParentView&&(webix.Xb=a||0===a?i:i.getParentView()),o=e.A(t)),!c||o.setPosition||o.$apiOnly||webix.ui.Pb(),o.s&&o.s.ft&&!h.$view)o.s.gt=h;else if(!o.$apiOnly)if(h.appendChild)s(h,o,t);else if(h.destructor){var u=h;if(a||0===a||webix.isArray(o)||(a=h,h=h.getParentView()),h&&h.Qb){if(l&&o.getParentView){
var i=o.getParentView();i&&i.Rb&&i.Rb(o),o.Xb=h,o.$scope=h.$scope}h.Qb(o,a)}else{var i=u.$view.parentNode;u.destructor(),s(i,o,t)}}return o},s=function(e,i,s){e.appendChild(i.x),i.getParentView()||(((!i.setPosition||i.s.fullscreen)&&e==document.body||i.s.position)&&t.push(i.VE),s.skipResize||i.adjust());
},n=function(t,e,i){var s=[t];if(e)s=t.getChildViews();else if(t.gd)s=[t.gd];else{if("number"==typeof i)return i;if(i)return s=[webix.$$(i)],a(s),s[0].config.id}return a(s),i},a=function(t){for(var e=t.length-1;e>=0;e--)delete webix.ui.views[t[e].config.id],t[e].config.id="x"+webix.uid(),webix.ui.views[t[e].config.id]=t[e],
...
webix.ui.QG=!1},webix.ui.each=function(t,e,i,s){if(t)for(var n=s?[t]:t.getChildViews(),a=0;a<n.length;a++)e.call(i||webix,n[a])!==!1&&webix.ui.each(n[a],e,i)},webix.event(window,"resize",function(){webix.env.touch&&(webix.edit_open_time&&new Date-webix.edit_open_time<1e3||webix.mb&&new Date-webix.mb<1e3)||webix.ui.resize();
...
}if(t.rows||t.cols){for(var s=t.rows||t.cols,n=!1,a=0;a<s.length;a++)!s[a].body||s[a].view||s[a].align||(n=!0);return n?new e.headerlayout(t):new e.layout(t)}return t.cells?new e.multiview(t):t.template||t.content?new e.template(t):t.align&&t.body?new e.align(t):new e.spacer(t)},e.views={},webix.$$=function(t){
...
var i;if("object"==typeof t){for(var s=Object.keys(t),n=[],a=0;a<s.length;a++)n[a]=t[s[a]];var i=function(t){for(var e=t.config,i=0;i<s.length;i++)if(e[s[i]]!=n[i])return!1;return!0}}else i=t;if("self"===e&&i(this))return this;var r="all"===e?[]:!1,h="parent"===e?this.gG:this.hG,o=this.iG(i,h,r);return"all"===e?r:o;
},hG:function(t){return t.getChildViews()},gG:function(t){var e=t.getParentView();return e?[e]:[]},iG:function(t,e,i){for(var s=e(this),n=0;n<s.length;n++)if(t(s[n])){if(!i)return s[n];i.push(s[n])}else{var a=s[n].iG(t,e,i);if(a)return a}return null},isVisible:function(t,e){if(this.s.hidden)return t&&(this.Yb||(this.Yb=[],
...
}var r={$layout:!0,type:this.config.type};return this.config.rows?r.rows=e:r.cols=e,r},$init:function(t){this.$ready.push(this.kc),this.y=this.w,this.lc=[],this.ht=[],t.$topView&&(t.borderless=!0,t.Ob={top:!0,left:!0,bottom:!0,right:!0}),t.isolate&&webix.extend(this,webix.IdSpace)},rows_setter:function(t){
...
this.nc=t,this.kc()}else{var s;if("number"==typeof e){(0>e||e>this.q.length)&&(e=this.q.length);var n=(this.q[e]||{}).x;webix.PowerArray.insertAt.call(this.q,t,e),t.s.hidden||webix.html.insertBefore(t.x,n,this.y)}else{s=webix.$$(e),e=webix.PowerArray.find.call(this.q,s);var a=s.x.parentNode;a&&!t.s.hidden&&a.insertBefore(t.x,s.x),
...
!r&&i>a[3]&&(n=a[3]),this.$setSize(s,n)}webix.ED&&(webix.ED=!1,this.resizeChildren()),webix.callEvent("onResize",[])}},getChildViews:function(){return this.q},index:function(t){t.s&&(t=t.s.id);for(var e=0;e<this.q.length;e++)if(this.q[e].s.id==t)return e;return-1},fc:function(t,e,i){if(t.s.hidden){t.s.hidden=!1;
...
if(e=e!==!1,i)this.s.visibleBatch="";else{if(this.s.visibleBatch==t)return;this.s.visibleBatch=t}for(var s=[],n=0;n<this.q.length;n++)this.q[n].s.batch||this.q[n].s.hidden?this.q[n].s.batch==t?e?s.push(this.q[n]):this.Fb(this.q[n],null,!0):i||this.Fb(this.q[n],null,!0):s.push(this.q[n]);for(var n=0;n<s.length;n++)this.fc(s[n],null,!0),
...
this.q[e].s.hidden||((this.y||this.w).appendChild(this.q[e].x),this.q[e].$nospace&&this.qc++);this.sc&&this.sc(t)},tc:function(t,e,i){if(this.mc!=i)for(var s=0;s<this.q.length;s++)this.q[s].s[t]=e,this.q[s].tc&&this.q[s].tc(t,e,i)},$getSize:function(t,e){var i=0,s=1e5,n=1e5,a=0;this.mc?n=0:s=0;var r=0,h=0,o=0;
this.uc=[];for(var l=0;l<this.q.length;l++)if(!this.q[l].s.hidden){var c=this.uc[l]=this.q[l].$getSize(0,0);this.q[l].$nospace?h++:this.mc?(c[0]>i&&(i=c[0]),c[1]<s&&(s=c[1]),a+=c[2],n+=c[3],c[2]==c[3]&&-1!=c[2]?(r+=c[2],h++):o+=c[4]):(c[2]>a&&(a=c[2]),c[3]<n&&(n=c[3]),i+=c[0],s+=c[1],c[0]==c[1]&&-1!=c[0]?(r+=c[0],
h++):o+=c[4])}a>n&&(n=a),i>s&&(s=i),this.vc=[r,this.q.length-h,o],this.ng=[i+t,a+e];var u=webix.ui.baseview.prototype.$getSize.call(this,0,0);return u[1]>=1e5&&(u[1]=0),u[3]>=1e5&&(u[3]=0),u[0]=(u[0]||i)+t,u[1]=Math.max(u[0],(u[1]||s)+t),u[2]=(u[2]||a)+e,u[3]=Math.max(u[2],(u[3]||n)+e),!this.mc&&this.s.responsive&&(u[0]=0),
...
webix.callEvent("onResponsiveHide",[n.s.id]),webix.ED=!0;break}i=this.q.length}}else if(this.ht.length){var n=this.ht[this.ht.length-1],a="hide"==n.lt?0:n.jt,r=n.$getSize(a,0);r[0]+this.ng[0]+this.Cc+20<=t&&(this.mt(n),webix.callEvent("onResponsiveShow",[n.s.id]),webix.ED=!0)}webix.ot=!1},rc:function(t,e){
webix.gc=(webix.gc||0)+1,!this.mc&&this.s.responsive&&this.nt(t,e),this.xc=(this.mc?e:t)-this.vc[0],this.yc=this.vc[2];for(var i=t,s=e,n=[],a=0;a<this.q.length;a++)if(!this.q[a].s.hidden&&this.uc[a]){var r=this.uc[a];if(this.mc){var s=this.wc(r,2,3);if(0>s){n.push(a);continue}}else{var i=this.wc(r,0,1);
if(0>i){n.push(a);continue}}this.q[a].$setSize(i,s)}for(var a=0;a<n.length;a++){var h=n[a],r=this.uc[h],o=Math.round(this.xc*r[4]/this.yc);this.xc-=o,this.yc-=r[4],this.mc?s=o:i=o,this.q[h].$setSize(i,s)}webix.gc-=1},zc:function(t,e){var i=this.index(t);return-1==i?null:this.q[i+e]},Ac:function(){return this.q[0];
...
},Jc:function(t,e){e.top&&(t.borderTopWidth="0px"),e.left&&(t.borderLeftWidth="0px"),e.right&&(t.borderRightWidth="0px"),e.bottom&&(t.borderBottomWidth="0px")},Ic:function(t){for(var e=0,i=0;i<t.length;i++){var s=this.q[i],n=s.s.Ob;if(s.s.hidden&&this.q[i+1]){var a=this.q[i+1].s.Ob;n.top||(a.top=!1),
n.left||(a.left=!1),i==e&&e++}this.Jc(s.x.style,s.s.Ob)}for(var r=this.mc?"marginLeft":"marginTop",h=this.mc?"marginTop":"marginLeft",o=this.mc?this.Dc:this.Ec,l=this.mc?this.Ec:this.Dc,i=0;i<t.length;i++)this.q[i].x.style[r]=(o||0)+"px";this.q.length&&(this.q[e].x.style[h]=(l||0)+"px");for(var c=e+1;c<t.length;c++)this.q[c].x.style[h]=this.Cc+"px";
...
this.Lc=t.layoutPadding}},webix.ui.baselayout),webix.ui.layout.call(webix),webix.FlexLayout={$init:function(){this.$view.className+=" webix_flexlayout"},oc:function(){},Hc:function(){},Ic:function(){},$getSize:function(t,e){var i=0,s=0,n=this.s.gravity;this.uc=[];for(var a=0;a<this.q.length;a++){var r=this.q[a].$getSize(0,0);
this.uc.push(r),i=Math.max(i,r[0]),s=Math.max(s,r[2])}i+=2*(this.Dc||0),s+=2*(this.Ec||0),this.s.width&&(i=Math.max(i,this.s.width)),this.s.height&&(s=Math.max(s,this.s.height));var h=[i,1e5,s,1e5,n];return h},render:function(){this.resize()},rc:function(t,e){if(this.isVisible(this.s.id)){var i=this.$view.style,s=Math.round(this.Cc/2);
i.paddingTop=i.paddingBottom=this.Ec-s+"px",i.paddingLeft=i.paddingRight=this.Dc-s+"px";for(var n=0;n<this.q.length;n++)if(!this.q[n].s.hidden){var a=this.q[n].$view,r=this.uc[n],h=this.q[n].s;a&&(a.style.minWidth=r[0]+"px",r[1]<1e5&&r[1]!=r[0]&&(a.style.maxWidth=r[1]+"px"),a.style.flexBasis=h.flexBasis||r[0]+"px",
a.style.flexGrow=h.flexGrow||(r[1]!=r[0]?r[4]:0),a.style.height=r[3]!=r[2]?"auto":r[2]+"px",a.style.minHeight=r[2]+"px",r[3]<1e5&&r[3]!=r[2]&&(a.style.maxHeight=r[3]+"px"),a.style.margin=s+"px")}for(var o=[],n=0;n<this.q.length;n++)if(!this.q[n].s.hidden){var a=this.q[n].$view;o[n]=[a.offsetWidth,a.offsetHeight];
}for(var n=0;n<this.q.length;n++)if(!this.q[n].s.hidden){var l=this.q[n],a=l.$view;if(a){l.s.flex=!0;var r=this.uc[n],c=r[2]==r[3]?r[2]:o[n][1];l.$setSize(o[n][0],c),l.s.flex=!1}}this.$height=this.dc=this.$view.scrollHeight,this.$view.style.height=this.dc+"px"}}},webix.protoUI({$init:function(){webix.extend(this,webix.FlexLayout,!0);
},name:"flexlayout"},webix.ui.layout),webix.protoUI({name:"proxy",body_setter:function(t){return webix.Xb=this,this.gd=webix.ui.A(t),this.x.appendChild(this.gd.x),t},getChildViews:function(){return[this.gd]},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e),this.gd.$setSize(this.$width,this.$height);
},$getSize:function(t,e){var i=webix.ui.view.prototype.$getSize.call(this,t,e),s=this.gd.$getSize(t,e);return s[0]=Math.max(i[0],s[0]),s[1]=Math.min(i[1],s[1]),s[2]=Math.max(i[2],s[2]),s[3]=Math.min(i[3],s[3]),s[4]=Math.max(i[4],s[4]),s},Qb:function(t){this.gd.destructor(),this.gd=t,this.x.appendChild(t.x);
}},webix.ui.view),webix.protoUI({name:"align",defaults:{borderless:!0,left:0,top:0,right:0,bottom:0},$init:function(){this.x.className+=" webix_view_align"},getChildViews:function(){return[this.gd]},body_setter:function(t){return t.Ob={top:!1,left:!1,right:!1,bottom:!1},webix.Xb=this,this.gd=webix.ui.A(t),
this.x.appendChild(this.gd.x),t},align_setter:function(t){"string"==typeof t&&(t=t.split(",")),this.FD=this.GD=this.HD="";for(var e=0;e<t.length;e++){var i=t[e];("center"===i||"left"===i||"right"===i)&&(this.FD=i),("top"===i||"bottom"===i||"middle"===i)&&(this.GD=i),"absolute"===i&&(this.FD=this.GD=this.HD="precise");
}return t},getBody:function(){return this.gd},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e);var i,s;this.HD?(i=t-this.s.left-this.s.right,s=e-this.s.top-this.s.bottom):(i=this.ng[0]||t,s=this.ng[2]||e),this.gd.$setSize(i,s);var n=this.gd.x;"center"==this.FD?n.style.marginLeft=Math.ceil((t-i)/2)+"px":"right"==this.FD?n.style.marginLeft=t-i+"px":n.style.marginLeft=(this.HD?this.s.left:0)+"px",
...
},webix.animate.defaults={type:"slide",delay:"0",duration:"500",timing:"ease-in-out",x:0,y:0},webix.animate.start=function(t,e){"string"==typeof e&&(e={type:e}),e=webix.Settings.E(e,webix.animate.defaults);var i,s,n=webix.env.cssPrefix,a=t.Mc=e;switch("slide"==a.type&&a.direction){case"right":a.x=t.offsetWidth;
break;case"left":a.x=-t.offsetWidth;break;case"top":a.y=-t.offsetHeight;break;case"bottom":default:a.y=a.y||t.offsetHeight}("flip"==a.type||"flipback"==a.type)&&(i=[0,0],s="scaleX","vertical"==a.subtype?(i[0]=20,s="scaleY"):i[1]=20,("right"==a.direction||"bottom"==a.direction)&&(i[0]*=-1,i[1]*=-1));var r=a.duration+"ms "+a.timing+" "+a.delay+"ms",h=n+"TransformStyle: preserve-3d;",o="",l="";
switch(a.type){case"fade":o="opacity "+r,h="opacity: 0;";break;case"show":o="opacity "+r,h="opacity: 1;";break;case"flip":r=a.duration/2+"ms "+a.timing+" "+a.delay+"ms",l="skew("+i[0]+"deg, "+i[1]+"deg) "+s+"(0.00001)",o="all "+r;break;case"flipback":a.delay+=a.duration/2,r=a.duration/2+"ms "+a.timing+" "+a.delay+"ms",
t.style[webix.env.transform]="skew("+-1*i[0]+"deg, "+-1*i[1]+"deg) "+s+"(0.00001)",t.style.left="0",l="skew(0deg, 0deg) "+s+"(1)",o="all "+r;break;case"slide":var c=a.x+"px",u=a.y+"px";l=webix.env.translate+"("+c+", "+u+("translate3d"==webix.env.translate?", 0":"")+")",o=n+"transform "+r}webix.delay(function(){
t.style[webix.env.transition]=o,webix.delay(function(){h&&(t.style.cssText+=h),l&&(t.style[webix.env.transform]=l);var e=!1,i=webix.event(t,webix.env.transitionEnd,function(s){t.Mc=null,a.callback&&a.callback.call(a.master||window,t,a,s),e=!0,webix.eventRemove(i)});window.setTimeout(function(){e||(t.Mc=null,
a.callback&&a.callback.call(a.master||window,t,a),e=!0,webix.eventRemove(i))},1.3*(1*a.duration+1*a.delay))})})},webix.MouseEvents={$init:function(t){t=t||{},this.Oc=0,this.Pc=300,this.Qc=null,this.Rc(t.onClick,"on_click"),this.Rc(t.onContext,"on_context"),this.Rc(t.onDblClick,"on_dblclick"),this.Rc(t.onMouseMove,"on_mouse_move"),
...
_c:function(t){this.callEvent("onMouseOut",[t||event])},Yc:function(t,e,i,s){if(t=t||event,!t.processed&&this.x){t.processed=!0;var n=t.target||t.srcElement;if(webix.env.isIE8){var a=this.s.id,r=n.w_view;if(r){if(r!==a)return}else n.w_view=a}for(var h="",o=null,l=!1;n&&n.parentNode&&this.x&&n!=this.x.parentNode;){
...
template:t}),t.Ob={top:!0,left:!0,right:!0,bottom:!0},webix.Xb=this,this.gd=webix.ui.A(t),this.ed.appendChild(this.gd.x),t},header_setter:function(t){return t&&(t=webix.template(t)),t},headerAlt_setter:function(t){return t&&(t=webix.template(t)),t},$getSize:function(t,e){var i=this.gd.$getSize(0,0),s=this.s.Ob;
s&&(t+=(s.left?0:1)+(s.right?0:1),e+=(s.top?0:1)+(s.bottom?0:1));var n=0,a=webix.ui.baseview.prototype.$getSize.call(this,0,0);a[0]=(a[0]||i[0])+t,a[1]>=1e5&&(a[1]=i[1]),a[1]+=t,a[2]=(a[2]||i[2])+e;var r=a[3]<1e5;return r||(a[3]=i[3]),a[3]+=e,this.getParentView().mc?this.s.collapsed?a[2]=a[3]=this.hd():this.s.header&&(n=this.s.headerHeight):(this.s.collapsed&&(a[0]=a[1]=this.hd()),
this.s.header&&(n=this.s.headerHeight)),r||(a[2]+=n,a[3]+=n),a},on_click:{webix_accordionitem_header:function(t,e){return this.id(t),!1},webix_accordionitem_header_v:function(t,e){return this.id(t),!1}},id:function(t){this.define("collapsed",!this.s.collapsed)},collapsed_setter:function(t){if(this.s.header!==!1){
...
webix.DragControl.sendSignal("stop")},zd:function(t){this.wd=webix.eventRemove(this.wd),this.yd=webix.eventRemove(this.yd),t||webix.html.removeCss(document.body,"webix_noselect")},Ad:function(t){var e=webix.DragControl,i=webix.html.pos(t),s=webix.env.mouse.context(t),n=e.$dragPos(i,t),a=e.Gd;if(e.v.style.top=i.y+e.top+(n||!a.y_offset?0:a.y_offset)+"px",
e.v.style.left=i.x+e.left+(n||!a.x_offset?0:a.x_offset)+"px",e.Ed)e.Ed=!1;else{var r=s.target=webix.env.touch?document.elementFromPoint(s.x,s.y):s.target,h=webix.env.touch?s:t;e.Fd(r,h)}return webix.html.preventEvent(t)},Fd:function(t,e){for(;t&&"BODY"!=t.tagName;){if(t.webix_drop){if(this.Cd&&(this.Cd!=t||t.webix_master)&&this.$dragOut(this.sd,this.Cd,t,e),
...
var a=e.$drag(i,t);if(e.ZB(t),!a)return!1;s=document.createElement("DIV"),s.innerHTML=a,s.className="webix_drag_zone",document.body.appendChild(s);var r=e.Gd;r.html&&webix.env.pointerevents&&(r.x_offset=-Math.round(.5*s.offsetWidth),r.y_offset=-Math.round(.75*s.offsetHeight))}return s.style.zIndex=Math.max(s.style.zIndex,webix.ui.zIndex()),
...
if("undefined"!=typeof s.x_offset&&"undefined"!=typeof s.y_offset)return null;if(s.x_offset=s.y_offset=0,webix.env.pointerevents){var n=webix.DragControl.VB();if(n.WB&&n!==this){var a=n.WB(i,t);a&&(s.x_offset=a.x-i.x,s.y_offset=a.y-i.y)}}},$dragPos:function(t,e){var i=this.pd[webix.DragControl.sd.webix_drag];
...
this.resize(!0)},show:function(t,e,i){if(t===!0){if(!this.s.hidden)return;t=null}if(!this.callEvent("onBeforeShow",arguments))return!1;this.s.hidden=!1,this.x.style.zIndex=this.s.zIndex||webix.ui.zIndex(),(this.s.modal||this.my)&&(this.Md(!0),this.my=null);var s,n,a;if(e=e||{},e.pos||(e.pos=this.s.relative),
t){"object"!=typeof t||t.tagName?(t=webix.toNode(t),s=webix.html.offset(t)):t.target||t.srcElement?(s=webix.html.pos(t),n=20,a=5):s=t;var r=Math.max(window.innerWidth||0,document.body.offsetWidth),h=Math.max(window.innerHeight||0,document.body.offsetHeight);n=n||t.offsetWidth||0,a=a||t.offsetHeight||0;
var o=this.ac,l=s.x,c=s.y,u=0,d=0,f=0,b=0,p=this.s.autofit;if(p){var x="node"===p,w=6,g=6,v=6;i="top",c=0,l=0,f=window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,r-s.x-n<o[0]&&"right"==e.pos&&!x&&(e.pos="left"),"right"==e.pos?(l=s.x+w+n,g=-a,i="left",u=Math.round(s.y+a/2),
d=l-v):"left"==e.pos?(l=s.x-w-o[0]-1,g=-a,i="right",u=Math.round(s.y+a/2),d=l+o[0]+1):(l=s.x<f?f:r+f-s.x>o[0]?s.x:r+f-w-o[0],d=Math.round(s.x+n/2),d=Math.min(d,l+o[0]-3*v)),b=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop,(!o[1]||h+b-a-s.y-g>o[1]||x)&&"top"!=e.pos?(c=a+s.y+g-4,
...
var n=window.innerWidth||document.documentElement.offsetWidth,a=window.innerHeight||document.documentElement.offsetHeight,r=Math.round((n-i)/2),h=Math.round((a-s)/2);if("function"==typeof this.s.position){var o={left:r,top:h,width:i,height:s,maxWidth:n,maxHeight:a};this.s.position.call(this,o),(o.width!=i||o.height!=s)&&this.$setSize(o.width,o.height),
this.setPosition(o.left,o.top)}else"top"==this.s.position&&(h=webix.animate.isSupported()?-1*s:10),this.s.position||(r=this.s.left||r,h=this.s.top||h),this.setPosition(r,h);"top"==this.s.position&&webix.animate(this.x,{type:"slide",x:0,y:s-2*(this.s.padding||0),duration:300,callback:this.Yd,master:this
...
e+=(i.top?0:1)+(i.bottom?0:1)),this.s.head&&(e+=1);var s=this.gd.$getSize(0,0),n=0;if(this.fd){var a=this.fd.$getSize(0,0);a[3]==a[2]&&(this.s.headHeight=a[3]),e+=this.s.headHeight,n=a[0]}if(this.s.fullscreen){var r=window.innerWidth||document.body.clientWidth,h=window.innerHeight||document.body.clientHeight;
return[r,r,h,h]}var o=webix.ui.view.prototype.$getSize.call(this,0,0);return n&&s[1]>1e5&&(s[0]=Math.max(n,s[0])),o[1]=Math.min(o[1],(s[1]>=1e5&&o[1]>=1e5?Math.max(s[0],o[0]):s[1])+t),o[3]=Math.min(o[3],(s[3]>=1e5&&o[3]>=1e5?Math.max(s[2],o[2]):s[3])+e),o[0]=Math.min(Math.max(o[0],s[0]+t),o[1]),o[2]=Math.min(Math.max(o[2],s[2]+e),o[3]),
...
},{bind:this}),t.JA&&(e=t.JA()),e.setAttribute("aria-autocomplete","list"),e.setAttribute("aria-expanded","false"),"DIV"===e.tagName&&(e.setAttribute("aria-live","assertive"),e.setAttribute("aria-atomic","true")),this.pt=!0},ce:function(t){t=t||event;var e=this.getList(),i=t.target||t.srcElement;if((i!=document.body||this.isVisible())&&"webix_clipbuffer"!=i.className){
...
if(40===s){var n=this.isVisible();n||this.show(this.ae),i.moveSelection("down",!1,!1)}else{if(i.count&&38!==s||!i.count&&!i.isVisible())return!1;var a;33==s&&(a="pgup"),34==s&&(a="pgdown"),35==s&&(a="bottom"),36==s&&(a="top"),37==s&&(a="left"),38==s&&(a="up"),39==s&&(a="right"),i.moveSelection(a,!1,!1);
...
if(!this.s.disabled&&!this.queryView({disabled:!0},"parent")){var t=this.Ie();if(t)for(var e=0;e<t.length;e++)"0"==t[e].getAttribute("tabindex")&&t[e].focus()}},JD:function(){var t=this.Ie();if(t)for(var e=0;e<t.length;e++)"0"==t[e].getAttribute("tabindex")&&t[e].blur()},ID:function(t){var e=t.which||t.keyCode,i=this.addOption?34:36;
if(e>i&&41>e){webix.html.preventEvent(t);var s,n=this.Ie();if(35==e)s=n.length-1;else if(36===e)s=0;else for(var a=37===e||38===e?-1:1,r=0;r<n.length;r++)if("0"==n[r].getAttribute("tabindex")){s=r+a,0>s?s=n.length-1:s>=n.length&&(s=0);break}if(!webix.isUndefined(s)){var h=n[s].getAttribute("button_id");
...
},$init:function(t){this.x.className+=" webix_control webix_el_"+(this.$cssName||this.name),this.data=this.s,this.y=this.x,this.$ready.push(function(){this.$B(this.config)})},hotkey_setter:function(t){var e=this;this.Bt(t,function(t,i){if(e.isVisible()){var s=e.$view.firstChild;webix.html.triggerEvent(s,"MouseEvents","click"),
webix.html.preventEvent(i)}})},Bt:function(t,e,i){var s=webix.UIManager.addHotKey(t,e,i);this.attachEvent("onDestruct",function(){webix.UIManager.removeHotKey(s,e,i)})},tooltip_setter:function(t){var e=this.re()||this.$view.firstChild;return e&&(e.title=t),t},type_setter:function(t){return this.ne[t]&&(this.$renderInput=webix.template(this.ne[t])),
...
this.se&&this.$setValue(t),void this.callEvent("onChange",[t,e]))},$compareValue:function(t,e){return"number"==typeof e&&(e=e.toString()),"number"==typeof t&&(t=t.toString()),t==e},$prepareValue:function(t){return this.VC(t,!1)},VC:function(t){return 0===t?"0":(t||"").toString()},$setValue:function(t){
var e=this.getInputNode();e&&("BUTTON"==e.tagName?e.innerHTML=t:e.value=t)},getValue:function(){var t=this.se?this.$getValue():this.s.value;return"undefined"==typeof t?"":t},$getValue:function(){return this.s.value||""},focus:function(){if(!this.s.disabled&&!this.queryView({disabled:!0},"parent")){var t=this.getInputNode();
...
return null},ue:Math.sqrt(2),pe:function(){var t=this.s,e=this.re().childNodes[1],i=e.previousSibling,s="next"==t.type?"right":"left",n=t.aheight-2*webix.skin.$active.inputPadding-2*this.ZE,a=n*this.ue/2;e.style.width=a+"px",e.style.height=a+"px",e.style.top=(n-a)/2+webix.skin.$active.inputPadding+"px",
e.style[s]=(n-a)/2+this.ue/2+"px",i.style.width=t.awidth-n/2-2+"px",i.style.height=n+2+"px",i.style[s]=n/2+2+"px",i.style.top=webix.skin.$active.inputPadding+"px"},$B:function(t){t=t||this.s,t.autowidth&&(t.width=webix.html.getTextSize(t.value||t.label||"","webixbutton").width+(t.badge?15:0)+("iconButton"===t.type?30:0)+("icon"===t.type?20:0));
...
var s=webix.html.locate(t,"radio_id");this.setValue(s),this.focus()},webix_inp_radio_label:function(t,e,i){return i=i.parentNode.getElementsByTagName("input")[0],this.on_click.webix_inp_radio_border.call(this,i,e,i)},webix_tab_more_icon:function(t,e,i){this.getPopup().resize(),this.getPopup().show(i,null,!0);
},webix_tab_close:function(t,e,i){var s=webix.html.locate(t,"button_id");s&&this.callEvent("onBeforeTabClose",[s,t])&&this.removeOption(s)}},Be:function(t){for(var e=0;e<t.length;e++)"string"==typeof t[e]?t[e]={id:t[e],value:t[e]}:(webix.isUndefined(t[e].id)&&(t[e].id=t[e].value),webix.isUndefined(t[e].value)&&(t[e].value=t[e].id));
return t},Yx:function(t){var e=t?t.placeholder:this.s.placeholder;return e?"<span class='webix_placeholder'>"+e+"</span>":""}},webix.ui.view,webix.AtomRender,webix.Settings,webix.EventSystem),webix.protoUI({name:"label",defaults:{template:"<div style='height:100%;line-height:#cheight#px'>#label#</div>"
},$skin:function(){this.defaults.height=webix.skin.$active.inputHeight},focus:function(){return!1},re:function(){return this.y.firstChild},setHTML:function(t){this.s.template=function(){return t},this.refresh()},setValue:function(t){this.s.label=t,webix.ui.button.prototype.setValue.apply(this,arguments);
},$setValue:function(t){this.y.firstChild.innerHTML=t},oe:function(){},$B:function(t){t=t||this.s,t.autowidth&&(t.width=webix.html.getTextSize(t.value||t.label,"webix_el_label").width)}},webix.ui.button),webix.protoUI({name:"icon",$skin:function(){this.defaults.height=webix.skin.$active.inputHeight},
defaults:{template:function(t){return"<button type='button'  style='height:100%;width:100%;' class='webix_icon_button'><span class='webix_icon "+webix.skin.icon+t.icon+" '></span>"+(t.badge?"<span class='webix_badge'>"+t.badge+"</span>":"")+"</button>"},width:33},oe:function(){},$setValue:function(){}
},webix.ui.button),webix.protoUI({name:"text",$allowsClear:!0,De:function(){this.$allowsClear&&(this._E||webix.UE(this.getInputNode(),"change",this.Xy,{bind:this}),this.s.suggest&&webix.$$(this.s.suggest).linkInput(this))},Xy:function(){var t=this.getValue();t!=this.s.value?this.setValue(t,!0):this.nH&&this.$setValue(t);
},$skin:function(){this.defaults.height=webix.skin.$active.inputHeight,this.defaults.inputPadding=webix.skin.$active.inputPadding,this.$E=webix.skin.$active.inputSpacing},$init:function(t){"top"==t.labelPosition&&webix.isUndefined(t.height)&&this.defaults.height&&(t.height=this.defaults.height+this.le),
this.Ns=[],this.attachEvent("onAfterRender",this.De),this.attachEvent("onBlur",function(){this._E&&this._E()})},$renderIcon:function(){var t=this.s;if(t.icon){var e=t.aheight-2*t.inputPadding,i=(e-18)/2-1,s=this.addSection?"role='button' tabindex='0' aria-label='"+webix.i18n.aria["multitext"+(t.mode||"")+"Section"]+"'":"";
return"<span style='height:"+(e-i)+"px;padding-top:"+i+"px;' class='webix_input_icon "+webix.skin.icon+t.icon+"' "+s+"></span>"}return""},relatedView_setter:function(t){return this.attachEvent("onChange",function(){var t=this.getValue(),e=this.s.relatedAction,i=this.s.relatedView,s=webix.$$(i);if(!s){
var n=this.getTopParentView();n&&n.$$&&(s=n.$$(i))}"enable"==e?t?s.enable():s.disable():t?s.show():s.hide()}),t},validateEvent_setter:function(t){return"blur"==t&&this.attachEvent("onBlur",this.validate),"key"==t&&this.attachEvent("onTimedKeyPress",this.validate),t},validate:function(){var t=this.s.validate;
!t&&this.s.required&&(t=webix.rules.isNotEmpty);var e=this.getFormView(),i=this.s.name,s=this.getValue(),n={};return n[i]=s,t&&!e.Se(t,s,n,i)?!1:!0},bottomLabel_setter:function(t){return this.s.bottomPadding||(this.s.bottomPadding=18),t},py:function(){var t=this.s.invalidMessage;return"function"==typeof t&&t.call(this),
t},setBottomText:function(t,e){var i=this.s;if("undefined"!=typeof t){if(i.bottomLabel==t)return;i.bottomLabel=t}var s=(i.invalid?i.invalidMessage:"")||i.bottomLabel;s||i.bottomPadding||(i.inputHeight=0),s&&!i.bottomPadding?(this.ry=1,i.bottomPadding=i.bottomPadding||e||18,this.render(),this.resize()):!s&&this.ry?(i.bottomPadding=this.ry=0,
i.height||this.render(),this.resize()):this.render()},$getSize:function(){var t=webix.ui.view.prototype.$getSize.apply(this,arguments),e=this.config.bottomPadding;return e&&(t[2]+=e,t[3]+=e),t},$setSize:function(t,e){var i=this.s;if(webix.ui.view.prototype.$setSize.call(this,t,e)){if(!t||!e)return;"top"==i.labelPosition?(i.inputHeight||(this.zy=this.dc-this.le-(this.config.bottomPadding||0)),
i.labelWidth=0):i.bottomPadding&&(i.inputHeight=this.dc-this.config.bottomPadding),this.render()}},Ee:function(t){var e=(this.we||0)-(t.label?this.s.labelWidth:0)-this.$E-(t.iconWidth||0);return 0>e?0:e},Fe:function(t,e){var i="x"+webix.uid(),s=e.Ee(t),n=t.inputAlign||"left",a=(this.$renderIcon?this.$renderIcon(t):"",
this.s.aheight-2*webix.skin.$active.inputPadding-2*this.ZE),r=t.text||t.value||this.Yx(t),h="<div class='webix_inp_static' role='combobox' aria-label='"+webix.template.escape(t.label)+"' tabindex='0'"+(t.readonly?" aria-readonly='true'":"")+(t.invalid?"aria-invalid='true'":"")+" onclick='' style='line-height:"+a+"px;width: "+s+"px; text-align: "+n+";' >"+r+"</div>";
...
a},$renderInput:function(t,e,i){var s=t.inputAlign||"left",n="top"==t.labelPosition,a=this.Ee(t);i=i||webix.uid();var r=this.$renderLabel(t,i),h="";if(e)h+=e;else{var o=webix.template.escape(t.text||this.VC(t.value));h+=this.qt("input")+"id='"+i+"' type='"+(t.type||this.name)+"'"+(t.editable?" role='combobox'":"")+" value='"+o+"' style='width: "+a+"px; text-align: "+s+";'";
...
var e=webix.$$(t);if(e)return webix.$$(t).s.id;t={body:{url:t,dataFeed:t}}}else t.getItem?t={body:{data:t}}:webix.isArray(t)?t={body:{data:this.Be(t)}}:t.body||(t.body={});webix.extend(t,{view:"suggest"});var i=webix.ui(t);return this.Ns.push(i),i.s.id}return!1}},webix.ui.button),webix.protoUI({name:"segmented",
$allowsClear:!1,$init:function(){this.attachEvent("onChange",function(t){this.s.multiview&&this.aF(t)}),this.attachEvent("onAfterRender",webix.once(function(){this.s.multiview&&this.s.value&&this.aF(this.s.value)}))},aF:function(t){var e=this.getTopParentView(),i=null;e&&e.$$&&(i=e.$$(t)),i||(i=webix.$$(t)),
i&&i.show&&i.show()},defaults:{template:function(t,e){!t.options;var i=t.options;e.Be(i),i=e.yC(i);var s=e.Ee(t),n=webix.uid(),a="<div style='width:"+s+"px' class='webix_all_segments' role='tablist' aria-label='"+webix.template.escape(t.label)+"'>",r=t.optionWidth||Math.floor(s/i.length);t.value||(t.value=i[0].id);
for(var h=0;h<i.length;h++)a+="<button type='button' style='width:"+(i[h].width||r)+"px' role='tab' aria-selected='"+(t.value==i[h].id?"true":"false")+"' tabindex='"+(t.value==i[h].id?"0":"-1")+"'",a+="class='webix_segment_"+(h==i.length-1?"N":h>0?1:0)+(t.value==i[h].id?" webix_selected ":"")+"' button_id='"+i[h].id+"' "+(i[h].tooltip?"title='"+i[h].tooltip+"'":"")+">",
a+=i[h].value+"</button>";return e.$renderInput(t,a+"</div>",n)}},Ie:function(){return this.$view.getElementsByTagName("BUTTON")},focus:function(){this.ub()},blur:function(){this.JD()},$setValue:function(t){for(var e=this.Ie(),i=0;i<e.length;i++){var s=e[i].getAttribute("button_id");e[i].setAttribute("aria-selected",t==s?"true":"false"),
e[i].setAttribute("tabindex",t==s?"0":"-1"),t==s?webix.html.addCss(e[i],"webix_selected"):webix.html.removeCss(e[i],"webix_selected")}var n=this.config.tabbarPopup;n&&webix.$$(n)&&webix.$$(n).getBody().exists(t)&&this.refresh()},getValue:function(){return this.s.value},getInputNode:function(){return null;
},optionIndex:function(t){for(var e=this.s.options,i=0;i<e.length;i++)if(e[i].id==t)return i;return-1},addOption:function(t,e,i,s){var n=t;"object"!=typeof t?(e=e||t,n={id:t,value:e}):(t=n.id,s=i,i=e),this.optionIndex(t)<0&&webix.PowerArray.insertAt.call(this.s.options,n,s),this.refresh(),i&&this.setValue(t);
},removeOption:function(t,e){var i=this.optionIndex(t),s=this.s.options;i>=0&&webix.PowerArray.removeAt.call(s,i),this.s.value==t&&this.zC(s,i),this.refresh(),this.callEvent("onOptionRemove",[t,this.s.value])},zC:function(t,e){var i=t.length;if(i){e=Math.min(e,i-1);for(var s=e;i>s;s++)if(!t[s].hidden)return this.setValue(t[s].id);
...
},hideOption:function(t){this.AC(t,!1)},showOption:function(t){this.AC(t,!0)},oe:!1},webix.HTMLOptions,webix.ui.text),webix.protoUI({name:"search",on_click:{webix_input_icon:function(t){this.getInputNode().focus(),this.callEvent("onSearchIconClick",[t])}},$skin:function(){this.defaults.inputPadding=webix.skin.$active.inputPadding;
},defaults:{type:"text",icon:"search"}},webix.ui.text),webix.protoUI({name:"toggle",$allowsClear:!0,$init:function(){this.attachEvent("onItemClick",function(){this.toggle()})},$setValue:function(t){var e=this.getInputNode(),i=this.s,s=t&&"0"!=t,n=(s?i.onLabel:i.offLabel)||i.label,a=e.lastChild;e.setAttribute("aria-pressed",s?"true":!1),
e.value=n,a&&((a.firstChild||a).nodeValue=" "+n),e.firstChild&&"SPAN"===e.firstChild.nodeName&&i.onIcon&&i.offIcon&&i.onIcon!==i.offIcon&&(e.firstChild.className=e.firstChild.className.replace(s?i.offIcon:i.onIcon,s?i.onIcon:i.offIcon));var r=e.parentNode;s?webix.html.addCss(r,"webix_pressed"):webix.html.removeCss(r,"webix_pressed");
...
return n+=" id='"+s+"' name='"+i+"' class='webix_inp_textarea'>"+e.VC(t.value)+"</textarea>",e.$renderInput(t,n,s)},height:0,minHeight:60},$skin:function(){this.defaults.inputPadding=webix.skin.$active.inputPadding,this.$E=webix.skin.$active.inputSpacing},Dt:!0,$renderLabel:function(t,e){var i=t.labelAlign||"left",s="top"==this.s.labelPosition,n=s?"display:block;":"width: "+this.s.labelWidth+"px;",a="";
s?this.le-2*this.ZE:(webix.skin.$active.inputHeight||this.s.aheight)-2*this.s.inputPadding;return t.label&&(a="<label style='"+n+"text-align: "+i+";' onclick='' for='"+e+"' class='webix_inp_"+(s?"top_":"")+"label "+(t.required?"webix_required":"")+"'>"+(t.label||"")+"</label>"),a},getInputNode:function(){
return this.y.getElementsByTagName("textarea")[0]}},webix.ui.text),webix.protoUI({name:"counter",defaults:{template:function(t,e){var i=t.value||0,s="x"+webix.uid(),n="<div role='spinbutton' aria-label='"+webix.template.escape(t.label)+"' aria-valuemin='"+t.min+"' aria-valuemax='"+t.max+"' aria-valuenow='"+t.value+"' class='webix_el_group' style='width:"+e.Ee(t)+"px'>";
...
t},blur:function(){var t=this.getInputNode();t&&t.blur()},De:function(){},$setValue:function(t){var e=t==this.s.checkValue,i=this.$view.getElementsByTagName("input")[0],s=i?i.parentNode:null;if(s&&this.s.customCheckbox){var n=s.getElementsByTagName("BUTTON");n[0]&&n[0].setAttribute("aria-checked",e?"true":"false");
}s&&(s.className=s.className.replace(/(webix_checkbox_)\d/,"$1"+(e?1:0))),i.checked=e},toggle:function(){var t=this.getValue()!=this.s.checkValue?this.s.checkValue:this.s.uncheckValue;this.setValue(t)},getValue:function(){var t=this.s.value;return t==this.s.checkValue?this.s.checkValue:this.s.uncheckValue;
},getInputNode:function(){return this.$view.getElementsByTagName(this.s.customCheckbox?"button":"input")[0]},$skin:function(){this.defaults.customCheckbox=!!webix.skin.$active.customCheckbox}},webix.ui.text),webix.protoUI({name:"radio",defaults:{template:function(t,e){for(var i,s=e.Be(t.options),n=[],a=0;a<s.length;a++){
...
}var a=this.config.bottomPadding;return a&&(i[2]+=a,i[3]+=a),i},Ie:function(){return this.y.getElementsByTagName(this.s.customRadio?"button":"input")},$setValue:function(t){for(var e=this.y.getElementsByTagName("input"),i=0;i<e.length;i++){e[i].parentNode.getAttribute("radio_id")==t?(e[i].checked=!0,
e[i].setAttribute("tabindex","0")):(e[i].checked=!1,e[i].setAttribute("tabindex","-1"));var s=e[i]?e[i].parentNode:null;if(s&&(s.className=s.className.replace(/(webix_radio_)\d/,"$1"+(e[i].checked?1:0)),this.s.customRadio)){var n=s.getElementsByTagName("BUTTON");n[0]&&(n[0].setAttribute("aria-checked",e[i].checked?"true":"false"),
n[0].setAttribute("tabindex",e[i].checked?"0":"-1"))}}},getValue:function(t){return this.s.value},focus:function(){this.ub()},blur:function(){this.JD()},customRadio_setter:function(t){return t===!0&&webix.skin.$active.customRadio&&(t="<a role='presentation' onclick='javascript:void(0)'><button type='button' class='webix_custom_radio' button_id='' role='radio' aria-checked='false' aria-label='' aria-invalid='' tabindex=''></button></a>"),
...
t=n(this.getInputNode().value)}}else t=this.$prepareValue(t)||null;if(this.s.stringResult){var a=webix.i18n.parseFormatStr;return i&&(a=webix.i18n.parseTimeFormatStr),!this.Hx||"month"!=e&&"year"!=e||(a=this.Hx),this.s.multiselect?[].concat(t).map(function(t){return t?a(t):""}):t?a(t):""}return t||null;
...
this.refresh()},kf:function(t,e){var i=t.from,s=!0,n=!1;if(!i&&0!==i&&this.order[0]){if(this.ff){n={};for(var a=0;a<this.order.length;a++)n[this.order[a]]=!0}s=!1,i=this.order.length}else i=1*(i||0);for(var r=0,a=0;a<e.length;a++){var h=this.driver.getDetails(e[a]),o=this.id(h);this.pull[o]?s&&this.order[r+i]&&r++:(this.order[r+i]=o,
...
return this.pull[t]},updateItem:function(t,e,i){"object"==typeof t&&(t=t.toString());var s=this.getItem(t),n=null,a=this.hasEvent("onDataUpdate");webix.isUndefined(e)||s===e||(a&&(n=webix.copy(s)),t=s.id,webix.extend(s,e,!0),s.id=t),this.pf&&this.pf(s),this.callEvent("onStoreUpdated",[t,s,i||"update"]),
a&&this.callEvent("onDataUpdate",[t,s,n])},refresh:function(t){this.rf||(t?this.exists(t)&&this.callEvent("onStoreUpdated",[t,this.pull[t],"paint"]):this.callEvent("onStoreUpdated",[null,null,null]))},silent:function(t,e){this.rf=!0,t.call(e||this),this.rf=!1},getRange:function(t,e){if(t=t?this.getIndexById(t):this.$min||this.startOffset||0,
...
this.of=t.$sort;for(var e in t)"$"!=e.substr(0,1)&&(this.tf[e]=t[e])},importData:function(t,e){var i=t?t.data||t:[];if(this.jf=null,"function"==typeof i.serialize){if(this.order=webix.toArray([].concat(i.order)),this.OF){this.OF=!1;var s=this.pull;this.pull={};for(var n in i.pull){var a=s[n];this.pull[n]=webix.copy(i.pull[n]),
a&&a.open&&(this.pull[n].open=!0)}}else this.pull=i.pull;i.branch&&this.branch&&(this.branch=webix.copy(i.branch),this.Mg=null)}else{this.order=webix.toArray(),this.pull={};var r,h;if(webix.isArray(t))for(var n=0;n<t.length;n++)h=r=t[n],"object"==typeof h?h.id=h.id||webix.uid():h={id:r,value:r},this.order.push(h.id),
...
},sync:function(t,e,i){this.unsync();var s=typeof t;if("string"==s&&(t=webix.$$(t)),"function"!=s&&"object"!=s&&(i=e,e=null),"DataStore"!=t.name){if(!t.data||"DataStore"!==t.data.name&&"TreeStore"!==t.data.name)return this.Ts=t,webix.callEvent("onSyncUnknown",[this,t,e]);t=t.data}var n=webix.bind(function(s,n,a){
this.wf||(e&&this.branch&&(this.OF=!0),this.importData(t,!0),e&&this.silent(e),this.Y&&this.Y(),this.OF,s&&n&&a||(this.Me={}),"delete"==a&&this.Me[s]&&delete this.Me[s],this.callEvent("onSyncApply",[]),i?i=!1:this.refresh())},this);this.ab=[t.attachEvent("onStoreUpdated",n),t.attachEvent("onIdChange",webix.bind(function(t,e){
...
this.detachEvent(this.Us)}else webix.callEvent("onUnSyncUnknown",[this,t]);this.Ts=null}},destructor:function(){this.unsync(),this.pull=this.order=this.Me=null,this.i=this.j={}},add:function(t,e){if(this.tf)for(var i in this.tf)webix.isUndefined(t[i])&&(t[i]=this.tf[i]);this.qf&&this.qf(t);var s=this.id(t),n=arguments[2]||this.order,a=n.length;
if((webix.isUndefined(e)||0>e)&&(e=a),e>a&&(e=Math.min(n.length,e)),this.callEvent("onBeforeAdd",[s,t,e])===!1)return!1;if(this.pull[s]=t,n.insertAt(s,e),this.jf){var r=this.jf.length;this.order.length&&(r=Math.min(e||0,r)),this.jf.insertAt(s,r)}return this.callEvent("onStoreUpdated",[s,t,"add"]),this.callEvent("onAfterAdd",[s,e]),
...
var a=this.Me[t]||{};if(this.Me[t]=a,!a[e]){if(a[e]=s||!0,i){var r=a.$css||"";a.$css=r+" "+e}n||this.refresh(t)}return a[e]},removeMark:function(t,e,i,s){var n=this.Me[t];if(n){if(n[e]&&delete n[e],i){var a=n.$css;a&&(n.$css=a.replace(e,"").replace("  "," "))}s||this.refresh(t)}},getMark:function(t,e){
...
this.Uf=webix.delay(this.Qf,this,[t,e,i],100);var s=e>t?"left":"right";("top"==i.direction||"bottom"==i.direction)&&(s=e>t?"top":"bottom"),i.flip&&(s="");var n=0,a=this.$master.y,r=!!this.$master.Vf;r&&(a=this.$master.Vf,n=a.offsetTop,webix.html.addCss(this.$master.$view,"webix_animation"));var h=a.cloneNode(!0);
h.style.width=a.style.width="100%",this.$master.refresh(),webix.html.insertBefore(h,a.nextSibling,a.parentNode),r&&(h.childNodes[1].scrollLeft=a.childNodes[1].scrollLeft);var o,l=i!==!0?i:{},c=webix.extend({direction:s,callback:webix.bind(function(){c.callback=null,webix.animate.breakLine(o),this.Tf=!1,
this.$master.Vf&&webix.html.removeCss(this.$master.$view,"webix_animation")},this),top:n,keepViews:r},l);o=webix.animate.formLine(a,h,c),webix.animate([a,h],c),this.Tf=!0}},webix.MouseEvents,webix.SingleRender,webix.ui.view,webix.EventSystem),webix.locale.pager={first:" &lt;&lt; ",last:" &gt;&gt; ",next:" &gt; ",
...
!0):void 0},setValues:function(t,e){this.s.complexData&&(t=webix.CodeParser.collapseNames(t)),this.Zf(t,e)},Zf:function(t,e){this.Yf=e,this.blockEvent(),e&&this.$f||(this.$f={});for(var i in t)this.elements[i]||(this.$f[i]=t[i]);for(var i in this.elements){var s=this.elements[i];s&&(webix.isUndefined(t[i])?!e&&s.$allowsClear&&s.setValue(""):s.setValue(t[i]),
...
e=!0,t&&("object"==typeof t?(t.hidden===!1&&(e=i.isVisible()),e&&t.disabled===!1&&(e=i.isEnabled())):e=t.call(this,i)),e?s[n]=i.getValue():delete s[n];return s},clear:function(){this.Yf=!1;var t={};for(var e in this.elements)this.elements[e].$allowsClear&&(t[e]="");this.Zf(t)},markInvalid:function(t,e){
if(e===!1)this.Qe(t);else{if("string"==typeof e){var i=this.elements[t];i&&(i.s.invalidMessage=e)}this.Te(t)}},Te:function(t){var e=this.elements[t];if(t&&e){this.Qe(t,!0),webix.html.addCss(e.x,"webix_invalid"),e.s.invalid=!0;var i=e.s.invalidMessage;"string"==typeof i&&e.setBottomText&&e.setBottomText();
...
delete e.elements),this.s.elementsConfig&&this.eg(this.nc,e.elementsConfig),t},eg:function(t,e){for(var i=0;i<t.length;i++){var s=t[i];webix.extend(s,e);var n=e;s.elementsConfig&&(n=webix.extend(webix.extend({},s.elementsConfig),e));var a;a=s.body?[s.body]:s.rows||s.cols||s.cells||s.body,a&&this.eg(a,n);
...
},content_setter:function(t){t&&(this.ig=!0,this.render=function(){},this.y.appendChild(webix.toNode(t)),webix.delay(this.hg,this))},refresh:function(){this.render()},setHTML:function(t){this.s.template=function(){return t},this.refresh()},setContent:function(t){this.y.innerHTML="",this.content_setter(t);
},$setSize:function(t,e){if(webix.ui.view.prototype.$setSize.call(this,t,e)){if(this.jg(),this.s.autoheight){var i=this.getTopParentView();clearTimeout(i.kg),i.kg=webix.delay(this.resize,this)}return!0}},$getSize:function(t,e){return!this.s.autoheight||this.s.type&&"clean"!=this.s.type||(this.s.height=this.lg()),
webix.ui.view.prototype.$getSize.call(this,t,e)},lg:function(){var t,e=webix.skin.$active.layoutPadding.space;return this.jg(),this.isVisible()?(this.y.style.height="auto",t=this.y.scrollHeight,this.y.style.height=""):t=webix.html.getTextSize(this.jb(this.data)||this.y.innerHTML,"webix_template",(this.$width||(this.getParentView()?this.getParentView().$width:0))-e).height,
...
parent:n};this.data.vf=r,i.parse(h)}s.copy||this.data.remove(t)}else{if(t==a||this.Lt(t,a))return;var o=this.getItem(t),l=this.data.branch[a];l||(l=this.data.branch[a]=[]);var c=this.data.branch[o.$parent],u=webix.PowerArray.find.call(c,t);if(0>e&&(e=l.length),c===l&&e===u)return;if(webix.PowerArray.removeAt.call(c,u),
...
d=this.getParentId(d);if(n.level||n.showSubItems)continue}else c=!0;if((r||!n.level)&&u){var f=this.branch[o]=this.Ng(t,e,u,s+1,n);l.$count=f.length,c&&f.length&&a.push(o)}}return a},count:function(){if(this.order.length)return this.order.length;var t=0;return this.eachOpen(function(){t++}),t},kG:function(t,e,i,s){
if(t[i]){for(var n=t[s]=t[i],a=0;a<n.length;a++)this.getItem(n[a]).$parent=s;delete t[i]}if(t[e]){var r=webix.PowerArray.find.call(t[e],i);r>=0&&(t[e][r]=s)}},changeId:function(t,e){if(t!=e){var i=this.getItem(t).$parent;return this.kG(this.branch,i,t,e),this.Mg&&this.kG(this.Mg,i,t,e),webix.DataStore.prototype.changeId.call(this,t,e);
...
this.pull[a]=n),this.Pg(n,i,0,r,t.from?1*t.from+s:0)}var h=this.pull[i]||{},o=this.branch[i]||[];h.$count=o.length,delete h.webix_kids,t.size&&t.size!=o.length&&(o[t.size-1]=webix.undefined)},Pg:function(t,e,i,s,n){t.$count=0,t.$parent="0"!=e?e:0,t.$level=i||("0"!=e?this.pull[e].$level+1:1);var a=this.branch[t.$parent];
...
},getTopRange:function(){return webix.toArray([].concat(this.branch[0])).map(function(t){return this.getItem(t)},this)},eachChild:function(t,e,i,s){var n=this.branch;s&&this.Mg&&(n=this.Mg);var a=n[t];if(a)for(var r=0;r<a.length;r++)a[r]&&e.call(i||this,this.getItem(a[r]))},each:function(t,e,i,s){this.eachChild(s||0,function(s){
...
t.$count=t.webix_kids?-1:0,t.$level=n?n.$level+1:1,t.$parent=n?n.id:0,this.Mg){var a=this.Mg[i||0];if(a||(a=this.Mg[i]=this.order),this.order!==a){var r=a.length;!e&&this.branch[i||0].length&&(r=0),a=webix.toArray(a),t.id=t.id||webix.uid(),a.insertAt(t.id,r)}}var h=webix.DataStore.prototype.add.call(this,t,e);
...
1==s.length&&s[0]==i&&e?delete t[e]:webix.toArray(s).remove(i)},remove:function(t){if(webix.isArray(t))for(var e=0;e<t.length;e++)this.remove(t[e]);else{var i=this.pull[t],s=i.$parent||0;if(this.callEvent("onBeforeDelete",[t])===!1)return!1;this.Rg(t),this.callEvent("onAfterDelete",[t]);var n=this.pull[s];
this.Wy(this.branch,s,t),this.Mg&&this.Wy(this.Mg,s,t);var a=0;n&&(n.$count--,n.$count<=0&&(n.$count=0,n.open=0,a=1)),this.callEvent("onStoreUpdated",[t,i,"delete"]),a&&this.refresh(n.id)}},getBranch:function(t){var e=[],i=(this.Mg||this.branch)[t];if(i)for(var s=0;s<i.length;s++)e[s]=this.pull[i[s]];
return e},serialize:function(t,e){var i=this.branch;e&&this.Mg&&(i=this.Mg);for(var s=this.branch[t||0],n=[],a=0;a<s.length;a++){var r,h=this.pull[s[a]];if(this.vf){if(r=this.vf(h),r===!1)continue}else r=webix.copy(h);this.branch[h.id]&&(r.data=this.serialize(h.id,e)),n.push(r)}return n}},webix.TreeType={
space:function(t,e){for(var i="",s=1;s<t.$level;s++)i+="<div class='webix_tree_none'></div>";return i},icon:function(t,e){return t.$count?t.open?"<div class='webix_tree_open'></div>":"<div class='webix_tree_close'></div>":"<div class='webix_tree_none'></div>"},checkbox:function(t,e){return t.nocheckbox?"":"<input type='checkbox' class='webix_tree_checkbox' "+(t.checked?"checked":"")+(t.disabled?" disabled":"")+">";
...
return e[t]};return e.$name=t,e},group:function(t){if(this.getBranchIndex)return this.jh.apply(this,arguments);"string"==typeof t&&(t={by:t,map:{}});var e="function"==typeof t.by?"value":t.by,i=this.ih(t.by);t.map[e]||(t.map[e]=[e,this.kh]);var s={},n=[];this.each(function(e){var a=i(e);s[a]||(n.push({
id:a,$group:!0,$row:t.row}),s[a]=webix.toArray()),s[a].push(e)});for(var a in t.map){var r=t.map[a][1]||"any",h=this.ih(t.map[a][0]);"function"!=typeof r&&(r=webix.GroupMethods[r]);for(var o=0;o<n.length;o++)n[o][a]=r.call(this,h,s[n[o].id])}this.nf=this.order,this.fh=this.pull,this.order=webix.toArray(),
...
var s;e?s=this.getItem(e).$level:(e=0,s=0);for(var n=this.branch[e],a=this.ih(i.by),r=[],h=[],o=0;o<n.length;o++){var l=this.getItem(n[o]),c=a(l),u=s+"$"+c,d=this.branch[u];if(!d){var f=this.pull[u]={id:u,value:c,$group:!0,$row:i.row};this.qf&&this.qf(f),h.push(f),d=this.branch[u]=[],d.lh=[],r.push(u);
}d.push(l.id),d.lh.push(l)}this.branch[e]=r;for(var b in i.map){var p=i.map[b][1]||"any",x=this.ih(i.map[b][0]);"function"!=typeof p&&(p=webix.GroupMethods[p]);for(var o=0;o<h.length;o++)h[o][b]=p.call(this,x,this.branch[h[o].id].lh)}for(var o=0;o<h.length;o++){var w=h[o];if(this.hasEvent("onGroupCreated")&&this.callEvent("onGroupCreated",[w.id,w.value,this.branch[w.id].lh]),
...
this.callEvent("onGroupFooter",[v.id,v.value,this.branch[w.id].lh])}delete this.branch[w.id].lh}this.mh(r,e,s+1),this.callEvent("onStoreUpdated",[])},hh:function(t,e,i){if(i||this.gh){this.gh=Math.max(0,this.gh-1),e=e||0;for(var s=[],n=this.branch[e],a=0;a<n.length;a++){var r=n[a],h=this.branch[r];h&&(s=s.concat(h)),
delete this.pull[r],delete this.branch[r]}this.branch[e]=s;for(var a=s.length-1;a>=0;a--)this.pull[s[a]].$footer&&s.splice(a,1);this.mh(s,0,1),t||this.callEvent("onStoreUpdated",[])}},mh:function(t,e,i){e&&(this.getItem(e).$count=t.length);for(var s=0;s<t.length;s++){var n=this.pull[t[s]];n.$level=i,
n.$parent=e;var a=this.branch[n.id];a&&this.mh(a,n.id,i+1)}}},webix.clipbuffer={nh:null,oh:null,ph:0,init:function(){return null!==this.nh?this.nh:(webix.destructors.push({obj:this}),this.nh=document.createElement("textarea"),this.nh.className="webix_clipbuffer",this.nh.setAttribute("webixignore",1),
...
86===e&&i&&(this.nh.value="",webix.delay(this.rh,this,[t],100))},this)),this.nh)},destructor:function(){this.nh=null},set:function(t){this.init(),t=""===t?"\n":t,this.nh.value=t,this.focus()},focus:function(){this.UA()||(this.init(),this.nh.focus(),this.nh.select())},UA:function(){var t="";return"undefined"!=typeof window.getSelection?t=window.getSelection().toString():"undefined"!=typeof document.selection&&"Text"==document.selection.type&&(t=document.selection.createRange().text),
...
var e=this.getItem(t),i=this.type.templateCopy(e);webix.clipbuffer.set(i,this),webix.clipbuffer.focus(),webix.UIManager.setFocus(this)}),this.attachEvent("onPaste",function(t){webix.isUndefined(this.rh[this.s.clipboard])||this.rh[this.s.clipboard].call(this,t)}),this.attachEvent("onFocus",function(){
webix.clipbuffer.focus()}),this.attachEvent("onItemClick",function(t){this.wg&&-1===this.wg.find(t)||(webix.clipbuffer.focus(),webix.UIManager.setFocus(this))}),t},rh:{insert:function(t){this.add({value:t})},modify:function(t){for(var e=this.getSelectedId(!0),i=0;i<e.length;i++)this.getItem(e[i]).value=t,
...
var s=this.s;if(!s.disabled){var n=this.getSelectedId(!0),a=this.count&&("x"==s.layout||s.xCount>1);if(("right"==t||"left"==t)&&this.ar){var r=webix.$$(this.ar);return r.Uq(!0),void("x"===r.config.layout?r.moveSelection(t):webix.UIManager.setFocus(r))}if(!n.length&&this.count()){if("down"==t||"right"==t&&a)t="top";else{
if(!("up"==t||"left"==t&&a))return;t="bottom"}n=[this.getFirstId()]}if(1==n.length){n=n[0];var h=n;if("left"==t&&this.close)return this.close(n);if("right"==t&&this.open)return this.open(n);if("top"==t)n=this.getFirstId();else if("bottom"==t)n=this.getLastId();else if("up"==t||"left"==t||"pgup"==t){var o=this.getIndexById(n),l="pgup"==t?10:1;
...
var n=t.ctrlKey||t.metaKey||"touch"==this.s.multiselect;if("level"==this.s.multiselect&&(n||t.shiftKey)){var a=this.getSelectedId(!0)[0];if(a&&this.getParentId(e)!=this.getParentId(a))return}this.select(e,!1,n,t.shiftKey)}else this.select(e)}},rh:{insert:function(t){var e=this.getSelectedId()||"0";this.add({
...
},this))},getItemNode:function(t){return this.t&&this.t[t]},showItem:function(t){var e=this.data.getIndexById(t);if(e>-1){var i=e*this.type.height,s=i+this.type.height,n=this.getScrollState(),a=webix.html.offset(this.$view);i<n.y?this.scrollTo(0,i):s>n.y+a.height&&this.scrollTo(0,s-a.height)}},render:function(t,e,i){
if(this.isVisible(this.s.id)&&!this.$blockRender){var s=this.Pe||this.y;if(!t||"paint"!=i&&"update"!=i){if("paint"!=i&&(this.t={},s.innerHTML=""),this.callEvent("onBeforeRender",[this.data])){var n=this.data.count(),a=this.getScrollState(),r=webix.html.offset(this.x),h=Math.floor(a.y/this.type.height)-2,o=Math.ceil((a.y+r.height)/this.type.height)+2;
...
},Ik:function(t){var e=Math.max(t.count,this.s.datafetch||this.s.loadahead||0);this.cf(t.count,t.start)||this.loadNext(e,t.start)}},function(){function t(t){return t=t||{},t.paper=r[(t.paper||"").toLowerCase()]||"A4",t.mode=o[t.mode]?t.mode:"portrait",t.fit=h[t.fit]?t.fit:"page",t.scroll=t.scroll||!1,
t.size=l[t.paper],t.margin=t.margin||0===t.margin?t.margin:{},a=isNaN(1*t.margin)?a:t.margin,t.margin={top:t.margin.top||0===t.margin.top?t.margin.top:a,bottom:t.margin.bottom||0===t.margin.bottom?t.margin.bottom:a,right:t.margin.right||0===t.margin.right?t.margin.right:a,left:t.margin.left||0===t.margin.left?t.margin.left:a
...
this.Qh=!1))}},getOpenState:function(){return{parents:this.Vh,branch:this.Uh}},render:function(t,e,i,s){var n,a;if(this.Vh=webix.copy(this.Vh),this.Uh=webix.copy(this.Uh),this.Vh.length)for(n=0;n<this.Vh.length;n++)this.data.branch[this.Vh[n]]||(this.Vh.splice(n,1),n--);if(a=this.Vh.length?this.Vh[this.Vh.length-1]:0,
this.Uh=webix.copy(this.data.branch[a]),!this.Uh.length&&this.Vh.length&&(this.Uh=[a],this.Vh.pop()),this.Wh)return webix.delay(this.render,this,arguments,100);for(n=0;n<this.Uh.length;n++)this.data.getItem(this.Uh[n]).$template="";if(this.Uh.length||(this.Uh=this.data.branch[0]),this.data.order=webix.toArray([].concat(this.Vh).concat(this.Uh)),
...
if(this.s.editable&&this.callEvent("onBeforeEditStart",[t])){if(this.s.form)return this.hi(t);var s=this.ii(t);if(s){if(this.getEditor(t))return;e||this.editStop();var n=webix.extend({},webix.editors[s]),a=this.ji(t,n,i);n.config.liveEdit&&(this.Ws=this.attachEvent("onKeyPress",this.Vs));var r=n.getPopup?n.getPopup(a).x:a;
...
var e=webix.$$(this.config.suggest),i=e.getList();(t||i.getSelectedId&&i.getSelectedId())&&(t=e.getSuggestion(t))}return t}},webix.editors.text),webix.editors.richselect=webix.extend({focus:function(){},getValue:function(){return this.getPopup().getValue()},setValue:function(t){var e=this.config.collection||this.config.options;
...
this.Bi=[];var i=this.Ci();(!this.y.firstChild||e)&&(this.y.innerHTML="",this.y.appendChild(this.Hi(i.Ii)),this.u=[this.y.firstChild]);for(var s=i.R;s<=i.Ji;){for(;this.u[s]&&this.u[s].Ki&&s<=i.Ji;)s++;if(s>i.Ji)break;for(var n=s;!this.u[n];)n--;var a=this.u[n],r=s*i.Di+(this.data.$min||0);if(r>(this.data.$max||1/0))break;
var h=Math.min(r+i.Di-1,this.data.$max?this.data.$max-1:1/0),o=this.Hi(i.Ei),l=this.data.getIndexRange(r,h);if(!l.length)break;for(var c={$template:"Loading"},u=0;u<l.length;u++)l[u]||this.Bi.push(r+u),l[u]=this.jb(l[u]||c);o.innerHTML=l.join("");for(var u=0;u<l.length;u++)this.t[this.data.getIdByIndex(r+u)]=o.childNodes[u];
...
var e=t.type||t.item,i=t.prerender||this.defaults.prerender||e&&"auto"==e.width;i||t.autoheight||webix.extend(this,webix.VirtualRenderStack,!0),t.autoheight&&(t.scroll=!1),this.w.className+=" webix_dataview",this.x.setAttribute("role","listbox")},Mi:function(){var t=webix.html.create("DIV",0,this.type.template({}));
...
return t},getInfo:function(t){return{size:0}},getOptions:function(){},getConfig:function(t){var e=[],i=t[0].getElementsByTagName("th");i.length&&(t[0].Oi=!0);for(var s=0;s<i.length;s++){var n={id:"data"+s,header:this.Pi(i[s].innerHTML)},a=this.Qi(i[s]);n=webix.extend(n,a),e.push(n)}return e},Pi:function(t){
...
scrollVisible:1,zoom:1},$init:function(t){var e=t.scroll||"x",i=this.x=webix.toNode(t.container);i.className+=" webix_vscroll_"+e,i.innerHTML="<div class='webix_vscroll_body'></div>",webix.UE(i,"scroll",this.Ri,{bind:this}),this.Si=0},reset:function(){this.config.scrollPos=0,this.x["x"==this.config.scroll?"scrollLeft":"scrollTop"]=0;
},Ti:function(t){return t>15e5?(this.s.zoom=t/1e6,t=1e6):this.s.zoom=1,t},scrollWidth_setter:function(t){return t=this.Ti(t),this.x.firstChild.style.width=t+"px",t},scrollHeight_setter:function(t){return t=this.Ti(t),this.x.firstChild.style.height=t+"px",t},sizeTo:function(t,e,i){t=t-(e||0)-(i||0);var s=this.s.scrollSize;
...
this.Si=t},getScroll:function(){return Math.round(this.s.scrollPos*this.s.zoom)},getSize:function(){return Math.round((this.s.scrollWidth||this.s.scrollHeight)*this.s.zoom)},scrollTo:function(t){0>t&&(t=0);var e=this.s;return t/=e.zoom,0>t&&(t=0),t!=this.s.scrollPos?(this.x["x"==e.scroll?"scrollLeft":"scrollTop"]=t,
this.Vi(t,!0),!0):void 0},Ri:function(){var t=this.x["x"==this.s.scroll?"scrollLeft":"scrollTop"];Math.floor(t)!=Math.floor(this.s.scrollPos)&&this.Vi(t,!1)},Vi:function(t,e){var i=this.s.scrollWidth||this.s.scrollHeight;t>=i-this.Si/(e?this.s.zoom:1)&&(t=Math.max(0,i-this.Si/this.s.zoom)),this.s.scrollPos=t||0,
this.callEvent("onScroll",[this.getScroll()])},activeArea:function(t,e){this.Xi=e,webix.UE(t,webix.env.isIE8?"mousewheel":"wheel",this.Yi,{bind:this}),this.uB(t)},uB:function(t){!webix.env.touch&&window.navigator.pointerEnabled&&(webix.html.addCss(t,"webix_scroll_touch_ie",!0),webix.UE(t,"pointerdown",function(t){
("touch"==t.pointerType||"pen"==t.pointerType)&&(this.km=webix.Touch.hm(t),this.vB=this.getScroll())},{bind:this}),webix.event(document.body,"pointermove",function(t){var e;this.km&&(this.lm=webix.Touch.hm(t),"x"==this.s.scroll?e=this.lm.x-this.km.x:"y"==this.s.scroll&&(e=this.lm.y-this.km.y),e&&Math.abs(e)>5&&this.scrollTo(this.vB-e));
},{bind:this}),webix.event(window,"pointerup",function(t){this.km&&(this.km=this.lm=null)},{bind:this}))},Yi:function(t){var e=0,i=0===t.deltaMode?30:1;return webix.env.isIE8&&(e=t.detail=-t.wheelDelta/30),t.deltaX&&Math.abs(t.deltaX)>Math.abs(t.deltaY)?this.Xi&&this.s.scrollVisible&&(e=t.deltaX/i):!this.Xi&&this.s.scrollVisible&&(e=webix.isUndefined(t.deltaY)?t.detail:t.deltaY/i),
webix.env.isSafari&&(this.Yy=t.target||t.srcElement),e&&this.scrollTo(this.getScroll()+e*this.s.scrollStep)?webix.html.preventEvent(t):void 0}},webix.EventSystem,webix.Settings),webix.Number={getConfig:function(t){var e={decimalSize:0,groupSize:999,prefix:"",sufix:""},i=t.split(/[0-9].*[0-9]/g);i[0].length&&(e.prefix=i[0]),
i[1].length&&(e.sufix=i[1]),(e.prefix||e.sufix)&&(t=t.substr(e.prefix.length,t.length-e.prefix.length-e.sufix.length));var s=t.indexOf("1");s>0&&(e.prefix=t.substr(0,s),t=t.substr(s));var n=t.indexOf("0");n>0&&(e.decimalSize=t.length-n,e.decimalDelimiter=t[n-1],t=t.substr(0,n-1));var a=t.match(/[^0-9]/);
return a&&(e.groupSize=t.length-a.index-1,e.groupDelimiter=t[a.index]),e},parse:function(t,e){if(!t||"string"!=typeof t)return t;e.prefix&&(t=t.toLowerCase().replace(e.prefix.toLowerCase()||"","")),e.sufix&&(t=t.toLowerCase().replace(e.sufix.toLowerCase()||"",""));var i="";if(e.decimalDelimiter){var s=t.indexOf(e.decimalDelimiter);
...
t=Math.abs(t),e.decimalOptional||(t=t.toFixed(e.decimalSize));var s=t.toString();s=s.split(".");var n="";if(e.groupSize){var a=e.groupSize,r=s[0].length;do{r-=a;var h=r>0?s[0].substr(r,a):s[0].substr(0,a+r);n=h+(n?e.groupDelimiter+n:"")}while(r>0)}else n=s[0];var s;return s=e.decimalSize?i+n+(s[1]?e.decimalDelimiter+s[1]:""):i+n,
e.prefix||e.sufix?e.prefix+s+e.sufix:s},numToStr:function(t){return function(e){return webix.Number.format(e,t)}}},webix.Date={startOnMonday:!1,toFixed:function(t,e){return 10>t&&(t="0"+t),e&&100>t&&(t="0"+t),t},weekStart:function(t){t=this.copy(t);var e=t.getDay();return this.startOnMonday&&(0===e?e=6:e--),
this.datePart(this.add(t,-1*e,"day"))},monthStart:function(t){return t=this.copy(t),t.setDate(1),this.datePart(t)},yearStart:function(t){return t=this.copy(t),t.setMonth(0),this.monthStart(t)},dayStart:function(t){return this.datePart(t,!0)},dateToStr:function(t,e){return"function"==typeof t?t:webix.env.strict?function(e){
var i="",s=0;return t.replace(/%[a-zA-Z]/g,function(n,a){i+=t.slice(s,a);var r=function(t){if("%d"==n)return webix.Date.toFixed(t.getDate());if("%m"==n)return webix.Date.toFixed(t.getMonth()+1);if("%j"==n)return t.getDate();if("%n"==n)return t.getMonth()+1;if("%y"==n)return webix.Date.toFixed(t.getFullYear()%100);
if("%Y"==n)return t.getFullYear();if("%D"==n)return webix.i18n.calendar.dayShort[t.getDay()];if("%l"==n)return webix.i18n.calendar.dayFull[t.getDay()];if("%M"==n)return webix.i18n.calendar.monthShort[t.getMonth()];if("%F"==n)return webix.i18n.calendar.monthFull[t.getMonth()];if("%h"==n)return webix.Date.toFixed((t.getHours()+11)%12+1);
if("%g"==n)return(t.getHours()+11)%12+1;if("%G"==n)return t.getHours();if("%H"==n)return webix.Date.toFixed(t.getHours());if("%i"==n)return webix.Date.toFixed(t.getMinutes());if("%a"==n)return t.getHours()>11?webix.i18n.pm[0]:webix.i18n.am[0];if("%A"==n)return t.getHours()>11?webix.i18n.pm[1]:webix.i18n.am[1];
if("%s"==n)return webix.Date.toFixed(t.getSeconds());if("%S"==n)return webix.Date.toFixed(t.getMilliseconds(),!0);if("%W"==n)return webix.Date.toFixed(webix.Date.getISOWeek(t));if("%c"==n){var e=t.getFullYear();return e+="-"+webix.Date.toFixed(t.getMonth()+1),e+="-"+webix.Date.toFixed(t.getDate()),e+="T",
e+=webix.Date.toFixed(t.getHours()),e+=":"+webix.Date.toFixed(t.getMinutes()),e+=":"+webix.Date.toFixed(t.getSeconds())}return n};i+=r(e),s=a+2}),i+=t.slice(s,t.length)}:(t=t.replace(/%[a-zA-Z]/g,function(t){switch(t){case"%d":return'"+webix.Date.toFixed(date.getDate())+"';case"%m":return'"+webix.Date.toFixed((date.getMonth()+1))+"';
case"%j":return'"+date.getDate()+"';case"%n":return'"+(date.getMonth()+1)+"';case"%y":return'"+webix.Date.toFixed(date.getFullYear()%100)+"';case"%Y":return'"+date.getFullYear()+"';case"%D":return'"+webix.i18n.calendar.dayShort[date.getDay()]+"';case"%l":return'"+webix.i18n.calendar.dayFull[date.getDay()]+"';
case"%M":return'"+webix.i18n.calendar.monthShort[date.getMonth()]+"';case"%F":return'"+webix.i18n.calendar.monthFull[date.getMonth()]+"';case"%h":return'"+webix.Date.toFixed((date.getHours()+11)%12+1)+"';case"%g":return'"+((date.getHours()+11)%12+1)+"';case"%G":return'"+date.getHours()+"';case"%H":return'"+webix.Date.toFixed(date.getHours())+"';
case"%i":return'"+webix.Date.toFixed(date.getMinutes())+"';case"%a":return'"+(date.getHours()>11?webix.i18n.pm[0]:webix.i18n.am[0])+"';case"%A":return'"+(date.getHours()>11?webix.i18n.pm[1]:webix.i18n.am[1])+"';case"%s":return'"+webix.Date.toFixed(date.getSeconds())+"';case"%S":return'"+webix.Date.toFixed(date.getMilliseconds(), true)+"';
...
var i,s,n,a=t.match(/%[a-zA-Z]/g),r="var temp=date.split(/[^0-9a-zA-Z]+/g);";if(!webix.i18n.calendar.monthShort_hash){for(n=webix.i18n.calendar.monthShort,s=webix.i18n.calendar.monthShort_hash={},i=0;i<n.length;i++)s[n[i]]=i;for(n=webix.i18n.calendar.monthFull,s=webix.i18n.calendar.monthFull_hash={},
i=0;i<n.length;i++)s[n[i]]=i}if(webix.env.strict)return function(t){if(!t)return"";if("object"==typeof t)return t;var s=t.split(/[^0-9a-zA-Z]+/g),n=[0,0,1,0,0,0,0];for(i=0;i<a.length;i++){var r=a[i];if("%y"==r)n[0]=1*s[i]+(s[i]>30?1900:2e3);else if("%Y"==r)n[0]=1*(s[i]||0),n[0]<30&&(n[0]+=2e3);else if("%n"==r||"%m"==r)n[1]=(s[i]||1)-1;else if("%M"==r)n[1]=webix.i18n.calendar.monthShort_hash[s[i]]||0;else if("%F"==r)n[1]=webix.i18n.calendar.monthFull_hash[s[i]]||0;else if("%j"==r||"%d"==r)n[2]=s[i]||1;else if("%g"==r||"%G"==r||"%h"==r||"%H"==r)n[3]=s[i]||0;else if("%a"==r)n[3]=n[3]%12+((s[i]||"")==webix.i18n.am[0]?0:12);else if("%A"==r)n[3]=n[3]%12+((s[i]||"")==webix.i18n.am[1]?0:12);else if("%i"==r)n[4]=s[i]||0;else if("%s"==r)n[5]=s[i]||0;else if("%S"==r)n[6]=s[i]||0;else if("%c"==r){
...
e(t[s],i[s]))};"string"==typeof t&&(t=this.locales[t]),t&&(t.priceSettings=webix.copy(t.priceSettings||t),e(this,t));for(var i=webix.i18n.Zi,s=0;s<i.length;s++){var n=i[s],a=webix.i18n[n+"UTC"];webix.i18n[n+"Str"]=webix.Date.dateToStr(webix.i18n[n],a),webix.i18n[n+"Date"]=webix.Date.strToDate(webix.i18n[n],a);
...
},richtext:{underline:"Underline",bold:"Bold",italic:"Italic"},combo:{select:"Select",selectAll:"Select all",unselectAll:"Unselect all"},message:{ok:"OK",cancel:"Cancel"}},webix.i18n.setLocale("en-US"),webix.protoUI({name:"datatable",defaults:{leftSplit:0,rightSplit:0,topSplit:0,columnWidth:100,minColumnWidth:20,
minColumnHeight:26,prerender:!1,autoheight:!1,autowidth:!1,header:!0,fixedRowHeight:!0,scrollAlignY:!0,scrollX:!0,scrollY:!0,datafetch:50,navigation:!0},$skin:function(){var t=webix.skin.$active.rowHeight,e=this.defaults;e.rowHeight=t,e.headerRowHeight=webix.skin.$active.barHeight},on_click:{webix_richfilter:function(){
return!1},webix_table_checkbox:function(t,e){e=this.locate(t);var i=this.getItem(e.row),s=this.getColumnConfig(e.column),n=t.target||t.srcElement,a="checkbox"==n.type?n.checked:i[e.column]!=s.checkValue,r=a?s.checkValue:s.uncheckValue,h={};return h[e.column]=r,this.updateItem(e.row,h,this.s.checkboxRefresh?"update":"save"),
this.callEvent("onCheck",[e.row,e.column,r]),!1},webix_table_radio:function(t){var e=this.locate(t),i=this.getItem(e.row),s=this.getColumnConfig(e.column);return this.eachRow(function(t){var i=this.data.pull[t];i&&i[e.column]==s.checkValue&&(i[e.column]=s.uncheckValue)}),i[e.column]=s.checkValue,this.callEvent("onCheck",[e.row,e.column,!0]),
...
}this.rj()}if(!this.isVisible(this.s.id)||this.$blockRender)return this.mj();var a=this.config.experimental&&!this.s.subview;return!t||-1==e||"paint"!=i&&"update"!=i||a?(this.sj&&(clearTimeout(this.sj),this.sj=0),this.callEvent("onBeforeRender",[this.data])?(this.mj(),this.tj||this.uj(),this.bc&&(a&&("paint"==i||"update"==i)&&t?this.Kv(t):this.vj(!0,!0)),
...
i[n]=" webix_first",i[n-1]=" webix_last"}i[0]=(i[0]||"")+" webix_first";var a=this.fj.length-1;i[a]=(i[a]||"")+" webix_last";for(var t=0;t<this.fj.length;t++){var r=this.fj[t].node;r.setAttribute("column",t),r.className="webix_column "+(this.fj[t].css||"")+(i[t]||"")}this.Hj(),this.Ij(),this.Jj(),this.Kj(),
...
},RF:function(t,e,i){var s=0,n=t.colspan||1,a="webix_hcell "+(t.css||"");if(t.rotate)a+=" webix_measure_rotate";else for(var r=0;n>r;r++)s+=this.fj[i+r]?this.fj[i+r].width:this.config.columnWidth;var h=webix.html.getTextSize([t.text],a,s);return(t.rotate?h.width:h.height)+1},Mj:function(t,e){for(var i=0,s=0;s<this.fj.length;s++){
var n=this.fj[s][t];n&&"object"==typeof n&&n.length||(webix.isUndefined(n)&&(n="header"==t?this.fj[s].id:""),n=[n]);for(var a=0;a<n.length;a++)"object"!=typeof n[a]&&(n[a]={text:n[a]}),n[a]&&n[a].height&&(e[a]=n[a].height),n[a]&&n[a].autoheight&&(e[a]=this.RF(n[a],this.fj[s],s));i=Math.max(i,n.length),
this.fj[s][t]=n}e.Ot=i;for(var s=i-1;s>=0;s--)e[s]=e[s]||this.s.headerRowHeight,e.Ot+=1*e[s];for(var s=0;s<this.fj.length;s++)for(var r=this.fj[s][t],a=0;a<r.length;a++){if(r[a]&&r[a].rowspan)for(var h=1;h<r[a].rowspan;h++)r[a+h]=null;if(r[a]&&r[a].colspan)for(var h=1;h<r[a].colspan;h++)this.fj[s+h][t][a]=null;
...
},Qj:function(t,e,i,s,n){if(t==e)return"";for(var a="<table role='presentation' style='width:"+i+"px' cellspacing='0' cellpadding='0'>",r=t;e>r;r++){a+="<tr class='webix_size_row'>";for(var r=t;e>r;r++)a+="<td style='width:"+this.fj[r].width+"px;'></td>";a+="</tr>"}for(var h=this.fj[0][s].length,o=0;h>o;o++){
a+="<tr section='"+s+"' role='row'>";for(var r=t;e>r;r++){var l=this.fj[r][s][o];if(null!==l){l.content&&(l.contentId=l.contentId||webix.uid(),l.columnId=this.fj[r].id,l.format=this.fj[r].format,l.text=webix.ui.datafilter[l.content].render(this,l),this.hj[l.contentId]=l,this.Rj=!0),a+="<td  role='presentation' column='"+(l.colspan?l.colspan-1+r:r)+"'";
...
var e=t.parentNode;if(!e)return null;var i=1*(t.getAttribute("column")||e.getAttribute("column")),s=t.getAttribute("row")||0,n=1*(t.getAttribute("colspan")||e.getAttribute("colspan"));if(!s)for(var a=0;a<e.childNodes.length;a++)e.childNodes[a]==t&&(s=a>=this.s.topSplit?a+this.fj[i].qk-this.s.topSplit:a);
...
},Xs:function(t,e,i,s){if(!(isNaN(e)||0>t)){var n=this.fj[t];n.minWidth&&e<n.minWidth?e=n.minWidth:e<this.s.minColumnWidth&&(e=this.s.minColumnWidth);var a=n.width;return a!=e?(t>=this.s.leftSplit&&t<this.Fj&&(this.Gj+=e-a),n.width=e,n.node?(n.node.style.width=e+"px",i||this.rk(),this.callEvent("onColumnResize",[n.id,e,a,!!s]),
...
ug:function(t,e){var i;1==arguments.length&&(e=t.column,t=t.row);for(var s=this.getItem(t),n=this.getColumnConfig(e),a=0,r=0,h=0;h<this.fj.length;h++){(h==this.s.leftSplit||h==this.Fj)&&(a=0);var o=this.fj[h];if(o.id==e){var l=h<this.s.leftSplit?0:h>=this.Fj?2:1;r=this.Vf.childNodes[l].firstChild;break;
}a+=o.width}return i=this.getIndexById(t)<this.s.topSplit?this.Tj(0,this.getIndexById(t)):this.Tj((this.ak||0)-this.s.topSplit,this.getIndexById(t))+(this.ck||0),{parent:r,top:i,left:a,width:n.width,height:s.$height||this.s.rowHeight}},xj:function(){var t=this.s.pager,e=0,i=this.data.order.length;return t&&(e=t.size*t.page,
...
var e=this.jk,i=0,s=this.count(),n=this.s.pager;if(n){var i=n.page*n.size,s=Math.min(s,i+n.size);n.level&&(i=this.data.$min,s=this.data.$max)}if(this.s.autoheight)return[i,s,0];if(t)return[i,s,0];var a=i,r=this.s.topSplit||0;r&&(a+=r);var h=this.s.fixedRowHeight?this.s.rowHeight:0;if(h){var o=Math.ceil(e/h);
e-=o*h,a+=o}else for(;e>0;)e-=this.Uj(a),a++;var l=a>0&&e?-(this.Uj(a-1)+e):0,c=a;if(e&&a--,e+=(this.Vj||this.dc)-(this.xD||0),h){var o=Math.ceil(e/h);e-=o*h,c+=o}else for(;e>0&&s>c;)e-=this.Uj(c),c++;return c>s&&(c=s),[a,c,l]},Kv:function(t){var e=this.getItem(t),i=this.getIndexById(t),s=this.Sj(),n=this.config.topSplit,a="";
if(i>=n){if(i<s[0]||i>=s[1])return;i-=s[0]-n}else a=i==n-1?" webix_topcell webix_last_topcell":" webix_topcell";for(var r=this.Xj(),h=0;h<this.fj.length;h++){var o=this.fj[h];if(h<this.Fj&&h>=this.s.leftSplit&&(h<r[0]||h>r[1])&&(o.qk=-999),o.attached&&o.node){var l=o.node.childNodes[i];if(!l)continue;
var c=this.Ek(e,this.fj[h],0);l.innerHTML=c,l.className=this.Mv(this.fj[h],c,e,t)+a}}},vj:function(t,e){if(this.fj.length){e&&this.uk();var i=this.Xj(this.s.prerender),s=this.Sj(this.s.prerender===!0);if(t){for(var n=this.s.leftSplit;n<i[0];n++)this.vk(n,e);for(var n=i[1];n<this.Fj;n++)this.vk(n,e)}this.wk=[];
for(var a=0,n=0;n<this.s.leftSplit;n++)a+=this.xk(n,s,e);for(var n=i[0];n<i[1];n++)a+=this.xk(n,s,e,n==i[0]);for(var n=this.Fj;n<this.fj.length;n++)a+=this.xk(n,s,e);this.yk(s[0],s[1],e),this.zk(s)}},Ak:function(t,e){this.Bk=t,this.Ck=e,webix.html.remove(this.gj),this.gj=[]},dF:function(){if(this.s.prerender&&this.GA){
var t=this.getScrollState();this.GA.style.top="-"+(t.y||0)+"px"}},yk:function(t,e,i){if(this.GA&&(this.GA.style.top=this.ck+"px"),i||t!=this.Bk||e!=this.Ck){if(this.Ak(t,e),this.Dk){this.Dk=!1;for(var s=0;s<this.wk.length;s++){var n,a=this.wk[s],r=this.getItem(a.id);n="function"==typeof r.$row?r.$row.call(this,r,this.type):this.Ek(r,this.getColumnConfig(r.$row),s);
var h=this.gj[s]=webix.html.create("DIV",null,n);h.className="webix_cell "+(r.$sub?"webix_dtable_sub"+(this.s.subview?"view":"row"):"webix_dtable_colrow"+(r.$row?" webix_topcell"+(this.data.getMark(r.id,"webix_selected")?" webix_selected":""):"")),h.setAttribute("column",0),h.setAttribute("row",a.index);
var o=r.$height||this.s.rowHeight;r.$subopen?h.style.height=r.$subHeight+"px":h.style.height=o+"px",h.style.paddingRight=webix.ui.scrollSize+"px";var l=this.wk[s].index<this.config.topSplit?-this.ck:0;h.style.top=l+a.top+(r.$subopen?o-1:0)+"px",this.GA||(this.GA=webix.html.create("DIV"),this.GA.style.position="relative",
this.GA.style.top=this.ck+"px",this.Vf.appendChild(this.GA)),this.GA.appendChild(h),this.attachEvent("onSyncScroll",function(t,e,i){webix.Touch.Nf(this.GA,0,e,i)}),this.s.subview&&this.callEvent("onSubViewRender",[r,h])}}}else if(this.config.topSplit)for(var s=0;s<this.wk.length;s++){var h=this.gj[s];
...
}else if(this.s.loadahead){this.Hk(t,this.s.loadahead,s)}},Hk:function(t,e,i){var s=t[1],n=s+e;i||(s=t[0]-e,n=t[0]),0>s&&(s=0),n=Math.min(n,this.data.order.length-1);for(var a=!1,r=s;n>r;r++)this.data.order[r]||(a?(a.last=r,a.count=r-s):a={start:r,count:n-s});return a?(this.Ik(a,i),!0):void 0},Ik:function(t,e){
var i=Math.max(t.count,this.s.datafetch||this.s.loadahead||0),s=e?t.start:t.last-i+1;this.cf(t.count,t.start)||this.loadNext(i,s)},Zy:function(t){if(webix.env.isSafari){var e,i,s,n,a=[this.Zj,this.Wj];for(e=0;2>e;e++)n=a[e],n&&n.Yy&&n.Yy.parentNode==t&&(i=n.Yy);i&&(this.$y&&webix.html.remove(this.$y),
...
this.gj=[])},getText:function(t,e){return this.Ek(this.getItem(t),this.getColumnConfig(e),0)},getCss:function(t,e){var i=this.getItem(t);return this.Mv(this.getColumnConfig(e),i[e],i,t)},Mv:function(t,e,i,s){var n="webix_cell";if(t.cssFormat){var a=t.cssFormat(e,i,s,t.id);a&&(n+="object"==typeof a?" "+webix.html.createCss(a):" "+a);
}var r=i.$css;r&&("object"==typeof r&&(i.$css=r=webix.html.createCss(r)),n+=" "+r);var h=this.data.Me[s];if(h&&(h.$css&&(n+=" "+h.$css),h.$cellCss)){var o=h.$cellCss[t.id];o&&(n+=" "+o)}if(i.$cellCss){var l=i.$cellCss[t.id];l&&("object"==typeof l&&(l=webix.html.createCss(l)),n+=" "+l)}var c=this.data.getMark(i.id,"webix_selected");
...
t},xk:function(t,e,i,s){var n=this.fj[t];if(!n.attached){var a=t<this.s.leftSplit?0:t>=this.Fj?2:1;this.Vf.childNodes[a].firstChild.appendChild(n.node),n.attached=!0,n.split=a}if(this.ak=e[0],this.ck=0,this.aC=e[2],this.s.scrollAlignY?e[1]==this.data.order.length||this.data.$pagesize&&e[1]%this.data.$pagesize===0?n.node.style.top=(this.ck=e[2])+"px":n.Jk&&(n.node.style.top="0px"):(this.ck=e[2],
n.node.style.top=e[2]+"px"),!(i||n.qk!=e[0]||n.Kk!=e[1]||this.s.topSplit&&n.ck!=this.ck))return 0;for(var r="",h=this.s.columns[t],o={row:this.s.rowHeight,total:0,single:s},l=0;l<this.s.topSplit;l++)r+=this.yD(l,h,e,o,-this.ck);this.Gk=null;for(var l=Math.max(e[0],this.s.topSplit);l<e[1];l++)r+=this.yD(l,h,e,o,-1);
...
if(s.single&&h.$row&&(this.Dk=!0,this.wk.push({top:s.total,id:h.id,index:t}),!h.$sub)){var c=h.$height||s.row;return s.total+=c,"<div"+l+" class='webix_cell' style='height:"+c+"px;'></div>"}var a=this.Ek(h,e,t),u=this.Mv(e,a,h,r);-1!==u.indexOf("select")&&(l+=" aria-selected='true' tabindex='0'");var d=!!h.$subopen,f=d?"margin-bottom:"+h.$subHeight+"px;":"";
...
}this.Qc=l={row:this.data.order[b],column:this.fj[d].id},l.toString=this.ok}else this.Qc=l={column:this.fj[d].id};if(a=this.iA(h,t,l,n),a===!1)return;if(f)this.callEvent("on"+i,[l,t,n])&&s&&this.callEvent("on"+s,[l,t,n]);else if("ItemClick"==i){var p="header"==n.parentNode.parentNode.getAttribute("section");
...
this.Rk=null)},mapCells:function(t,e,i,s,n,a){if(null===t&&this.data.order.length>0&&(t=this.data.order[0]),null===e&&(e=this.columnId(0)),null===i&&(i=this.data.order.length),null===s&&(s=this.s.columns.length),this.exists(t)&&(t=this.getIndexById(t),e=this.getColumnIndex(e),null!==e))for(var r=0;i>r&&t+r<this.data.order.length;r++){
var h=t+r,o=this.data.order[h];if(o)for(var l=this.getItem(o),c=0;s>c&&e+c<this.s.columns.length;c++){var u=e+c,d=this.columnId(u),f=n(l[d],o,d,r,c);a||(l[d]=f)}}},dj:function(t,e){!this.s.columns&&t.getConfig&&this.define("columns",t.getConfig(e))},qj:function(){var t=this.getItem(this.getFirstId()),e=this.s.columns=[];
...
n.getBody&&(n=n.getBody()),this.Zk.call(n,"id","value",e,i)}else this.Zk(s.id,s.id,e,i);var s={values:e};return this.callEvent("onCollectValues",[t,s]),s.values},Zk:function(t,e,i,s){if(this.data.each(function(n){var a=n?n[t]:"";if(a!==webix.undefined&&!s[a]){s[a]=!0;var r=n[t];0===r&&(r="0"),i.push({
id:r,value:n[e]})}},this,!0),i.length){var n="string"==typeof i[0].value?"string":"raw";i.sort(this.data.sorting.create({as:n,by:"value",dir:"asc"}))}},jA:function(t){this.loadNext(0,0,{before:function(){this.editStop&&this.editStop(),this.clearAll(!0)},success:function(){this.callEvent("onAfterFilter",[]);
...
this.callEvent("onSelectChange",[]))},bl:function(t,e){var i=t.ctrlKey||t.metaKey||"touch"==this.s.multiselect,s=t.shiftKey;if(this.s.multiselect||"multiselect"==this.s.select||"area"==this.s.select||(i=s=!1),s&&this.el.length){var n=this.el[this.el.length-1];this.ol(e,n)}else i&&this.gl[this.fl(e)]?this.ll(e):this.hl({
row:e.row,column:e.column},i)},pl:function(t,e,i){var s=this.s.columns;if(e){for(var n=[],a=0;a<s.length;a++)s[a].$selected&&n.push(s[a]);s=n}for(var r=this.data.order,h=0,a=0;a<r.length;a++){var o=this.getItem(r[a]);if(o){var l=this.data.getMark(o.id,"webix_selected");if(l||e){for(var c=0,u=0;u<s.length;u++){
var d=s[u].id;if(i||e||l[d]){if(!t)return{row:r[a],column:d};o[d]=t(o[d],r[a],d,h,c),c++}}h++}}}}},row:{Lk:" webix_row_select",fl:function(t){return t.row},select:function(t,e){t&&(t=t.toString()),this.hl({row:t},e)},kl:function(t){return this.nl(t.row).$row=!0,t.row},unselect:function(t){this.ll({row:t
...
if(s>n){var a=s;s=n,n=a}this.Dg=!0;for(var r=s;n>=r;r++){var h=this.getIdByIndex(r);if(!h){t&&this.select(t);break}this.select(h,i)}this.Dg=!1,this.jl()}},cell:{fl:function(t){return t.column?t.row+"_"+t.column:null},select:function(t,e,i){this.hl({row:t,column:e},i)},kl:function(t){var e=this.nl(t.row);
...
},selectRange:function(t,e,i,s,n){webix.isUndefined(n)&&(n=!0);var a=t?this.getIndexById(t):0,r=i?this.getIndexById(i):this.data.order.length-1,h=e?this.getColumnIndex(e):0,o=s?this.getColumnIndex(s):this.fj.length-1;if(a>r){var l=a;a=r,r=l}if(h>o){var l=h;h=o,o=l}this.Dg=!0;for(var c=a;r>=c;c++)for(var u=h;o>=u;u++)this.select(this.getIdByIndex(c),this.columnId(u),n);
...
if(s>n){var a=s;s=n,n=a}this.Dg=!0;for(var r=s;n>=r;r++)this.select(this.columnId(r),i);this.Dg=!1,this.Kj(),this.jl()},rF:function(){}},area:{fl:function(t){return t.row+"_"+t.column},getSelectedId:function(t){var e=this.getSelectArea(),i=[];if(e)if(!t||e.start.row==e.end.row&&e.start.column==e.end.column)i.push(e.end);else{
var s=this.getIndexById(e.start.row),n=this.getIndexById(e.end.row);if(-1==s||-1==n)return i;for(var a=this.getColumnIndex(e.start.column),r=this.getColumnIndex(e.end.column),h=s;n>=h;h++)for(var o=a;r>=o;o++)i.push({row:this.getIdByIndex(h),column:this.columnId(o)})}return t?i:i[0]},unselect:function(t){
...
var c=this.fj[l].id;if(!t)return{row:h,column:c};o[c]=t(o[c]||"",h,c,r-n,l-i)}},select:function(t,e,i){this.hl({row:t,column:e},i)},ol:function(t,e){this.gC(t,e)},hl:function(t,e){return this.addSelectArea(t,t,!1),!0},rF:function(){this.el.length&&this.refreshSelectArea()}}}}),webix.extend(webix.ui.datatable,{
...
if(t.target&&"INPUT"==t.target.tagName||this.Pl)return;this.xl=webix.html.offset(this.Vf);var e=webix.html.pos(t);this.ul=[e.x-this.xl.x,e.y-this.xl.y],webix.html.preventEvent(t)}},tl:function(t){this.yl&&(this.jz("select",!0,t),this.yl=webix.html.remove(this.yl)),webix.html.removeCss(document.body,"webix_noselect"),
...
this.vl===!1&&this.Al(t),this.vl=i,this.jz(this.config.blockselect,!1,t)}},zl:function(t,e){var i=!1,s=null,n=null;if(this.ek&&t>this.dk+this.Yj?t+=this.Zj.getSize()-this.Yj-this.dk-this.ek:(!this.dk||t>this.dk)&&(t+=this.Zj.getScroll()),this.s.topSplit&&this.ak>this.s.topSplit){var a=this.ug(this.getIdByIndex(this.s.topSplit-1),this.columnId(0));
...
if(e=e||this.delimiter,!this.escape)return this.Wl(t,e);for(var i=t.replace(/\n$/,"").split(e.rows),s=0;s<i.length-1;)this.Xl(i[s],'"')%2===1&&(i[s]+=e.rows+i[s+1],delete i[s+1],s++),s++;var n=[];for(s=0;s<i.length;s++)if("undefined"!=typeof i[s]){for(var a=i[s],r=0,h=[],o=!1,l=0;l<=a.length;l++){if(!o&&a[l]===e.cols||l===a.length){
var c=a.substr(r,l-r);c[0]===c[c.length-1]&&'"'===c[0]&&(c=c.substr(1,c.length-2).replace('""','"')),h.push(c),r=l+1}'"'!==a[l]||(o=!o)}n.push(h)}return n},Wl:function(t,e){for(var i=t.split(e.rows),s=0;s<i.length;s++)i[s]=i[s].split(e.cols);return i},Xl:function(t,e){var i=t.split(e);return i.length-1;
...
webix.UIManager.setFocus(this))}),this.attachEvent("onPaste",this.Zl),t},templateCopy_setter:webix.template,Yl:function(){var t=this.$l();webix.clipbuffer.set(t),webix.UIManager.setFocus(this)},$l:function(){var t=[],e=this.s.templateCopy;this.mapSelection(function(i,s,n,a,r){t[a]||(t[a]=[]);var h=e?e(i,s,n):i;
return t[a].push(h),i});var i=1===t.length&&1===t[0].length?t[0][0]:webix.csv.stringify(t,this.s.delimiter);return i},Zl:function(t){if(!webix.isUndefined(this.rh[this.s.clipboard])){var e=webix.csv.parse(t,this.s.delimiter);this.rh[this.s.clipboard].call(this,e)}},rh:{block:function(t){var e=this.mapSelection(null);
e&&(this.mapCells(e.row,e.column,t.length,null,function(e,i,s,n,a){return t[n]&&t[n].length>a?t[n][a]:e}),this.render())},selection:function(t){this.mapSelection(function(e,i,s,n,a){return t[n]&&t[n].length>a?t[n][a]:e}),this.render()},repeat:function(t){this.mapSelection(function(e,i,s,n,a){return i=t[n%t.length],
e=i[a%i.length]}),this.render()},custom:function(t){}}},webix.extend(webix.ui.datatable,webix.TablePaste),webix.storage||(webix.storage={}),webix.storage.prefix=function(t,e){return t+=".",{put:function(i,s){return e.put(t+i,s)},get:function(i){return e.get(t+i)},remove:function(i){return e.remove(t+i);
}}},webix.storage.local={put:function(t,e){t&&window.JSON&&window.localStorage&&window.localStorage.setItem(t,webix.stringify(e))},get:function(t){if(t&&window.JSON&&window.localStorage){var e=window.localStorage.getItem(t);return e?webix.DataDriver.json.toObject(e):null}return null},remove:function(t){
t&&window.JSON&&window.localStorage&&window.localStorage.removeItem(t)},clear:function(){window.localStorage.clear()}},webix.storage.session={put:function(t,e){t&&window.JSON&&window.sessionStorage&&window.sessionStorage.setItem(t,webix.stringify(e))},get:function(t){if(t&&window.JSON&&window.sessionStorage){
var e=window.sessionStorage.getItem(t);return e?webix.DataDriver.json.toObject(e):null}return null},remove:function(t){t&&window.JSON&&window.sessionStorage&&window.sessionStorage.removeItem(t)},clear:function(){window.sessionStorage.clear()}},webix.storage.cookie={put:function(t,e,i,s){t&&window.JSON&&(document.cookie=t+"="+escape(webix.stringify(e))+(s&&s instanceof Date?";expires="+s.toUTCString():"")+(i?";domain="+i:"")+(webix.env.https?";secure":""));
},getRaw:function(t){for(var e=document.cookie.split(";"),i="",s="",n="",a=!1,r=0;r<e.length;r++){if(i=e[r].split("="),s=i[0].replace(/^\s+|\s+$/g,""),s==t)return a=!0,i.length>1&&(n=unescape(i[1].replace(/^\s+|\s+$/g,""))),n;i=null,s=""}return null},get:function(t){if(t&&window.JSON){var e=this.getRaw(t);
...
}},webix.DataState={getState:function(){for(var t=this.config.columns.length,e=this.config.columns,i={ids:[],size:[],select:this.getSelectedId(!0),scroll:this.getScrollState()},s=0;t>s;s++){var n=e[s];i.ids.push(n.id),i.size.push(n.fillspace||n.adjust?-1:n.width)}if(i.order=[].concat(this.bm.length?this.bm:i.ids),
this.Nk&&(i.sort={id:this.Nk,dir:this.Ok}),this.ij&&this.tj){var a={},r=0;for(var h in this.ij)if(!this.am[h]){var o=this.ij[h];o[1].value=a[h]=o[2].getValue(o[0]),r=1}r&&(i.filter=a)}i.hidden=[];for(var h in this.am)i.hidden.push(h);return i},setState:function(t){var e=this.config.columns;if(t){if(this.Nk=null,
this.blockEvent(),t.order&&t.order.length&&(this.bm=[].concat(t.order)),t.hidden){for(var i={},s=0;s<t.hidden.length;s++)i[t.hidden[s]]=!0,this.bm.length||this.hideColumn(t.hidden[s]);if(this.bm.length)for(var s=0;s<this.bm.length;s++){var n=this.bm[s];!!i[n]==!this.am[n]&&this.hideColumn(n,{},!1,!!i[n]);
}}if(t.ids){for(var a=!1,r=this.config.columns,s=0;s<r.length;s++)r[s].id!=t.ids[s]&&(a=!0);if(a){for(var s=0;s<t.ids.length;s++)r[s]=this.getColumnConfig(t.ids[s])||r[s];this.refreshColumns()}}if(t.size)for(var h=Math.min(t.size.length,e.length),s=0;h>s;s++){var o=e[s];o&&t.size[s]>0&&o.width!=t.size[s]&&(delete o.fillspace,
delete o.adjust,this.Xs(s,t.size[s],!0))}this.unblockEvent();var l=!(this.s.leftSplit||this.s.rightSplit);if(this.rk(l),this.callEvent("onStructureUpdate",[]),t.sort){var c=e[this.getColumnIndex(t.sort.id)];c&&this.zf(t.sort.id,t.sort.dir,c.sort)}if(t.filter){var u=this.filterByAll;this.filterByAll=function(){};
for(var d in t.filter){var f=t.filter[d];if(f&&this.ij[d]){var b=this.ij[d];b[2].setValue(b[0],f);var p=b[1].contentId;p&&(this.hj[p].value=f)}}for(var d in this.ij)if(!t.filter[d]){var b=this.ij[d];b[2].setValue(b[0],"")}this.filterByAll=u,this.filterByAll()}if(t.select&&this.select){var x=t.select;this.unselect();
for(var s=0;s<x.length;s++)(!x[s].row||this.exists(x[s].row))&&this.hl(x[s],!0)}t.scroll&&this.scrollTo(t.scroll.x,t.scroll.y)}}},webix.extend(webix.ui.datatable,webix.DataState),function(){function t(){if(webix.env.touch)i.$init(),-1==document.body.className.indexOf("webix_full_screen")&&i.limit(!0),
window.MSCSSMatrix&&webix.html.addStyle(".webix_view{ -ms-touch-action: none; }");else var n=webix.event(document.body,"touchstart",function(i){if(i.touches.length&&i.touches[0].radiusX>4){webix.env.touch=!0,e(s),t();for(var a in webix.ui.views){var r=webix.ui.views[a];r&&r.$touch&&r.$touch()}}webix.eventRemove(n);
},{capture:!0})}function e(t){t.down="touchstart",t.move="touchmove",t.up="touchend",t.context=i.gm}var i=webix.Touch={config:{longTouchDelay:1e3,scrollDelay:150,gravity:500,deltaStep:30,speed:"0ms",finish:1500,ellastic:!0,fastClick:!0},limit:function(t){i.cm=t!==!1},disable:function(){i.Xf=!0},enable:function(){
i.Xf=!1},$init:function(){i.$init=function(){},webix.event(document.body,s.down,i.dm),webix.event(document.body,s.move,i.em),webix.event(document.body,s.up,i.fm),webix.event(document.body,"dragstart",function(t){return i.Xf||i.cm?void 0:webix.html.preventEvent(t)}),webix.event(document.body,"touchstart",function(t){
if(!i.Xf&&!i.cm&&i.config.fastClick&&webix.env.isSafari){var e=t.srcElement.tagName.toLowerCase();return"input"==e||"textarea"==e||"select"==e||"label"==e?!0:(i.im=!0,webix.html.preventEvent(t))}}),i.Of(),i.jm=[null,null],i.$active=!0},Of:function(){i.km=i.lm=i.mm=i.bC=null,i.nm=i.om=i.pm=this.qm=null,
i.rm={sm:0,tm:0,um:0},i.vm&&(webix.html.removeCss(i.vm,"webix_touch"),i.vm=null),window.clearTimeout(i.wm),i.xm=!0,i.ym=!0,i.zm=!0,i.Am||i.Pf()},fm:function(t){if(i.km){if(i.nm){var e=i.Mf(i.om),s=e.e,n=e.f,a=i.config.finish,r=i.Bm(t,!0),h=webix.$$(i.om),o=h&&h.$scroll?h.$scroll.gravity:i.config.gravity;
...
for(var a=0;a<t.length;a++)if(t[a]){var r=Math.min(s,Math.round(s*t[a]/e));n=this.Xs(a,r,!0)||n,s-=i[a].width,e-=t[a]}n&&this.rk(!0)}}},dn:function(t,e){var i=this.s.columns[t],s=i.minColumnWidth||10;if("header"!=e){var n=this.data.order.length;i.adjustBatch&&i.adjustBatch<n&&(n=i.adjustBatch);for(var a=this.data.order.slice(0,n),r=0;n>r;r++)a[r]=a[r]?this.Ek(this.getItem(a[r]),i,0):"";
s=Math.max(s,webix.html.getTextSize(a,"webix_table_cell webix_cell").width)}if("data"!=e)for(var r=0;r<i.header.length;r++){var h=i.header[r];if(h){var o=0;if(h.rotate)for(var l=0;l<(h.rowspan||1);l++)o+=this.Mt[l];var c="webix_table_cell webix_cell "+(h.css||"")+(h.rotate?"webix_measure_rotate":""),u=webix.html.getTextSize([h.text],c,o);
...
this.data.each(function(t){n.innerHTML=this.Ek(t,s,0),t.$height=Math.max(n.scrollHeight,this.s.rowHeight)},this),n=webix.html.remove(n),i&&webix.html.remove(i)}else{var a=new Array(this.data.order.length),r=this.config.columns,h=0;for(var o in this.data.pull)a[h]=0,h++;for(var l=0;l<r.length;l++){this.adjustRowHeight(r[l].id,!0);
var h=0;this.data.each(function(t,e){t.$height>a[h]&&(a[h]=t.$height),t.$height=a[h],h++})}}e||this.refresh()}}),webix.extend(webix.ui.datatable,{math_setter:function(t){return t&&this.en(),t},fn:"$",en:function(){webix.env.strict||(this.data.attachEvent("onStoreUpdated",webix.bind(this.gn,this)),this.data.attachEvent("onStoreLoad",webix.bind(this.hn,this)),
...
n[e]=this.ln(s,t,e)):("undefined"!=typeof n[this.fn+e]&&delete n[this.fn+e],this.mn(n,e)),"undefined"!=typeof n.depends&&"undefined"!=typeof n.depends[e]))for(var a in n.depends[e]){var r=n.depends[e][a][0]+"__"+n.depends[e][a][1];"undefined"==typeof this.kn[r]&&(this.kn[r]=!0,this.jn(n.depends[e][a][0],n.depends[e][a][1],!0));
...
this.un(e,i);var n=this.getItem(e);t=t.substring(1);var a=this.vn(t),r=this.wn(t,e);a?(t=this.xn(t,r),t=this.yn(t,a)):t=this.xn(t,r,!0);var h=this.zn(t);if(h!==!1)return h;this.An(e,i),this.mn(n,i);for(var o=0;o<r.length;o++)this.Bn([e,i],r[o]);var h=this.zn(t);if(h!==!1)return h;if(!t)return t;t=this.Cn(t.replace(/\$r/g,n.id));
var h=this.zn(t);return h!==!1?h:t},vn:function(t){var e=/(\+|\-|\*|\/)/g,i=t.replace(/\[[^)]*?\]/g,"").match(e);return i},wn:function(t,e){var i=/\[([^\]]+),([^\]]+)\]/g,s=t.match(i);null===s&&(s=[]);for(var n=0;n<s.length;n++){var a=s[n],r=a;a=a.substr(1,a.length-2),a=a.split(","),a[0]=this.Dn(a[0]),
a[1]=this.Dn(a[1]),":"===a[0].substr(0,1)&&(a[0]=this.getIdByIndex(a[0].substr(1))),"$r"===a[0]&&(a[0]=e),":"===a[1].substr(0,1)&&(a[1]=this.columnId(a[1].substr(1))),a[2]=r,s[n]=a}return s},xn:function(t,e,i){var s="(",n=")";i&&(s=n="");for(var a=0;a<e.length;a++){var r=e[a],h=this.rn(r[0],r[1]);isNaN(h)&&(h='"'+h+'"'),
t=t.replace(r[2],s+h+n)}return t},yn:function(t,e){for(var i=[],s=0;s<e.length;s++){var n=e[s],a=this.En(t,n);i.push(a[0]),t=a[1]}i.push(t);for(var s=0;s<i.length;s++){var r=this.Dn(i[s]);i[s]=r}for(var h="",s=0;s<i.length-1;s++)h+=i[s]+e[s];return h+=i[i.length-1]},Cn:function(expr){try{webix.temp_value="",
...
i.depends[e[1]][t[0]+"__"+t[1]]=t,i=this.getItem(t[0]),"undefined"==typeof i.triggers&&(i.triggers={}),"undefined"==typeof i.triggers[t[1]]&&(i.triggers[t[1]]={}),i.triggers[t[1]][e[0]+"__"+e[1]]=e},mn:function(t,e){if(t&&"undefined"!=typeof t.triggers)for(var i in t.triggers[e]){var s=t.triggers[e][i],n=this.getItem(s[0]);
n&&delete n.depends[s[1]][t.id+"__"+e]}},zn:function(t){var e=/#\w+/,i=t.match(e);return null!==i&&i.length>0?i[0]:!1}}),webix.extend(webix.ui.datatable,{ii:function(t){return this.getColumnConfig(t.column).editor},getEditor:function(t,e){return t?(1==arguments.length&&(e=t.column,t=t.row),(this.ai[t]||{})[e]):this.di;
},si:function(t){for(var e in this.ai){var i=this.ai[e];for(var s in i)"$count"!=s&&t.call(this,i[s])}},ji:function(t,e,i){var s=t.row,n=t.column,a=e.config=this.getColumnConfig(n);i!==!1&&this.showCell(s,n);var r=e.render();e.$inline&&(r=this.mi(t)),e.node=r;var h,o=this.getItem(s),l=a.editFormat;return this.s.editMath&&(h=o["$"+n]),
h=h||o[n],webix.isUndefined(h)&&(h=""),e.setValue(l?l(h):h,o),e.value=o[n],this.ni(t,e),e.$inline||this.oi(t,r,!0),e.afterRender&&e.afterRender(),this.s.liveValidation&&(webix.UE(e.node,"keyup",this.Gn(t,this)),this.validateEditor(t)),r},Gn:function(t,e){return function(){e.validateEditor(t)}},ti:function(t,e,i){
...
this.editNext(t,s),!1}}return!0},ui:function(t,e,i){var s=this.getIndexById(t.row),n=this.getColumnIndex(t.column),a=this.data.order,r=this.fj;if(i)for(var h=s;h<a.length;h++){for(var o=n+1;o<r.length;o++){var l={row:a[h],column:r[o].id};if(e.call(this,l)&&(!this.QD||!this.QD(t,l)))return l}n=-1}else for(var h=s;h>=0;h--){
for(var o=n-1;o>=0;o--){var l={row:a[h],column:r[o].id};if(e.call(this,l))return l}n=r.length}return null},In:function(){this.Eb&&(this.Jn?this.Jn=!1:(this.Wj.scrollTo(this.getScrollState().y+this.Vf.childNodes[1].firstChild.scrollTop),this.Vf.childNodes[1].firstChild.scrollTop=0,this.Jn=!0))},Kn:function(){
...
},xB:function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s&&s.colspan&&!s.$colspan&&(s.$colspan=s.colspan)}},moveColumn:function(t,e){var i=this.getColumnIndex(t);if(i!=e){var s=this.s.columns,n=s.splice(i,1),a=e-(e>i?1:0);webix.PowerArray.insertAt.call(s,n[0],a);var r=this.bm;if(r.length){r=webix.toArray(r);
var h=r.find(t);r.removeAt(h),0===a?r.unshift(t):r.insertAt(t,r.find(s[a-1].id)+1)}this.On()}},rz:function(){var t=this.bm,e=this.s.columns;if(!t.length){for(var i=0;i<e.length;i++)t[i]=e[i].id;this.Mn=[this.s.leftSplit,this.Fj]}},isColumnVisible:function(t){return!this.am[t]},hideColumn:function(t,e,i,s){
var n,a=this.s.columns,r=this.bm,h=this.am,o=1;if(e=e||{},s!==!1){var l=this.getColumnIndex(t);if(-1===l||!this.callEvent("onBeforeColumnHide",[t]))return;if(-1==l)return;if(this.rz(),e.spans)for(var c=a[l].header,u=0;u<c.length;u++)c[u]&&(c[u].$groupSpan=c[u].colspan||1,o=Math.max(o,c[u].$groupSpan));
l<this.s.leftSplit&&(this.s.leftSplit-=o),l>=this.Fj?this.s.rightSplit-=o:this.Fj-=o;for(var u=l+o-1;u>=l;u--)this.vk(l),n=a.splice(l,1)[0],h[n.id]=n,n.qk=-1,delete this.Aj[n.id];this.callEvent("onAfterColumnHide",[t])}else{if(n=h[t],!n||!this.callEvent("onBeforeColumnShow",[t]))return;for(var d=null,u=0,f=0;u<r.length;u++){
if(r[u]==t){f=u;break}h[r[u]]||(d=r[u])}var l=d?this.getColumnIndex(d)+1:0;if(e.spans)for(var c=n.header,u=0;u<c.length;u++)c[u]&&(c[u].colspan=c[u].$groupSpan||c[u].colspan,delete c[u].$groupSpan,o=Math.max(o,c[u].colspan||1));for(var u=f+o-1;u>=f;u--){var n=h[r[u]];n?(webix.PowerArray.insertAt.call(a,n,l),
delete n.hidden,delete h[n.id],this.Aj[n.id]=n):o--}f<this.Mn[0]&&(this.s.leftSplit+=o),f>=this.Mn[1]?this.s.rightSplit+=o:this.Fj+=o,this.callEvent("onAfterColumnShow",[t])}n.header&&this.xt(n,s!==!1?0:1,"header"),n.footer&&this.xt(n,s!==!1?0:1,"footer"),i||this.On()},xt:function(t,e,i){for(var s=t[i].length-1;s>=0;s--)for(var n,a=this.bm,r=!1,h=0,o=0;o<a.length;o++){
var t=this.getColumnConfig(a[o]),l=t[i][s];this.isColumnVisible(a[o])?(r&&h>0&&n&&n.colspan>0?(l=t[i][s]=n,n=l):l&&l.$colspan&&0>=h&&(h=l.colspan=l.$colspan,n=l),r=null):(l&&l.$colspan&&0>=h&&(h=l.colspan=l.$colspan,r=n=l),n&&h>0&&n.colspan--),h--}},refreshColumns:function(t,e){(t&&t!=this.config.columns||e)&&(this.kz(),
this.ij={},t&&(this.Fj=t.length-(this.config.rightSplit||0))),this.Aj={};for(var i=0;i<this.fj.length;i++){var s=this.fj[i];this.Aj[s.id]=s,s.attached=s.node=null}for(var i=0;3>i;i++)this.I.childNodes[i].innerHTML="",this.Vf.childNodes[i].firstChild.innerHTML="";this.fj=this.config.columns=t||this.config.columns,
this.Fj=this.fj.length-this.s.rightSplit,this.tj=0,this.rj(),this.callEvent("onStructureUpdate"),this.sk(),this.render()},On:function(){this.tj=0,this.callEvent("onStructureUpdate"),this.uj(),this.render()},showColumn:function(t,e,i){return this.hideColumn(t,e,i,!1)},showColumnBatch:function(t,e){var i="undefined"!=typeof e;
e=e!==!1,this.eachColumn(function(s,n){if(n.batch){var a=this.am[n.id];e||(a=!a),n.batch==t&&a?this.hideColumn(n.id,{spans:!0},!0,!e):i||n.batch==t||a||this.hideColumn(n.id,{spans:!0},!0,e)}},!0),this.On()}}),webix.extend(webix.ui.datatable,{$init:function(){this.attachEvent("onAfterScroll",this.cF)},
cF:function(){var t=this.eF();if(!t){var e=this.y.querySelector(".webix_cell");e&&e.setAttribute("tabindex","0")}},eF:function(){for(var t=this.getSelectedId(!0),e=0;e<t.length;e++)if(this.isColumnVisible(t[e].column))return this.getItemNode(t[e]);return null},moveSelection:function(t,e,i){if(!this.s.disabled){
e=e||{};var s=this.getSelectedId(!0),n=s.length-1,a=this.s.multiselect||this.s.areaselect?e.shift:!1;if(s.length>1&&"cell"!==this.s.select&&(s=s.sort(webix.bind(function(t,e){return this.getIndexById(t.row)>this.getIndexById(e.row)||this.getColumnIndex(t.column)>this.getColumnIndex(e.column)?1:-1},this)),
("up"==t||"left"==t||"top"==t||"pgup"==t)&&(n=0)),0>n&&this.count()){if("down"==t||"right"==t)t="top";else{if("up"!=t&&"left"!=t)return;t="bottom"}n=0,s=[{row:1,column:1}]}if(n>=0){var r=s[n].row,h=s[n].column;if("top"==t||"bottom"==t)r&&("top"==t?r=this.data.getFirstId():"bottom"==t&&(r=this.data.getLastId())),
h&&(n=0,"bottom"==t&&(n=this.config.columns.length-1),h=this.columnId(n));else if("up"==t||"down"==t||"pgup"==t||"pgdown"==t){if(r){var n=this.getIndexById(r),o=1;("pgup"==t||"pgdown"==t)&&(o=this.Wf?this.Wf.config.size:Math.round(this.Vj/this.s.rowHeight)),"up"==t||"pgup"==t?n-=o:("down"==t||"pgdown"==t)&&(n+=o),
0>n&&(n=0),n>=this.data.order.length&&(n=this.data.order.length-1),r=this.getIdByIndex(n),!r&&this.s.pager&&this.showItemByIndex(n)}}else{if("right"!=t&&"left"!=t)return;if(h&&"row"!=this.config.select){var n=this.getColumnIndex(h);"right"==t?n++:"left"==t&&n--,0>n&&(n=0),n>=this.config.columns.length&&(n=this.config.columns.length-1),
h=this.columnId(n)}else{if((this.open||this.oA)&&"right"==t)return this.open?this.open(r):this.openSub(r);if((this.close||this.oA)&&"left"==t)return this.close?this.close(r):this.closeSub(r)}}if(r){this.showCell(r,h),this.select||(webix.extend(this,this._k.$k,!0),this.s.select=this.open||this.oA?"row":"cell",
webix.extend(this,this._k[this.s.select],!0));var l={row:r,column:h};if(a&&"area"==this.s.select){var c=this.el[this.el.length-1];this.gC(l,c,t,e)}else this.hl(l,a);if(!this.s.clipboard&&i!==!1){var u=this.getItemNode(l);u&&u.focus()}}}return!1}}}),webix.extend(webix.ui.datatable,webix.KeysNavigation),
...
return 0>e||e>=this.s.topSplit}),webix.DragItem.drag_setter.call(this,t)},RD:function(t){var e,i,s=!1;if(this.s.topSplit&&t)for(webix.isArray(t)||(t=[t]),e=0;!s&&e<t.length;e++)i=this.getIndexById(t[e]),s=i<this.s.topSplit;return!s},$dragHTML:function(t,e){for(var i=this.bc-this.oj,s="<div class='webix_dd_drag' style='width:"+(i-2)+"px;'>",n=this.s.columns,a=0;a<n.length;a++){
var r=this.Ek(t,n[a]);s+="<div style='width:"+n[a].width+"px;'>"+r+"</div>"}return s+"</div>"},getHeaderNode:function(t,e){return this.nG(t,e,this.I)},getFooterNode:function(t,e){return this.nG(t,e,this.cj)},nG:function(t,e,i){if(this.isColumnVisible(t)){var s=this.getColumnIndex(t),n=this.s.leftSplit>s?0:this.Fj<=s?2:1;
e=e||0;var a=i.childNodes[n].getElementsByTagName("TR");if(a.length)for(var r=a[e+1].childNodes,h=0;h<r.length;h++)if(r[h].getAttribute("column")==s)return r[h].firstChild}return null},getItemNode:function(t,e){if(t&&!t.header){var i=t.row||t,s=this.getIndexById(i),n=this.Sj(),a=n[0]-this.s.topSplit;if(a>s&&s>n[1])return;
var r=this.Xj(),h=this.s.leftSplit?0:r[0];if(t.column&&(h=this.getColumnIndex(t.column),h<this.Fj&&h>=this.s.leftSplit&&(h<r[0]||h>r[1])))return;var o=this.s.columns[h];if(o.attached&&o.node){var l=s<this.s.topSplit?s:s-a;return o.node.childNodes[l]}}},dragColumn_setter:function(t){var e;"order"==t?e={
...
},this),$dragPos:webix.bind(function(t,e,i){var s=webix.DragControl.getContext(),n=webix.html.offset(this.$view);i.style.display="none";var a=document.elementFromPoint(t.x,n.y+1),r=a?this.locate(a):null,h=webix.DragControl.getContext().start.column;if(r&&r.column!=h&&(!this.Sn||r.column!=this.Yg)&&"column_dnd"==s.custom&&webix.$$(a)==this){
if(!this.callEvent("onBeforeColumnDropOrder",[h,r.column,e]))return;var o=this.getColumnIndex(h),l=this.getColumnIndex(r.column);e.touches&&(this.wy=e.target,this.wy.style.display="none",this.$view.parentNode.appendChild(this.wy)),this.moveColumn(h,l+(l>o?1:0)),this.Yg=r.column,this.Sn=!0}if(r&&r.column==h&&(this.Sn=!1),
...
this.callEvent("onAfterColumnDropOrder",[i.column,this.Yg,t])},this),$drop:function(){}}:t&&(e={ah:!0,$drag:webix.bind(function(t,i){var s=this.locate(i);if(this.Pl||!s||!this.callEvent("onBeforeColumnDrag",[s.column,i]))return!1;webix.DragControl.Gd={from:e,start:s,custom:"column_dnd"};for(var n=this.getColumnConfig(s.column).header,a="&nbsp;",r=0;r<n.length;r++)if(n[r]){
a=n[r].text;break}return"<div class='webix_dd_drag_column'>"+a+"</div>"},this),$drop:webix.bind(function(t,e,i){var s=i;i.touches&&this.Tn&&(s=this.Tn);var n=this.locate(s);if(!n)return!1;var a=webix.DragControl.getContext().start.column;if(a!=n.column){if(!this.callEvent("onBeforeColumnDrop",[a,n.column,i]))return;
var r=this.getColumnIndex(a),h=this.getColumnIndex(n.column);this.moveColumn(a,h+(h>r?1:0)),this.callEvent("onAfterColumnDrop",[a,n.column,i])}},this),$dragIn:webix.bind(function(t,i,s){var n=webix.DragControl.getContext();if("column_dnd"!=n.custom||n.from!=e)return!1;for(var a=s.target||s.srcElement;-1==(a.className||"").indexOf("webix_hcell");)if(a=a.parentNode,
...
if(e=(e||100)-2*h,i=(i||100)-2*o,t.length){var d=e/t.length,f=s.scale||a-n;c=Math.min(d-l,c),l=d-c;var b=0,p=n;s.origin!==!1&&s.origin>n?p=s.origin||0:b=s.minHeight;for(var x=(i-b)/(f?f:1),w=0;w<t.length;w++){var g=Math.ceil(x*(t[w]-p));r.push({x:Math.ceil(d*w)+h+l/2,y:u-(t[w]>=p?g:0)-b,height:Math.abs(g)+b,
...
for(var c=0,u=this.getItem(e),d=this.getIndexById(e),f=[],b=!1,p=i;p<s.length;p++){var x=s[p].id,w=this.getColumnIndex(x)-i;if(s[p]){if(c+=s[p].width,c>a&&p>i){l=p;break}if("selection"!==t.data||"selection"==t.data&&-1!==this.sq(n,function(t){return t.column==x&&t.row==e})){var g;if(this.getSpan&&(g=this.getSpan(e,x)),
...
height:g&&g[3]>1?"auto":(u.$height||this.config.rowHeight)+"px",width:g&&g[2]>1?"auto":s[p].width+"px"};f.push({txt:m,className:y,style:$,span:g?{colspan:g[2],spanStart:this.getColumnIndex(g[1]),rowspan:g[3]}:null}),m&&(r=Math.max(w+1,r),h=Math.max(d+1,h)),b=b||!!m}else g&&(f.push({$inspan:!0}),r=Math.max(w+1,r),
h=Math.max(d+1,h))}}}(!t.skiprows||b)&&o.push(f)},this)),h&&r&&(t.trim&&(o.length=h,o=o.map(function(t){for(var e=t.length-1;e>=0;e--)if(t[e].span&&t[e].span.colspan){t[e].span.colspan=Math.min(t[e].span.colspan,t.length-e);break}return t.length=r,t})),e.push(o)),l?this.VF(t,e,l):(t.footer&&(e=this.$F(e,s,"footer")),
t.header&&(e=this.$F(e,s,"header"))),e},WF:function(t,e){var i=webix.html.create("div");return t.forEach(webix.bind(function(s,n){var a=webix.html.create("table",{"class":"webix_table_print "+this.$view.className+(e.borderless?" borderless":""),style:"border-collapse:collapse",id:this.$view.getAttribute("id")
});if(s.forEach(function(t){var e=webix.html.create("tr");t.forEach(function(t,i){if(!t.$inspan){var s=webix.html.create("td");s.innerHTML=t.txt,s.className=t.className;for(var n in t.style)s.style[n]=t.style[n];t.span&&(s.colSpan=t.span.colspan,s.rowSpan=t.span.rowspan),e.appendChild(s)}}),a.appendChild(e);
}),i.appendChild(a),n+1<t.length){var r=webix.html.create("DIV",{"class":"webix_print_pagebreak"});i.appendChild(r)}},this)),i}}),webix.extend(webix.ui.datatable,webix.CustomPrint),webix.extend(webix.ui.datatable,{$exportView:function(t){if(this.isBranchOpen&&webix.extend(t,{filterHTML:!0}),"excel"!==t.export_mode||t.dataOnly||!t.styles)return this;
...
this.data.each(function(t){for(var s={},n=0;n<e.length;n++){var a=this.getCss(t.id,e[n].id),r=e[n].node.className,h="",o=this.getIndexById(t.id)%2?"even":"odd",l=null,c=null;if(this.Rt&&(l=this.getSpan(t.id,e[n].id))?(c=this.getSpanNode({row:l[0],column:l[1]}),h="webix_dtable_span "+(l[5]||"")):c=this.getItemNode({
row:t.id,column:e[n].id}),!c){c=webix.html.create("div",{"class":a,style:"visibility:hidden"});var u=e[n].node;e[n].attached||(u=webix.html.create("div",{"class":r,style:"visibility:hidden"}),this.Vf.appendChild(u)),u.appendChild(c)}s[n]=this.sG(c,[a,r,h,o].join(":"))}i[i.length]=s},this),t.footer!==!1&&this.config.footer&&(i=this.rG(t,"footer",i)),
t.docFooter&&(i=i.concat([{0:{}},{0:this.qG(t.docFooter.css)}])),i},rG:function(t,e,i){for(var s=this.config.columns,n=[],a=0;a<s[0][e].length;a++){for(var r={},h=0;h<s.length;h++){var o=s[h][e][a];if(o){var l=o.colspan?s[h+o.colspan-1].id:s[h].id,c="header"==e?this.getHeaderNode(l,a):this.getFooterNode(l,a);
if(c){var u=[c.parentNode.className,o.css||"","webix_hcell",e];r[h]=this.sG(c,u.join(":")),(o.colspan||o.rowspan)&&n.push([a,h,{colspan:o.colspan-1||0,rowspan:o.rowspan-1||0},r[h]])}}else for(var d=0;d<n.length;d++){var f=n[d][2],b=n[d][1],p=n[d][0];b+f.colspan>=h&&p+f.rowspan>=a&&(r[h]=n[d][3])}}i[i.length]=r;
...
webix.extend(webix.ui.datatable,{topSplit_setter:function(t){return this.data&&(this.data.$freeze=t),t},freezeRow:function(t,e){function i(t,e,i,s,a){var r;if(i&&t>=n){for(a||n++,r=t;r>=n;r--)s[r]=s[r-1];s[n-1]=e}if(!i&&n>t){for(a||n--,r=t;n>r;r++)s[r]=s[r+1];s[n]=e}}var s,n=this.s.topSplit,a=this.data.order,r=this.data.jf;
t?(s=this.getIndexById(t),t=t.toString(),i(s,t,e,a),r&&i(r.find(t),t,e,r,!0)):e||(n=0),this.define("topSplit",n),this.refresh()}}),webix.TreeTableClick={},webix.TreeTablePaste={insert:function(t){for(var e=this.getSelectedId(!0,!0),i=0;i<t.length;i++){for(var s={},n=0;n<this.s.columns.length;n++)s[this.s.columns[n].id]=t[i][n]||"";
...
this.attachEvent("onSyncScroll",function(t,e,i){for(var s=0;3>s;s++)webix.Touch.Nf(this.St[s],1==s?t:0,e,i)}),this.attachEvent("onScrollY",this.Tt),this.attachEvent("onScrollX",this.Tt),this.attachEvent("onAfterRender",this.Ut),this.attachEvent("onColumnResize",this.Ut),this.attachEvent("onSelectChange",this.Vt);
},addSpan:function(t,e,i,s,n,a){if("object"!=typeof t)s=s||1,i=i||1,this.Rt[t]||(this.Rt[t]={}),this.Rt[t][e]=[i,s,n,a];else for(var r=0;r<t.length;r++)this.addSpan.apply(this,t[r])},removeSpan:function(t,e){arguments.length||(this.Rt={});var i=this.Rt[t];i&&delete i[e]},getSpan:function(t,e){if(!t)return this.Rt;
var i,s,n,a,r,e,t,h=this.Rt;i=this.getIndexById(t),n=this.getColumnIndex(e);for(t in h)for(e in h[t])if(r=h[t][e],s=this.getIndexById(t),a=this.getColumnIndex(e),!(i>s+r[1]-1||s>i||n>a+r[0]-1||a>n))return[t,e].concat(r);return null},Ut:function(){var t,e,i=this.fj.length-this.s.rightSplit;for(webix.html.remove(this.St),
e=0;3>e;e++)t=this.St[e]=webix.html.create("DIV",{"class":"webix_span_layer"}),this.Vf.childNodes[e].appendChild(t);this.Tt(),this.s.leftSplit&&this.Wt(this.St[0],0,this.s.leftSplit),this.s.rightSplit&&this.Wt(this.St[2],i,this.fj.length),this.Wt(this.St[1],this.s.leftSplit,i),this.s.topSplit&&!webix.env.touch&&this.DG();
},EG:function(){for(var t,e=0,i=0,s=0,n=0;e<this.s.leftSplit;)i+=this.fj[e].width,e++;for(e=this.fj.length-1,t=e-this.s.rightSplit;e>=t;)n+=this.fj[e].width,e--;for(e=this.s.leftSplit;e<this.fj.length-this.s.rightSplit;e++)s+=this.fj[e].width;return[i,s,n]},DG:function(){var t,e,i,s=this.fj.length-this.s.rightSplit;
for(e=3;6>e;e++)t=this.St[e]=webix.html.create("DIV",{"class":"webix_span_layer_top"}),this.Vf.childNodes[e-3].appendChild(t);i=this.EG(),this.s.leftSplit&&(this.St[3].style.width=i[0]+"px",this.Wt(this.St[3],0,this.s.leftSplit,!0)),this.s.rightSplit&&(this.St[5].style.width=i[2]+"px",this.Wt(this.St[5],s,this.fj.length,!0)),
this.St[4].style.width=i[1]+"px",this.Wt(this.St[4],this.s.leftSplit,s,!0)},Wt:function(t,e,i,s){for(var n=0,a=this.data.$min||0,r=this.data.$max||this.data.order.length,h=a;r>h;h++){var o=this.data.order[h];if(o){var l=this.Rt[o];if(l&&(!s||h<this.s.topSplit))for(var c=e;i>c;c++){var u=this.fj[c].id;
l[u]&&this.Xt(t,h,c,l,n,e,o,u)}n+=this.FA(this.getItem(o))}}},Vt:function(){for(var t=this.config.select,e="cell"==t||"column"==t,i=this.getSelectedId(!0),s=[],n=this.Yt||[],a=webix.uid()+"",r=!1,h=0;h<i.length;h++){var o=this.Rt[i[h]];!o||e&&!o[i[h].column]||(o.$selected&&o.$selected.id==i[h].id||(r=!0),
o.$selected=i[h],o.$time=a,s.push(i[h].id))}for(var h=0;h<n.length;h++){var o=this.Rt[n[h]];o&&o.$time!==a&&(delete o.$selected,r=!0)}this.Yt=[].concat(i),r&&this.Ut()},Zt:function(t,e){for(var i=0,s=t;e>s;s++){var n=this.fj[s];i+=n?n.width:0}return i},$t:function(t,e){for(var i=0,s=t;e>s;s++){var n=this.getItem(this.data.order[s]);
i+=n?this.FA(n):this.s.rowHeight}return i},Xt:function(t,e,i,s,n,a,r,h){var o=s[h],l=o[2]||this.getText(r,h),c="";!s.$selected||"row"!==this.s.select&&s.$selected.column!==h||(c="webix_selected ");var u={column:i,row:e,"class":c+"webix_cell webix_table_cell webix_dtable_span "+(o[3]||""),"aria-colindex":i+1,
"aria-rowindex":e+1};o[0]>1&&(u["aria-colspan"]=o[0]),o[1]>1&&(u["aria-rowspan"]=o[1]);var d=webix.html.create("DIV",u,""+l);d.style.top=n+"px",d.style.left=this.Zt(a,i)+"px",d.style.width=this.Zt(i,i+o[0])+"px",d.style.height=this.$t(e,e+o[1])+"px",t.appendChild(d)},Tt:function(){if(!this.s.prerender)for(var t=this.getScrollState(),e=0;3>e;e++)this.St[e].style.top="-"+(t.y||0)+"px";
},QD:function(t,e){var i,s,n=!1;return this.Rt&&(i=this.getSpan(t.row,t.column),s=this.getSpan(e.row,e.column),i&&s&&i[0]==s[0]&&i[1]==s[1]&&(n=!0)),n},getSpanNode:function(t){for(var e=this.St,i=this.getIndexById(t.row),s=this.getColumnIndex(t.column),n=0;n<e.length;n++)for(var a=e[n].childNodes,r=0;r<a.length;r++)if(a[r].getAttribute("row")==i&&a[r].getAttribute("column")==s)return a[r];
...
n>2&&(t.$subHeight=i,this.refresh(t.id))},wC:function(t){var e=t.$width;if(t.lc){var i=t.q.length-t.qc;e-=t.mc?2*t.Dc+2:t.Cc*(i-1)+2*t.Dc+2*i}return e>0},pA:function(t,e){var i,s=this.oA[t.$subContent];if(s)e.firstChild.appendChild(s),i=webix.$$(t.$subContent),this.wC(i)||i.adjust(),s.repaintMe&&(delete s.repaintMe,
i.config.hidden=!1,i.Qd());else{var n,a=this.s.subview;"function"==typeof a?i=a.call(this,t,e.firstChild):(n=webix.copy(a),n.$scope=this.$scope,i=webix.ui(n,e.firstChild)),i.getMasterView=webix.bind(function(){return this},this),t.$subContent=i.config.id,this.oA[t.$subContent]=i.$view,i.attachEvent("onResize",webix.bind(function(e,i,s,n){
i&&i!=n&&this.refresh(t.id)},this)),this.callEvent("onSubViewCreate",[i,t])}this.qA(t,i||webix.$$(s))},rA:function(t){var e=this.getItem(t),i=this.oA[e.$subContent];if(i){delete e.$subContent;var s=webix.$$(i);s&&s!=this&&s.destructor()}},mA:function(t,e){var i=webix.html.create("DIV",{"class":"webix_measure_size webix_cell webix_dtable_subrow"
},"");i.style.cssText="width:"+this.bc+"px; height:auto; visibility:hidden; position:absolute; top:0px; left:0px; overflow:hidden;",this.$view.appendChild(i),this.data.each(function(s){(s&&!t||s.id==t&&s.$sub)&&(i.innerHTML=e||this.s.subrow(s,this.type),s.$subHeight=i.offsetHeight)},this),i=webix.html.remove(i);
},closeSub:function(t){var e=this.getItem(t);if(e.$subopen){e.$row=!1,e.$subopen=!1;var i=this.oA[e.$subContent];i&&(webix.$$(i).config.hidden=!0),this.refresh(t),this.callEvent("onSubViewClose",[t])}}}),webix.extend(webix.ui.datatable,{headermenu_setter:function(t){return t&&(t.data&&(this.Xw=!0),t=this._t(t)),
t},_t:function(t){var e={view:"contextmenu",template:"<span class='webix_icon {common.hidden()}'></span> &nbsp; #value#",type:{hidden:function(t){return t.hidden?webix.skin.icon+"empty":webix.skin.icon+"eye"}},on:{onMenuItemClick:webix.bind(function(e,i){var s=webix.$$(this.s.headermenu),n=s.getItem(e).hidden;
s.getItem(e).hidden=!n,s.refresh(e),s.$blockRender=!0;var a={spans:"object"==typeof t&&t.spans};return n?this.showColumn(e,a):this.hideColumn(e,a),s.$blockRender=!1,!1},this)},data:[]};"object"==typeof t&&webix.extend(e,t,!0);var i=webix.ui(e);return i.attachTo(this.I),this.Ns.push(i),this.attachEvent("onStructureLoad",this.au),
this.attachEvent("onStructureUpdate",this.au),this._t=function(t){return t},i.s.id},au:function(){var t=webix.$$(this.s.headermenu),e=this.am;if(!t.$blockRender){if(this.Xw)return t.data.each(function(t){t.hidden=!!e[t.id]}),void t.refresh();var i=[],s=this.bm;s.length||(s=this.fj);for(var n=0;n<s.length;n++){
var a=this.getColumnConfig(s[n].id||s[n]),r=a.header[0],h=!!e[a.id];a.headermenu!==!1&&r&&i.push({id:a.id,value:h?r.text:r.groupText||r.text,hidden:h})}i.length&&t.data.importData(i)}}}),webix.ui.datafilter.headerMenu={getValue:function(){},setValue:function(){},refresh:function(t,e,i){t.s.headermenu||(t.define("headermenu",!0),
t.au()),e.onclick=function(){webix.$$(t.config.headermenu).show(e)}},render:function(t,e){return"<span class='webix_icon "+webix.skin.icon+"columns' role='button' tabindex='0' aria-label='"+webix.i18n.aria.headermenu+"'>"}},webix.ui.datafilter.richSelectFilter={getInputNode:function(t){return webix.$$(t.$webix)||null;
},getValue:function(t){var e=this.getInputNode(t);return e?e.getValue():""},setValue:function(t,e){var i=this.getInputNode(t);return i?i.setValue(e):""},compare:function(t,e){return t==e},refresh:function(t,e,i){if(!t.$destructed){var s=webix.$$(i.richselect);if(!s.$view.parentNode){var n=webix.html.create("div",{
"class":"webix_richfilter"});n.appendChild(s.$view)}e.$webix=i.richselect,e.style.marginLeft="-10px",i.compare=i.compare||this.compare,i.prepare=i.prepare||this.prepare,t.registerFilter(e,i,this);var a,r=i.options;r?"string"==typeof r?(a=i.options=[],webix.ajax(r).then(webix.bind(function(e){i.options=e.json();
var s=document.body.contains(s)?s:document.body.querySelector('[active_id="'+i.contentId+'"]');this.refresh(t,s,i)},this))):a=r:a=t.collectValues(i.columnId);var h=s.getPopup().getList(),o=webix.$$(r);if(o&&o.data&&o.data.getRange&&(a=o.data.getRange()),e.firstChild.appendChild(s.$view.parentNode),h.parse&&(h.clearAll(),
h.parse(a),!this.$noEmptyOption&&i.emptyOption!==!1||i.emptyOption)){var l={id:"",value:i.emptyOption||"",$empty:!0};h.add(l,0)}i.value&&this.setValue(e,i.value),s.render(),webix.delay(s.resize,s)}},render:function(t,e){if(!e.richselect){var i=webix.html.create("div",{"class":"webix_richfilter"}),s={
container:i,view:this.inputtype,options:[]},n=webix.extend(this.inputConfig||{},e.inputConfig||{},!0);webix.extend(s,n),e.separator&&(s.separator=e.separator),e.suggest&&(s.suggest=e.suggest);var a=webix.ui(s);a.attachEvent("onChange",function(){t.filterByAll()}),e.richselect=a.s.id,t.Ns.push(a)}return e.css="webix_div_filter",
" "},inputtype:"richselect"},webix.ui.datafilter.serverRichSelectFilter=webix.extend({$server:!0},webix.ui.datafilter.richSelectFilter),webix.ui.datafilter.multiSelectFilter=webix.extend({$noEmptyOption:!0,inputtype:"multiselect",prepare:function(t,e){if(!t)return t;for(var i={},s=t.toString().split(e.separator||","),n=0;n<s.length;n++)i[s[n]]=1;
...
i=this.hexToDec(t.substr(2,2)),s=this.hexToDec(t.substr(4,2))),e=parseInt(e,10)||0,i=parseInt(i,10)||0,s=parseInt(s,10)||0,(0>e||e>255)&&(e=0),(0>i||i>255)&&(i=0),(0>s||s>255)&&(s=0),[e,i,s]},hsvToRgb:function(t,e,i){var s,n,a,r,h,o,l,c;switch(s=Math.floor(t/60)%6,n=t/60-s,a=i*(1-e),r=i*(1-n*e),h=i*(1-(1-n)*e),
o=0,l=0,c=0,s){case 0:o=i,l=h,c=a;break;case 1:o=r,l=i,c=a;break;case 2:o=a,l=i,c=h;break;case 3:o=a,l=r,c=i;break;case 4:o=h,l=a,c=i;break;case 5:o=i,l=a,c=r}return o=Math.floor(255*o),l=Math.floor(255*l),c=Math.floor(255*c),[o,l,c]},rgbToHsv:function(t,e,i){var s,n,a,r,h,o,l,c;return s=t/255,n=e/255,
a=i/255,r=Math.min(s,n,a),h=Math.max(s,n,a),l=0,o=0===h?0:1-r/h,c=h,h==r?l=0:h==s&&n>=a?l=60*(n-a)/(h-r)+0:h==s&&a>n?l=60*(n-a)/(h-r)+360:h==n?l=60*(a-s)/(h-r)+120:h==a&&(l=60*(s-n)/(h-r)+240),[l,o,c]}},webix.HtmlMap=webix.proto({$init:function(t){this.ad="map_"+webix.uid(),this.U=t,this.eo=[],this.sA=[];
},addRect:function(t,e,i){this.fo(t,"RECT",e,i)},addPoly:function(t,e,i){this.fo(t,"POLY",e,i)},fo:function(t,e,i,s){var n="";4==arguments.length&&(n="userdata='"+s+"'"),this.eo.push("<area "+this.U+"='"+t+"' shape='"+e+"' coords='"+i.join()+"' "+n+"></area>"),this.sA.push({index:s,points:i})},addSector:function(t,e,i,s,n,a,r,h){
var o=[];o.push(s),o.push(Math.floor(n*r));for(var l=e;i>l;l+=Math.PI/18)o.push(Math.floor(s+a*Math.cos(l))),o.push(Math.floor((n+a*Math.sin(l))*r));return o.push(Math.floor(s+a*Math.cos(i))),o.push(Math.floor((n+a*Math.sin(i))*r)),o.push(s),o.push(Math.floor(n*r)),this.addPoly(t,o,h)},hide:function(t,e,i){
if(t.querySelectorAll)for(var s=t.querySelectorAll('area[userdata="'+e+'"]'),n=0;n<s.length;n++){var a=s[n];i?a.getAttribute("coords")&&(a.coordsdis=a.getAttribute("coords"),a.setAttribute("coords",""),a.coords=""):i||a.coordsdis&&(a.setAttribute("coords",a.coordsdis),a.coords=a.coordsdis,a.coordsdis=""),
...
on_click:{webix_chart_legend_item:function(t,e,i){var s=i.getAttribute("series_id");if(this.callEvent("onLegendClick",[t,s,i])&&"undefined"!=typeof s&&this.go.length>1){var n=this.s,a=n.legend.values,r=a&&a[s].toggle||n.legend.toggle;r&&(-1!=i.className.indexOf("hidden")?this.showSeries(s):this.hideSeries(s));
...
this.mo(this.data.getRange(),this.bc,this.dc)),this.eo=a=new webix.HtmlMap(this.ad),r=this.s,s=this.no(this.bc,this.dc),this.go)for(n=0;n<this.go.length;n++)this.s=this.go[n],this.canvases[n]||(this.canvases[n]=this.lo(this.name+" "+n,"z-index:"+(2+n),null,n,this.s.ariaLabel)),this["$render_"+this.s.type](this.canvases[n].getCanvas(),e,s.start,s.end,n,a);
if(a.render(this.w),this.w.lastChild.style.zIndex=100,this.po(this.w.lastChild,s),this.callEvent("onAfterRender",[e]),this.s=r,this.s.legend&&this.s.legend.values)for(var h=this.s.legend.values,n=0;n<h.length;n++)h[n].$hidden&&this.hideSeries(n)}},po:function(t,e){var i={};i.left=e.start.x,i.top=e.start.y,
i.width=e.end.x-e.start.x,i.height=e.end.y-e.start.y;for(var s in i)t.style[s]=i[s]+"px"},oo:function(){var t,e,i,s,n,a,r,h,o,l;if(s=this.data.getRange(),t=-1!=this.s.type.toLowerCase().indexOf("barh")?"yAxis":"xAxis",e=this.s[t],e&&e.units&&"object"==typeof e.units){if(i=e.units,h=[],"undefined"!=typeof i.start&&"undefined"!=typeof i.end&&"undefined"!=typeof i.next)for(r=i.start;r<=i.end;)h.push(r),
r=i.next.call(this,r);else"[object Array]"===Object.prototype.toString.call(i)&&(h=i);if(a=[],h.length){for(o=e.value,l={},n=0;n<s.length;n++)l[o(s[n])]=n;for(n=0;n<h.length;n++)"undefined"!=typeof l[h[n]]?(s[l[h[n]]].$unit=h[n],a.push(s[l[h[n]]])):a.push({$unit:h[n]})}return a}return s},series_setter:function(t){
...
marker:{type:"square",width:15,height:15,radius:3},margin:4,padding:3}),t.template=webix.template(t.template),t):(this.ko&&(this.ko.innerHTML="",this.ko=null),!1)},item_setter:function(t){"object"!=typeof t&&(t={color:t,borderColor:t}),this.E(t,webix.extend({},this.defaults.item));var e=["alpha","borderColor","color","radius","type"];
...
template:"{obj}",lines:!0,bg:"#ffffff"});var e=["lineColor","template","lines","bg"];return this.ro(e,t),this.to=webix.extend({},t),t},ro:function(t,e){for(var i=0;i<t.length;i++)e[t[i]]=webix.template(e[t[i]])},lo:function(t,e,i,s,n){var a={container:i||this.w,name:t,title:webix.isUndefined(n)?t:n||"",
series:s,style:e||"",width:this.bc,height:this.dc};return new webix.Canvas(a)},uo:function(t,e,i,s,n,a){var r,h=0;return this.s.yAxis&&(this.canvases.y||(this.canvases.y=this.lo("axis_y")),h=this.vo(this.canvases.y.getCanvas(),t,e,i,s,n)),this.s.xAxis&&(this.canvases.x||(this.canvases.x=this.lo("axis_x")),
r=this.canvases.x.getCanvas(),this.callEvent("onBeforeXAxis",[r,t,e,i,a,h])&&this.wo(r,t,e,i,a,h)),h},wo:function(t,e,i,s,n,a){var r,h,o=this.s,l=i.x-.5,c=parseInt(a?a:s.y,10)+.5,u=s.x,d=!0,f="stackedBar"==o.type?s.y+.5:c;for(r=0;r<e.length;r++){o.offset===!0?h=l+n/2+r*n:(h=r!=e.length-1||o.cellWidth?l+r*n:s.x,
d=!!r),h=Math.ceil(h)-.5;var b="auto"!=o.origin&&"bar"==o.type&&parseFloat(o.value(e[r]))<o.origin;this.xo(h,f,e[r],d,b),(o.offset||r||o.cellWidth)&&o.xAxis.lines.call(this,e[r])&&this.yo(t,h,s.y,i.y,e[r])}this.canvases.x.renderTextAt(!0,!1,l,s.y+o.padding.bottom-3,o.xAxis.title,"webix_axis_title_x",s.x-i.x),
this.zo(t,l,c,u,c,o.xAxis.color,1),o.xAxis.lines.call(this,{})&&o.offset&&this.zo(t,u+.5,s.y,u+.5,i.y+.5,o.xAxis.color,.2)},vo:function(t,e,i,s,n,a){var r,h={};if(this.s.yAxis){var o=i.x-.5,l=s.y,c=i.y,u=s.y+.5;if(this.s.yAxis.step&&(r=parseFloat(this.s.yAxis.step)),"undefined"==typeof this.to.step||"undefined"==typeof this.to.start||"undefined"==typeof this.to.end?(h=this.Ao(n,a),
n=h.start,a=h.end,r=h.step,this.s.yAxis.end=a,this.s.yAxis.start=n):"logarithmic"==this.config.scale&&(this.Bo=!0),this.Co(i,s),0!==r){if(a==n)return l;for(var d=(l-c)*r/(a-n),f=0,b=n;a>=b;b+=r){var p=this.Bo?Math.pow(10,b):b;h.fixNum&&(p=parseFloat(p).toFixed(h.fixNum));var x=Math.floor(l-f*d)+.5;if(b==n&&"auto"==this.s.origin||!this.s.yAxis.lines.call(this,b)||this.zo(t,o,x,s.x,x,this.s.yAxis.lineColor.call(this,b),1),
b==this.s.origin&&(u=x),1>r&&!this.Bo){var w=Math.min(Math.floor(this.Do(r)),0>=n?0:Math.floor(this.Do(n))),g=Math.pow(10,-w);p=Math.round(p*g)/g,b=p}this.canvases.y.renderText(0,x-5,this.s.yAxis.template(p.toString()),"webix_axis_item_y",i.x-5),f++}return this.zo(t,o,l+1,o,c,this.s.yAxis.color,1),u}
...
var n,a,r;if(n=this.uG((e-t)/8||1),n>Math.abs(t))a=0>t?-n:0;else{var h=Math.abs(t),o=Math.floor(this.Do(h)),l=h/Math.pow(10,o);for(a=Math.ceil(10*l)/10*Math.pow(10,o)-n,h>1&&n>.1&&(a=Math.ceil(a));0>t?t>=a:a>=t;)a-=n;0>t&&(a=-a-2*n)}e-a>10&&(n=this.uG((e-a)/8||1)),r=a;for(var c=Math.floor(this.Do(n));e>r;)r+=n,
r=parseFloat((1*r).toFixed(Math.abs(c)));return{start:a,end:r,step:n,fixNum:0>c?Math.abs(c):0}},Go:function(t,e){var i,s,n=this.data.Df(),a=arguments.length&&"h"==t?this.so:this.to;if(e=e||"value",a&&"undefined"!=typeof a.end&&"undefined"!=typeof a.start&&a.step)i=parseFloat(a.end),s=parseFloat(a.start);else if(i=webix.GroupMethods.max(this.go[0][e],n),
s=a&&"undefined"!=typeof a.start?parseFloat(a.start):webix.GroupMethods.min(this.go[0][e],n),this.go.length>1)for(var r=1;r<this.go.length;r++){var h=webix.GroupMethods.max(this.go[r][e],n),o=webix.GroupMethods.min(this.go[r][e],n);h>i&&(i=h),s>o&&(s=o)}return{max:i,min:s}},Do:function(t){var e="log";
return Math[e](t)/Math.LN10},xo:function(t,e,i,s,n){if(this.s.xAxis){var a=this.canvases.x.renderTextAt(n,s,t,e-(n?2:0),this.s.xAxis.template(i));a&&(a.className+=" webix_axis_item_x")}},yo:function(t,e,i,s,n){this.s.xAxis&&this.s.xAxis.lines&&this.zo(t,e,i,e,s,this.s.xAxis.lineColor.call(this,n),1)},
zo:function(t,e,i,s,n,a,r){t.strokeStyle=a,t.lineWidth=r,t.beginPath(),t.moveTo(e,i),t.lineTo(s,n),t.stroke(),t.lineWidth=1},Ho:function(t,e){var i,s=1;return i=e!=t?e-t:t,[i,s]},qo:[function(t){return"#FF"+webix.color.toHex(t/2,2)+"00"},function(t){return"#FF"+webix.color.toHex(t/2+128,2)+"00"},function(t){
...
s&&s.disable();i.getAttribute("disabled")||(s=this.go[this.Io].tooltip,s&&s.enable())}},uA:function(t){var e,i,s,n,a,r,h,o;for(i=this.eo.sA,n=webix.html.offset(this.w.t),a=webix.html.pos(t),h=a.x-n.x,o=a.y-n.y,s=0;s<i.length;s++)e=i[s].points,h<=e[2]&&h>=e[0]&&o<=e[3]&&o>=e[1]&&(r?i[s].index>r.index&&(r=i[s]):r=i[s]);
return r?r.index:0},hideSeries:function(t){this.canvases[t].hideCanvas();var e=this.s.legend;e&&e.values&&e.values[t]&&(e.values[t].$hidden=!0,this.mo()),this.eo.hide(this.w,t,!0)},showSeries:function(t){this.canvases[t].showCanvas();var e=this.s.legend;e&&e.values&&e.values[t]&&(delete e.values[t].$hidden,
this.mo()),this.eo.hide(this.w,t,!1)},mo:function(t,e){var i,s,n,a,r,h,o,l,c,u,d,f=0,b=0;if(t=t||[],e=e||this.bc,l=this.canvases.legend.getCanvas(),s=this.s.legend,o="x"!=this.s.legend.layout?"width:"+s.width+"px":"",this.ko&&(this.ko.innerHTML="",this.ko.parentNode.removeChild(this.ko)),this.canvases.legend.clearCanvas(!0),
...
"round"!=c&&o.radius)if("item"==c){if(this.s.line&&"scatter"!=this.s.type&&!this.s.disableLines){t.beginPath(),t.lineWidth=this.go[r].line.width,t.strokeStyle=a?s:this.go[r].line.color.call(this,{});var u=e+5,d=i+n/2;t.moveTo(u,d);var f=u+o.width;t.lineTo(f,d),t.stroke()}var b=this.go[r].item,p=parseInt(b.radius.call(this,{}),10)||0,x=b.type.call(this,{});
p&&(t.beginPath(),a?(t.lineWidth=b.borderWidth,t.strokeStyle=s,t.fillStyle=s):(t.lineWidth=b.borderWidth,t.fillStyle=b.color.call(this,{}),t.strokeStyle=b.borderColor.call(this,{}),t.globalAlpha=b.alpha.call(this,{})),t.beginPath(),e+=o.width/2+5,i+=n/2,this.Lo(t,e,i,p+1,x),t.fill(),t.stroke()),t.globalAlpha=1;
...
if(this.s.yAxis&&"undefined"!=typeof this.s.yAxis.end&&"undefined"!=typeof this.s.yAxis.start&&this.s.yAxis.step)s=parseFloat(this.s.yAxis.end),n=parseFloat(this.s.yAxis.start);else{for(e=0;e<t.length;e++)for(t[e].$sum=0,t[e].$min=1/0,i=0;i<this.go.length;i++)a=Math.abs(parseFloat(this.go[i].value(t[e])||0)),
isNaN(a)||(-1!=this.go[i].type.toLowerCase().indexOf("stacked")&&(t[e].$sum+=a),a<t[e].$min&&(t[e].$min=a));for(s=-(1/0),n=1/0,e=0;e<t.length;e++)t[e].$sum>s&&(s=t[e].$sum),t[e].$min<n&&(n=t[e].$min);n>0&&(n=0)}return{max:s,min:n}},Oo:function(t,e,i,s,n,a,r,h){var o,l,c,u,d,f;return"light"==a?(o="x"==h?t.createLinearGradient(e,i,s,i):t.createLinearGradient(e,i,e,n),
...
t.fillStyle="#ffffff",t.beginPath(),t.arc(c,u,l,0,2*Math.PI,!0),t.fill()}}}),webix.extend(webix.ui.chart,{$render_bar:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w,g,v=s.y-i.y;g=!!this.s.yAxis,w=!!this.s.xAxis,l=this.Go(),c=l.max,u=l.min,h=(s.x-i.x)/e.length,n||"auto"!=this.s.origin&&!g||this.uo(e,i,s,u,c,h),
g&&(c=parseFloat(this.s.yAxis.end),u=parseFloat(this.s.yAxis.start)),b=this.Ho(u,c),d=b[0],f=b[1],x=d?v/d:d,g||"auto"!=this.s.origin&&w||(p=10,x=d?(v-p)/d:p),!n&&"auto"!=this.s.origin&&!g&&this.s.origin>u&&this.wo(t,e,i,s,h,s.y-x*(this.s.origin-u)),r=parseInt(this.s.barWidth,10);var m=0,y=0;for(o=0;o<this.go.length;o++)o==n&&(y=m),
...
i[2]/=1.4,e="rgb("+webix.color.hsvToRgb(i[0],i[1],i[2])+")",t.strokeStyle=e,1==t.globalAlpha&&(t.globalAlpha=.9)},dp:function(t,e,i,s,n,a,r,h,o){var l;t.save(),l=this.ep(t,e,i,h,r,s,n),this.gp(t,o),this.fp(t,l.x0,l.y0,s,a,r,l.value,t.lineWidth/2,1),t.stroke(),t.restore()},cp:function(t,e,i,s,n,a,r,h,o,l,c){
t.save();var u=this.ep(t,e,i,h,r,s,n),d=this.Oo(t,u.x0,u.y0,u.x0+s,u.y0-r*u.value+2,l,o,"y");t.fillStyle=d.gradient,this.fp(t,u.x0+d.offset,u.y0,s-2*d.offset,a,r,u.value,d.offset+c),t.fill(),t.restore()},fp:function(t,e,i,s,n,a,r,h,o){t.beginPath();var l=0;if(n>a*r){var c=(n-a*r)/n;1>=c&&c>=-1&&(l=-Math.acos(c)+Math.PI/2);
}t.moveTo(e+h,i);var u=i-Math.floor(a*r)+n+(n?0:h);a*r>n&&t.lineTo(e+h,u);var d=e+n;n&&n>0&&t.arc(d,u,Math.max(n-h,0),-Math.PI+l,-Math.PI/2,!1);var f=e+s-n-h,b=u-n+(n?h:0);t.lineTo(f,b),n&&n>0&&t.arc(f+h,u,Math.max(n-h,0),-Math.PI/2,0-l,!1);var p=e+s-h;return t.lineTo(p,i),o||t.lineTo(e+h,i),[p,b]}}),
webix.extend(webix.ui.chart,{$render_line:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w;if(l=this.hp(t,e,i,s,n),r=this.s,e.length){for(c=r.offset?i.x+.5*l.cellWidth:i.x,o=[],h=0;h<e.length;h++)if(w=this.ip(e[h],i,s,l),w||"0"==w){if(d=h?l.cellWidth*h-.5+c:c,b="object"==typeof w?w.y0:w,h&&this.s.fixOverflow){
...
}},jp:function(t,e,i,s,n){return t+(n-i)*(e-t)/(s-i)},lp:function(t,e,i,s,n,a,r){var h=this.s.item,o=parseInt(h.radius.call(this,s),10)||0,l=this.kp,c=h.type.call(this,s);if(o){if(t.save(),h.shadow){t.lineWidth=1,t.strokeStyle="#bdbdbd",t.fillStyle="#bdbdbd";for(var u=[.1,.2,.3],d=u.length-1;d>=0;d--)t.globalAlpha=u[d],
t.strokeStyle="#d0d0d0",t.beginPath(),this.Lo(t,e,i+2*o/3,o+d+1,c),t.stroke();t.beginPath(),t.globalAlpha=.3,t.fillStyle="#bdbdbd",this.Lo(t,e,i+2*o/3,o+1,c),t.fill()}t.restore(),t.lineWidth=h.borderWidth,t.fillStyle=h.color.call(this,s),t.strokeStyle=h.borderColor.call(this,s),t.globalAlpha=h.alpha.call(this,s),
t.beginPath(),this.Lo(t,e,i,o+1,c),t.fill(),t.stroke(),t.globalAlpha=1}if(n&&this.canvases[a].renderTextAt(!1,!0,e,i-o-this.s.labelOffset,this.s.label.call(this,s)),r){var f=this.s.eventRadius||o+1;r.addRect(s.id,[e-f-l.x,i-f-l.y,e+f-l.x,i+f-l.y],a)}},Lo:function(t,e,i,s,n){var a=[];if(!n||"square"!=n&&"s"!=n)if(!n||"diamond"!=n&&"d"!=n)a=!n||"triangle"!=n&&"t"!=n?[[e,i,s,0,2*Math.PI,!0]]:[[e,i-s],[e+Math.sqrt(3)*s/2,i+s/2],[e-Math.sqrt(3)*s/2,i+s/2],[e,i-s]];else{
var r=t.lineWidth>1?t.lineWidth*Math.sqrt(2)/4:0;a=[[e,i-s],[e+s,i],[e,i+s],[e-s,i],[e+r,i-s-r]]}else s*=Math.sqrt(2)/2,a=[[e-s-t.lineWidth/2,i-s],[e+s,i-s],[e+s,i+s],[e-s,i+s],[e-s,i-s]];this.Mo(t,a)},ip:function(t,e,i,s){var n=s.minValue,a=s.maxValue,r=s.unit,h=s.valueFactor,o=this.s.value(t);this.Bo&&(o=this.Do(o));
var l=(parseFloat(o||0)-n)*h;this.s.yAxis||(l+=s.startValue/r);var c=i.y-r*l;return!this.s.fixOverflow||"line"!=this.s.type&&"area"!=this.s.type?(o>a&&(c=e.y),(0>l||n>o)&&(c=i.y)):o>a?c={y:e.y,y0:c,out:"max"}:(0>l||n>o)&&(c={y:i.y,y0:c,out:"min"}),c},hp:function(t,e,i,s,n){var a,r={};r.totalHeight=s.y-i.y,
this.s.cellWidth?r.cellWidth=Math.min(s.x-i.x,this.s.cellWidth):r.cellWidth=(s.x-i.x)/(this.s.offset?e.length:e.length-1);var h=!!this.s.yAxis,o=-1!=this.s.type.indexOf("stacked")?this.No(e):this.Go();r.maxValue=o.max,r.minValue=o.min,n||this.uo(e,i,s,r.minValue,r.maxValue,r.cellWidth),h&&(r.maxValue=parseFloat(this.s.yAxis.end),
r.minValue=parseFloat(this.s.yAxis.start));var l=this.Ho(r.minValue,r.maxValue);return a=l[0],r.valueFactor=l[1],r.unit=a?r.totalHeight/a:10,r.startValue=0,h||(r.startValue=10,r.unit!=r.totalHeight&&(r.unit=a?(r.totalHeight-r.startValue)/a:10)),r}}),webix.extend(webix.ui.chart,{$render_barH:function(t,e,i,s,n,a){
var r,h,o,l,c,u,d,f,b,p,x,w,g,v,m,y,$,_,C,S,k;for(o=(s.y-i.y)/e.length,d=this.Go("h"),f=d.max,b=d.min,y=s.x-i.x,k=!!this.s.xAxis,n||this.mp(t,e,i,s,b,f,o),k&&(f=parseFloat(this.s.xAxis.end),b=parseFloat(this.s.xAxis.start)),v=this.Ho(b,f),w=v[0],x=v[1],_=w?y/w:10,k||(m=10,_=w?(y-m)/w:10),h=parseInt(this.s.barWidth,10),
h*this.go.length+4>o&&(h=o/this.go.length-4),r=Math.floor((o-h*this.go.length)/2),g="undefined"!=typeof this.s.radius?parseInt(this.s.radius,10):Math.round(h/5),p=!1,c=this.s.gradient,c&&"function"!=typeof c?(p=c,c=!1):c&&(c=t.createLinearGradient(i.x,i.y,s.x,i.y),this.s.gradient(c)),k||this.zo(t,i.x-.5,i.y,i.x-.5,s.y,"#000000",1),
u=0;u<e.length;u++)if($=parseFloat(this.s.value(e[u]||0)),this.Bo&&($=this.Do($)),$&&!isNaN($))if($>f&&($=f),$-=b,$*=x,C=i.x,S=i.y+r+u*o+(h+1)*n,0>$&&"auto"==this.s.origin||this.s.xAxis&&0===$&&!("auto"!=this.s.origin&&this.s.origin>b))this.canvases[n].renderTextAt("middle","right",C+10,S+h/2+r,this.s.label(e[u]));else{
...
a.addRect(e[u].id,[I[0]-i.x,I[3]-i.y,I[2]-i.x,I[3]+h-i.y],n)):(this.canvases[n].renderTextAt("middle",!1,I[2]+5,I[1]+Math.floor(h/2),this.s.label(e[u])),a.addRect(e[u].id,[I[0]-i.x,S-i.y,I[2]-i.x,I[3]-i.y],n))}},qp:function(t,e,i,s,n,a,r,h,o){var l=0;if(n>a*r){var c=(n-a*r)/n;l=-Math.asin(c)+Math.PI/2;
...
t.fillStyle=u.gradient,t.beginPath(),this.qp(t,c.x0,c.y0+u.offset,s-2*u.offset,a,r,c.value,u.offset),t.fill(),t.globalAlpha=1,t.restore()}}),webix.extend(webix.ui.chart,{$render_stackedBar:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f=this.s,b=s.y-i.y,p=!!f.yAxis,x=!!f.xAxis,w=this.No(e),g=0===f.origin;r=w.max,
h=w.min;var v=Math.floor((s.x-i.x)/e.length);n||(o=this.uo(e,i,s,h,r,v)),p&&(r=parseFloat(f.yAxis.end),h=parseFloat(f.yAxis.start));var m=this.Ho(h,r);d=m[0],u=m[1];var y=d?b/d:10,$=parseInt(f.barWidth,10);$+4>v&&($=v-4);var _=Math.floor((v-$)/2),C=f.gradient?f.gradient:!1;x||this.zo(t,i.x,s.y+.5,s.x,s.y+.5,"#000000",1);
...
a.addRect(e[S].id,[l-i.x,D[1]-i.y,D[0]-i.x,e[S][I?"$startYN":"$startY"]-i.y],n),e[S][I?"$startYN":"$startY"]=D[1]}}},up:function(t,e,i,s,n,a,r,h){t.moveTo(e,i),r>n&&(n=r),t.lineTo(e,n);var o=e+s,l=n;t.lineTo(o,l);var c=e+s;return t.lineTo(c,i),h||t.lineTo(e,i),[c,l]}}),webix.extend(webix.ui.chart,{$render_stackedBarH:function(t,e,i,s,n,a){
...
S>r&&(S=r),S-=h,S*=o;var k=i.x,I=i.y+g+C*f;if(_?k=e[C].$startX:e[C].$startX=k,S&&!isNaN(S)){u||(S+=x/p);var E=this.s.color.call(this,e[C]);t.globalAlpha=this.s.alpha.call(this,e[C]),t.fillStyle=this.s.color.call(this,e[C]),t.beginPath();var M=this.qp(t,k,I,w,v,p,S,0);if(y&&!m&&t.lineTo(i.x+c,I+(this.s.border?1:0)),
...
e[C].$startX=M[0]}}}}),webix.extend(webix.ui.chart,{$render_spline:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w,g;if(c=this.hp(t,e,i,s,n),r=this.s,this.kp=i,o=[],e.length){for(f=r.offset?i.x+.5*c.cellWidth:i.x,h=0;h<e.length;h++)x=this.ip(e[h],i,s,c),(x||"0"==x)&&(d=h?c.cellWidth*h-.5+f:f,o.push({
x:d,y:x,v:this.s.value(e[h]),index:h}));for(u=this.vp(o),h=0;h<o.length;h++){if(b=o[h].x,w=o[h].y,h<o.length-1){for(p=o[h+1].x,g=o[h+1].y,l=b;p>l;l++){var v=this.wp(l,b,h,u.a,u.b,u.c,u.d);v<i.y&&(v=i.y),v>s.y&&(v=s.y);var m=this.wp(l+1,b,h,u.a,u.b,u.c,u.d);m<i.y&&(m=i.y),m>s.y&&(m=s.y),this.zo(t,l,v,l+1,m,r.line.color(e[h]),r.line.width);
}this.zo(t,p-1,this.wp(l,b,h,u.a,u.b,u.c,u.d),p,g,r.line.color(e[h]),r.line.width)}this.lp(t,b,w,e[o[h].index],r.label(e[o[h].index]),n,a)}}},vp:function(t){var e,i,s,n,a,r,h,o,l=[],c=[],u=t.length;for(a=0;u-1>a;a++)l[a]=t[a+1].x-t[a].x,c[a]=(t[a+1].y-t[a].y)/l[a];for(h=[],o=[],h[0]=0,h[1]=2*(l[0]+l[1]),
...
n[a]=(r[a+1]-r[a])/(6*l[a]);for(a=0;a<t.length-1;a++)0===t[a].v&&0===t[a+1].v&&(e[a]=t[a].y,n[a]=s[a]=i[a]=0);return{a:e,b:i,c:s,d:n}},wp:function(t,e,i,s,n,a,r){return s[i]+(t-e)*(n[i]+(t-e)*(a[i]+(t-e)*r[i]))}}),webix.extend(webix.ui.chart,{$render_area:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w,g,v,m;
...
x=u.cellWidth*(o-1)-.5+p,w="object"==typeof f?f.y0:f,f.out&&(m="min"==f.out?s.y:i.y,d.push([this.jp(x,g,w,v,m),m])),b.out&&(m="min"==b.out?s.y:i.y,d.push([this.jp(x,g,w,v,m),m]),o==e.length-1&&m==i.y&&d.push([g,i.y]))}b.out||(d.push([g,v]),a.addRect(c.id,[g-l-i.x,v-l-i.y,g+l-i.x,v+l-i.y],n)),h.yAxis||(r=h.offset||o!=e.length-1?"center":"left",
this.canvases[n].renderTextAt(!1,r,g,v-h.labelOffset,h.label(c)))}d.length&&(d.push([g,s.y]),d.push([d[0][0],s.y])),t.globalAlpha=this.s.alpha.call(this,e[0]),t.fillStyle=this.s.color.call(this,e[0]),t.beginPath(),this.Mo(t,d),t.fill(),t.lineWidth=1,t.globalAlpha=1,h.border&&(t.lineWidth=h.borderWidth||1,
h.borderColor?t.strokeStyle=h.borderColor.call(this,e[0]):this.gp(t,t.fillStyle),t.beginPath(),this.Mo(t,d),t.stroke())}},$render_stackedArea:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w,g,v;if(p=this.hp(t,e,i,s,n),l=this.s,f=l.eventRadius||Math.floor(p.cellWidth/2),e.length){x=[],v=[],w=l.offset?i.x+.5*p.cellWidth:i.x;
var m=function(t,i){return n?e[t].$startY?i-s.y+e[t].$startY:0:i},y=function(t,e,i){var s=(i.y-e.y)/(i.x-e.x);return s*t+e.y-s*e.x};for(c=0;c<e.length;c++)b=e[c],c?w+=p.cellWidth:(g=m(c,s.y),x.push([w,g])),g=m(c,this.ip(b,i,s,p)),v.push(isNaN(g)&&!c?e[c].$startY||s.y:g),g&&(x.push([w,g]),a.addRect(b.id,[w-f-i.x,g-f-i.y,w+f-i.x,g+f-i.y],n),
...
t.beginPath(),this.Mo(t,x),t.fill(),c=0;c<e.length;c++){if(g=v[c],!g)for(c==e.length-1&&(g=e[c].$startY),u=c+1;u<e.length;u++)if(v[u]){r={x:i.x,y:v[0]},h={x:i.x+p.cellWidth*u,y:v[u]},g=y(i.x+p.cellWidth*c,r,h);break}e[c].$startY=g}}}}),webix.extend(webix.ui.chart,{$render_radar:function(t,e,i,s,n,a){
...
var o,l,c,u,d,f,b,p,x,w,g,v,m,y,$,_,C,S,k;for(c=this.s,d=c.yAxis.start,f=c.yAxis.end,k=this.Ho(d,f),v=k[0],S=v?n/v:n/2,C=k[1],m=-Math.PI/2,o=l=m,x=[],p=0,u=0;u<a.length;u++)_?$=_:(y=c.value(a[u]),this.Bo&&(y=this.Do(y)),$=(parseFloat(y||0)-d)*C),w=Math.floor(S*$),y=c.value(u!=a.length-1?a[u+1]:a[0]),
this.Bo&&(y=this.Do(y)),_=(parseFloat(y||0)-d)*C,g=Math.floor(S*_),o=l,l=u!=a.length-1?m+e[u]-1e-4:m,b=p||this.Qo(o,i,s,w),p=this.Qo(l,i,s,g),x.push(b);c.fill&&this.Ap(t,x,a),!c.disableLines&&a.length>2&&this.Bp(t,x,a),(!c.disableItems||a.length<3)&&this.Cp(t,x,a,r,h),x=null},Cp:function(t,e,i,s,n){for(var a=0;a<e.length;a++)this.lp(t,e[a].x,e[a].y,i[a],this.s.label.call(this,i),s,n);
...
h=c.start,o=c.end,l=c.step,a.end=o,a.start=h}var f,b,p,x,w,g=[],v=0,m=s*l/(o-h);1>l&&(x=Math.min(this.Do(l),0>=h?0:this.Do(h)),w=Math.pow(10,-x));var y=[];this.canvases.scale||(this.canvases.scale=this.lo("radar_scale"));var $=this.canvases.scale.getCanvas();for(f=o;f>=h;f-=l){var _=this.Bo?Math.pow(10,f):f;
c.fixNum&&(_=parseFloat(f).toFixed(c.fixNum)),g.push(Math.floor(v*m)+.5),w&&!this.Bo&&(_=Math.round(_*w)/w,f=_);var C=i-s+g[g.length-1];if(this.canvases.scale.renderTextAt("middle","left",e,C,a.template(_.toString()),"webix_axis_item_y webix_radar"),t.length<2)return void this.Dp($,"arc",e,i,s-g[g.length-1],-Math.PI/2,3*Math.PI/2,f);
var S,k=-Math.PI/2,I=k;for(b=0;b<t.length;b++)v||y.push(I),S=k+t[b]-1e-4,this.Dp($,t.length>2?u.lineShape||"line":"arc",e,i,s-g[g.length-1],I,S,f,b,n[f]),I=S;v++}for(f=0;f<y.length;f++)p=this.Qo(y[f],e,i,s),r.lines.call(this,n[f],f)&&this.zo($,e,i,p.x,p.y,r?r.lineColor.call(this,n[f]):"#cfcfcf",1),this.Ep($,e,i,s,y[f],r?r.template.call(this,n[f]):"&nbsp;");
...
if(!this.s.xValue)return!1;var r=this.s,h=!(r.disableLines||"undefined"==typeof r.disableLines),o=this.Go(),l=this.Go("h","xValue");n||(this.canvases.x||(this.canvases.x=this.lo("axis_x")),this.canvases.y||(this.canvases.y=this.lo("axis_y")),this.vo(this.canvases.y.getCanvas(),e,i,s,o.min,o.max),this.rp(this.canvases.x.getCanvas(),e,i,s,l.min,l.max)),
o={min:r.yAxis.start,max:r.yAxis.end},l={min:r.xAxis.start,max:r.xAxis.end};var c=this.Fp(t,e,i,s,l,o);this.kp=i;for(var u=[],d=0;d<e.length;d++){var f=this.Ip(c,s,i,l,e[d],"X"),b=this.Ip(c,i,s,o,e[d],"Y");isNaN(f)||isNaN(b)||u.push({x:f,y:b,index:d})}for(var p,x,w,g,v,d=0;d<u.length;d++){if(v=u[d].index,
h){var m=r.line.color.call(this,e[v]);p=u[d].x,x=u[d].y,d==u.length-1?r.shape&&u.length>2&&(this.zo(t,w,g,u[0].x,u[0].y,m,r.line.width),r.disableItems||this.Gp(t,a,u[0],e[0],n),r.fill&&this.sH(t,u,e)):(w=u[d+1].x,g=u[d+1].y,this.zo(t,p,x,w,g,m,r.line.width))}!r.disableItems&&u[d]&&this.Gp(t,a,u[d],e[v],n);
}},sH:function(t,e,i){var s,n;t.globalAlpha=this.s.alpha.call(this,{}),t.beginPath();for(var a=0;a<e.length;a++)t.fillStyle=this.s.fill.call(this,i[a]),s=e[a],n=e[a+1]||e[0],a||t.moveTo(s.x,s.y),t.lineTo(n.x,n.y);t.fill(),t.globalAlpha=1},Fp:function(t,e,i,s,n,a){var r={};return r.totalHeight=s.y-i.y,
r.totalWidth=s.x-i.x,this.Hp(r,n.min,n.max,r.totalWidth,"X"),this.Hp(r,a.min,a.max,r.totalHeight,"Y"),r},Gp:function(t,e,i,s,n){this.lp(t,i.x,i.y,s,this.s.label.call(this,s),n,e)},Ip:function(t,e,i,s,n,a){var r=this.s["X"==a?"xValue":"value"].call(this,n),h=t["valueFactor"+a],o=(parseFloat(r||0)-s.min)*h,l=t["unit"+a],c=i[a.toLowerCase()]-("X"==a?-1:1)*Math.floor(l*o);
...
$render_splineArea:function(t,e,i,s,n,a){var r,h,o,l,c,u,d,f,b,p,x,w,g,v,m=this.s,y=[];if(u=this.hp(t,e,i,s,n),c=m.eventRadius||Math.floor(u.cellWidth/2),o=[],e.length){for(b=i.x,h=0;h<e.length;h++)w=this.ip(e[h],i,s,u),(w||"0"==w)&&(f=h?u.cellWidth*h-.5+b:b,o.push({x:f,y:w,index:h}),a.addRect(e[h].id,[f-c-i.x,w-c-i.y,f+c-i.x,w+c-i.y],n));
for(d=this.vp(o),h=0;h<o.length;h++)if(p=o[h].x,g=o[h].y,h<o.length-1){for(x=o[h+1].x,v=o[h+1].y,l=p;x>l;l++){var $=this.wp(l,p,h,d.a,d.b,d.c,d.d);$<i.y&&($=i.y),$>s.y&&($=s.y);var _=this.wp(l+1,p,h,d.a,d.b,d.c,d.d);_<i.y&&(_=i.y),_>s.y&&(_=s.y),y.push([l,$]),y.push([l+1,_])}y.push([x,v])}r=this.s.color.call(this,e[0]),
...
}},ID:function(t,e,i){var s=this.aq[this.Np].LD(t,e,this);if(i!==!1){var n=this.x.querySelector("."+s+"[tabindex='0']");n&&n.focus()}},Op:function(t,e){if(!this.Pp||e){var i=t.getMonth(),s=t.getFullYear(),n=new Date(s,i+1,1),a=webix.Date.weekStart(new Date(s,i,1)),r=Math.round((n.valueOf()-a.valueOf())/864e5),h=this.s.skipEmptyWeeks?Math.ceil(r/7):6;
this.Pp={Qp:i,Rp:a,zc:n,Sp:h}}return this.Pp},$skin:function(){webix.skin.$active.calendar&&(webix.skin.$active.calendar.width&&(this.defaults.width=webix.skin.$active.calendar.width),webix.skin.$active.calendar.height&&(this.defaults.height=webix.skin.$active.calendar.height),webix.skin.$active.calendar.headerHeight&&(this.defaults.headerHeight=webix.skin.$active.calendar.headerHeight),
webix.skin.$active.calendar.timepickerHeight&&(this.defaults.timepickerHeight=webix.skin.$active.calendar.timepickerHeight))},Tp:function(t){for(var e=this.Op(t),i=this.s,s=[],n=[],a=this.bc-36,r=this.dc-this.s.headerHeight-10-(this.s.timepicker||this.ax?this.s.timepickerHeight:0),h=i.weekNumber?8:7,o=0;h>o;o++)n[o]=Math.ceil(a/(h-o)),
a-=n[o];for(var l=e.Sp,c=0;l>c;c++)s[c]=Math.ceil(r/(l-c)),r-=s[c];return[n,s]},icons_setter:function(t){t?"object"==typeof t?this.ax=t:this.ax=this.Sx:this.ax=null},ax:[],Sx:[{template:function(){return"<span role='button' tabindex='0' class='webix_cal_icon_today webix_cal_icon'>"+webix.i18n.calendar.today+"</span>";
...
r+="</div>",t.weekHeader&&(r+="<div class='webix_cal_header' aria-hidden='true'>"+this.Wp(n)+"</div>"),r+="<div class='webix_cal_body'>"+this.Xp(n,a,i)+"</div>",(this.s.timepicker||this.ax)&&(r+="<div class='webix_cal_footer'>",this.s.timepicker&&(r+=this.Yp(e)),this.ax&&(r+=this.bx()),r+="</div>"),this.w.innerHTML=r,
...
return i},Wp:function(t){var e=this.s,i="",s=0;e.weekNumber&&(s=1,i+="<div class='webix_cal_week_header' style='width: "+t[0]+"px;' >"+e.calendarWeekHeader()+"</div>");for(var n=webix.Date.startOnMonday?1:0,a=0;7>a;a++){var r=(n+a)%7,h=webix.i18n.calendar.dayShort[r];i+="<div day='"+r+"' style='width: "+t[a+s]+"px;' >"+h+"</div>";
...
i+=" webix_cal_day"},Xp:function(t,e,i){for(var s=this.s,n="",a=webix.Date.datePart(webix.Date.copy(i.Rp)),r=s.weekNumber?1:0,h=webix.Date.getISOWeek(webix.Date.add(a,2,"day",!0)),o=(this.s.minDate||new Date(1,1,1),this.s.maxDate||new Date(9999,1,1),0);o<e.length;o++){n+="<div class='webix_cal_row' style='height:"+e[o]+"px;line-height:"+e[o]+"px'>",
r&&(!a.getMonth()&&a.getDate()<7&&(h=webix.Date.getISOWeek(webix.Date.add(a,2,"day",!0))),n+="<div class='webix_cal_week_num' aria-hidden='true' style='width:"+t[0]+"px'>"+h+"</div>");for(var l=r;l<t.length;l++){var c=this.Zp(a,i),u=this.s.dayTemplate.call(this,a),d=this.VG(a),f="";"object"==typeof u?(f=u.aria||f,
u=u.text):f=webix.Date.dateToStr(webix.i18n.aria.dateFormat)(a),n+="<div day='"+l+"' role='gridcell' "+(a.getMonth()!=i.Qp?"aria-hidden='true'":"")+" aria-label='"+f+"' tabindex='"+(d?"0":"-1")+"' aria-selected='"+(d?"true":"false")+"' class='"+c+"' style='width:"+t[l]+"px'><span aria-hidden='true' class='webix_cal_day_inner'>"+u+"</span></div>",
...
d+="</div>",d+="</div>",d+="<div  class='webix_time_footer'>"+this.mq()+"</div>",this.w.innerHTML=d}else{var w=r[0].childNodes,g=webix.i18n.aria["nav"+(1==this.Np?"Year":"Decade")];for(w[0].innerHTML=c.eq(e.date,this),w[1].setAttribute("aria-label",g[0]),w[2].setAttribute("aria-label",g[1]),s=this.hq/3,
...
return t&&(e=webix.Date.dateToStr(t)(e)),e},selectDate:function(t,e,i){if(t&&i&&this.config.multiselect||(this.UG={}),t){webix.isArray(t)||(t=[t]);for(var s=0;s<t.length;s++){var n=this.Jp(t[s]),a=webix.Date.datePart(webix.Date.copy(n)).valueOf();if(this.UG[a]&&i?delete this.UG[a]:this.UG[a]=n,!this.config.multiselect)break;
...
var i=this.on_edit[e];return i===!1?!1:i||e},li:function(t){return this.getItem(t)},ui:function(t,e,i){var s=this.oq[t.id],n=this.s.elements;if(i){for(var a=s+1;a<n.length;a++)if(e.call(this,n[a].id))return n[a].id}else for(var a=s-1;a>=0;a--)if(e.call(this,n[a].id))return n[a].id;return null},updateItem:function(t,e){
...
a=s.collection||s.options?s.template(s,s.value):s.format?s.format(s.value):s.value,r&&(a=r.call(this,s.value,s)),t[i]=n+h+a+"</div></div>"}}return t.join("")},type:{height:24,templateStart:webix.template(""),templateEnd:webix.template("</div>")},$skin:function(){this.type.height=webix.skin.$active.propertyItemHeight||24;
...
return t.className="webix_color_selector",this.x.lastChild.appendChild(t),t},$setValue:function(t,e){if(this.isVisible(this.s.id)){var i,s,n,a,r,h=0,o=0;if(e&&(n=this.sq(e)),n||(n={row:0,col:0}),this.x.lastChild.childNodes[n.row].childNodes[n.col].setAttribute("tabindex","-1"),n=this.sq(t),n&&(i=this.x.lastChild.childNodes[n.row].childNodes[n.col]),
...
i.setAttribute("tabindex","0"),i.setAttribute("aria-selected","true"),s=this.vq(),r=["left:"+h+"px","top:"+o+"px","width:"+i.style.width,"height:"+i.style.height].join(";"),"undefined"!=typeof s.style.cssText?s.style.cssText=r:s.setAttribute("style",r)}},wq:function(t){function e(t){return webix.color.toHex(t,2);
}function i(t,i,s){return"#"+e(Math.floor(t))+e(Math.floor(i))+e(Math.floor(s))}function s(t,e,i){var s,a,r;if(e){var h=.5>i?i*(1+e):i+e-i*e,o=2*i-h;s=n(o,h,t+1/3),a=n(o,h,t),r=n(o,h,t-1/3)}else s=a=r=i;return{r:255*s,g:255*a,b:255*r}}function n(t,e,i){return 0>i&&(i+=1),i>1&&(i-=1),1/6>i?t+6*(e-t)*i:.5>=i?e:2/3>i?t+(e-t)*(2/3-i)*6:t;
}function a(t){for(var e=[],s=255,n=s/t,a=0;t>a;a++)s=Math.round(s>0?s:0),e.push(i(s,s,s)),s-=n;return e[e.length-1]="#000000",e}var r=[],h=t.rows-1,o=1/t.cols,l=(t.maxLightness-t.minLightness)/h,c=null;r.push(a(t.cols));for(var u=0,d=t.minLightness;h>u;u++){c=[];for(var f=0,b=0;f<t.cols;f++){var p=s(b,1,d);
c.push(i(p.r,p.g,p.b)),b+=o}r.push(c),d+=l}this.s.palette=r},moveSelection:function(t,e,i){var s,n,a=this.getValue();if(a&&(s=this.sq(a)),s||(s={row:0,col:0}),s&&("up"==t||"down"==t?s.row=s.row+("up"==t?-1:1):"right"==t||"left"==t?s.col=s.col+("right"==t?1:-1):"top"==t?s.row=s.col=0:"bottom"==t&&(s.row=this.x.lastChild.querySelectorAll(".webix_color_row").length-1,
s.col=this.x.lastChild.childNodes[s.row].childNodes.length-1),s.row>=0&&(n=this.x.lastChild.childNodes[s.row].childNodes[s.col]),n&&(a=n.getAttribute("webix_val"),this.setValue(a),this.callEvent("onSelect",[this.s.value]),i!==!1))){var r=this.x.querySelector("div[tabindex='0']");r&&r.focus()}},render:function(){
...
events:webix.bind(this.WD,this),css:h+(1===r?"":0===l?"0":l+1==r?"N":"1"),timepicker:0===this.Np?t.timepicker:!1,borderless:!0,date:c},!0),e.push(webix.copy(a))}t.rows=[{type:"clean",cols:e},this.XD(t,n*r)],t.height=t.height||a.height+(t.icons||t.button?35:0),t.type="line",this.$ready.push(this.av),webix.event(this.$view,"keydown",webix.bind(function(t){
this.DD(t.which||t.keyCode,t)},this))},value_setter:function(t){return this.SD(t)},getValue:function(){return this.s.value},setValue:function(t,e){t=this.SD(t),this.s.value=t;var i=t.start||t.end||new Date;if(!e){this.YD[0].showCalendar(t.start);for(var s=1;s<this.YD.length;s++)this.YD[s].s.date=i,this.ZD(this.YD[s],1,s);
}this.callEvent("onChange",[t]),this.refresh()},refresh:function(){for(var t=(this.s.value,0);t<this.YD.length;t++)if(this.YD[t].Np===this.Np){webix.html.removeCss(this.YD[t].$view,"webix_cal_timepicker"),webix.html.removeCss(this.YD[t].$view,"webix_range_timepicker");var e=this.$D(this.YD[t].getVisibleDate());
if(e.start||e.end){if(this.YD[t].s.date=e.start||e.end,this.s.timepicker){var i="webix_"+(e.start&&e.end?"range":"cal")+"_timepicker";webix.html.addCss(this.YD[t].$view,i)}}else webix.Date.datePart(this.YD[t].s.date);this.YD[t].refresh()}},addToRange:function(t){var e=this._D(this.Jp(t));this.setValue(e);
},ax:[{template:function(){return"<span role='button' tabindex='0' class='webix_cal_icon_today webix_cal_icon'>"+webix.i18n.calendar.today+"</span>"},on_click:{webix_cal_icon_today:function(){var t=new Date;this.s.timepicker||(t=webix.Date.datePart(t)),this.addToRange(t),this.callEvent("onTodaySet",[this.getValue()]);
...
t.start=this.Jp(t.start)||null,(t.end&&t.end<t.start||!t.start)&&(t.end=[t.start,t.start=t.end][0]),t},Jp:function(t){return"string"==typeof t&&(t=webix.i18n.parseFormatDate(t)),isNaN(1*t)?null:t},WD:function(t){var e=this.s.value,i=e.start?webix.Date.datePart(webix.Date.copy(e.start)):null,s=e.end?webix.Date.datePart(webix.Date.copy(e.end)):null,n=webix.Date.datePart(t),a="";
n>=i&&s&&s>=n&&(a="webix_cal_range"),webix.Date.equal(n,i)&&(a="webix_cal_range_start"),webix.Date.equal(n,s)&&(a="webix_cal_range_end");var r=webix.Date.isHoliday(t)+" "||"";return a+" "+r},av:function(){var t=this.YD=this.getChildViews()[0].getChildViews(),e=this,i=this.config.id;this.aE={};for(var s=0;s<t.length;s++)t[s].config.master=i,
this.aE[t[s].config.id]=s,t[s].attachEvent("onBeforeDateSelect",function(t){return e.bE(this,t)}),t[s].attachEvent("onBeforeZoom",function(t){return e.cE(this,t)}),(0===s||s===t.length-1)&&(t[s].attachEvent("onAfterMonthChange",webix.bind(this.dE,this)),t[s].attachEvent("onAfterZoom",function(t,i){e.eE(this,t,i);
}));this.s.timepicker&&this.refresh()},cE:function(t,e){var i=this.fE(t.config.id);if(e>=0&&i>0&&i!==this.YD.length-1)return!1;if(-1===e){var s=this.$D(t.getVisibleDate());s.start&&s.end&&(t.s.date=s[this.UD])}return!0},dE:function(t,e){var i=t>e?1:-1,s=t>e?this.YD[this.YD.length-1]:this.YD[0],n=s.aq[s.Np]._p;
this.gE(i,n,s),this.refresh()},eE:function(t,e,i){var s=t.aq[t.Np]._p,n=this.fE(t.config.id),a=0===n?1:-1;if(this.YD[n+a]){var r=this.YD[n+a].s.date;if(i>e&&e>=0){var h=0;if(1===e){var o=r.getFullYear();(this.Np||-1===a&&11===r.getMonth()||1===a&&0===r.getMonth())&&(o-=a),h=t.s.date.getFullYear()-o}else if(0===e){
var l=r.getMonth()-a;(12===l||-1==l)&&(l=-1===l?11:0),h=t.s.date.getMonth()-l}this.gE(h,s,t),this.refresh()}}},ZD:function(t,e,i){t.blockEvent(),t.Np>=0&&t.$p(e,i),t.unblockEvent()},fE:function(t){return this.aE[t]},gE:function(t,e,i){for(var s=0;s<this.YD.length;s++){var n=this.YD[s];i&&n.config.id===i.config.id||this.ZD(n,t,e);
...
$init:function(t){this.s.value={},delete t.type},Je:function(){var t=this.s;t.suggest?t.popup=t.suggest:t.popup||(t.popup=t.suggest=this.suggest_setter({view:"daterangesuggest",body:{timepicker:t.timepicker,calendarCount:t.calendarCount,height:250+(t.button||t.icons?30:0)}})),this.ze=function(){}},$prepareValue:function(t){
t=t||{},t.start=webix.ui.datepicker.prototype.$prepareValue.call(this,t.start?t.start:null),t.end=webix.ui.datepicker.prototype.$prepareValue.call(this,t.end?t.end:null);var e=webix.$$(this.s.popup).getRange();return webix.copy(e.SD(t))},$compareValue:function(t,e){var i=webix.ui.datepicker.prototype.$compareValue,s=i.call(this,t.start,e.start),n=i.call(this,t.end,e.end);
return s&&n},$setValue:function(t){t=t||{},this.s.text=(t.start?this.YE(t.start):"")+(t.end?" - "+this.YE(t.end):""),this.ND()},$render:function(t){t.value=this.$prepareValue(t.value),this.$setValue(t.value)},getValue:function(){var t=this.s.value;if(this.s.stringResult){var e=webix.i18n.parseFormatStr;
return this.kE(e,t)}return t||null},kE:function(t,e){return e.start&&(e.start=t(e.start)),e.end&&(e.end=t(e.end)),e}},webix.ui.datepicker),webix.protoUI({name:"resizer",defaults:{width:7,height:7},$init:function(t){this.x.className+=" webix_resizer";var e=this.getParentView().Cc;webix.UE(this.x,webix.env.mouse.down,this.xq,{
bind:this}),webix.event(document.body,webix.env.mouse.up,this.yq,{bind:this});var i=this.zq();this.Aq=!1,this.Bq=i,this.Cq="x"==i?"width":"height","x"==i?t.height=0:t.width=0,e>0?(this.x.className+=" webix_resizer_v"+i,this.x.style.marginRight="-"+e+"px","x"==i?t.width=e:t.height=e,this.$nospace=!0):this.x.className+=" webix_resizer_"+i,
this.x.innerHTML="<div class='webix_resizer_content'></div>","y"==i&&e>0&&(this.x.style.marginBottom="-"+(t.height||this.defaults.height)+"px"),this.x.setAttribute("tabindex","-1"),this.x.setAttribute("aria-grabbed","false")},xq:function(t){var e=this.Dq();if(e&&!this.s.disabled){t=t||event,this.Aq=!0,
this.Pl=webix.html.pos(t),this.Eq=[],this.x.setAttribute("aria-grabbed","true");for(var i=0;2>i;i++)e[i].$view.setAttribute("aria-dropeffect","move");this.x.setAttribute("aria-dropeffect","move"),this.Fq(t,e[0])}},yq:function(){this.Aq=!1,this.Pl=!1},Fq:function(t,e){var i,s,n,a,r;t=t||event,i=this.Bq,
this.getParentView().x.style.position="relative",n=webix.html.offset(this.x),a=webix.html.offset(this.getParentView().x),r=n[i]-a[i],s=webix.html.offset(e.$view)[i]-webix.html.offset(this.getParentView().$view)[i],this.Rl=[i,e,r,s],this.Gq=new webix.ui.resizearea({container:this.getParentView().x,dir:i,
eventPos:this.Pl[i],start:r-1,height:this.$height,width:this.$width,border:1,margin:this.getParentView()["_padding"+i.toUpperCase()]}),this.Gq.attachEvent("onResizeEnd",webix.bind(this.Hq,this)),this.Gq.attachEvent("onResize",webix.bind(this.Iq,this)),webix.html.addCss(document.body,"webix_noselect",1);
},zq:function(){return this.getParentView().mc?"y":"x"},Iq:function(){var t,e,i,s,n,a,r,h,o,l;if(this.Rl)for(t=this.Dq(),n=this.Rl[0],s=this.Gq.Jl-this.Rl[2],o=this.Jq(t,n,s),l=t[0]["$"+this.Cq]+t[1]["$"+this.Cq],r="y"==n?["minHeight","maxHeight"]:["minWidth","maxWidth"],a=0;2>a;a++){e=t[a].s,i=a?-s:s;
var c=e[r[0]],u=e[r[1]];if(i>0&&u&&u<=o[a]||0>i&&(c||3)>=o[a])return this.Eq[a]=i>0?u:c||3,h=this.Kq(t,n),void(this.Gq.Dl.style["y"==n?"top":"left"]=this.Rl[3]+h[0]+"px");o[a]<3?this.Gq.Dl.style["y"==n?"top":"left"]=this.Rl[3]+a*l+1+"px":this.Eq[a]=null}},Dq:function(){var t,e,i;for(t=this.getParentView().q,
e=0;e<t.length;e++)if(t[e]==this)return i=[this.tH(t,e,1,-1),this.tH(t,e,1,1)],i[0]&&i[1]||(i=null),i},tH:function(t,e,i,s){var n=t[e+s*i];return n&&n.s.hidden?this.tH(t,e,i+1,s):n&&n.s.$noresize?null:n},Hq:function(t){if("undefined"!=typeof t){var e,i,s,n,a,r=this.getParentView().mc;if(this.Lq=null,
this.Rl){if(i=this.Rl[0],s=t-this.Rl[2],e=this.Dq(),e[0]&&e[1]){a=this.Mq(e,i,s);for(var n=0;2>n;n++){var h=e[n].$getSize(0,0);if(r?h[2]==h[3]:Math.abs(h[1]-h[0])<3)e[n].s[this.Cq]=a[n],e[n].tc&&e[n].tc(this.Cq,a[n],r);else{var o=e[n].$view[r?"offsetHeight":"offsetWidth"];e[n].s.gravity=a[n]/o*e[n].s.gravity;
...
webix.ui.each(r,this.Lw)),this.callEvent("onViewChange",[a.s.id,r.s.id])}},$getSize:function(t,e){if(!this.q.length)return webix.ui.baseview.prototype.$getSize.call(this,0,0);var i=this.q[this.Mh].$getSize(0,0);if(this.s.fitBiggest)for(var s=0;s<this.q.length;s++)if(s!=this.Mh)for(var n=this.q[s].$getSize(0,0),a=0;4>a;a++)i[a]=Math.max(i[a],n[a]);
var r=webix.ui.baseview.prototype.$getSize.call(this,0,0);return r[1]>=1e5&&(r[1]=0),r[3]>=1e5&&(r[3]=0),r[0]=(r[0]||i[0])+t,r[1]=(r[1]||i[1])+t,r[2]=(r[2]||i[2])+e,r[3]=(r[3]||i[3])+e,r},$setSize:function(t,e){this.q.length&&(this.lc=[t,e],webix.ui.baseview.prototype.$setSize.call(this,t,e),this.q[this.Mh].$setSize(t,e));
...
if(e>105&&112>e&&(e-=64),t[e]&&8!==e&&46!==e)return void(i[e]||webix.html.preventEvent(s));webix.html.preventEvent(s),this.$C(s,e)}}),this.attachEvent("onAfterRender",this.ye),this.getText=function(){return this.getInputNode().value},this.VC=function(t,e){return e===!1?this._C(t):this.aD(t)},e.format))if("object"==typeof e.format)this.nH=e.format;else{
var s=webix.Number.getConfig(e.format);this.nH={parse:function(t){return webix.Number.parse(t,s)},edit:function(t){return webix.Number.format(t,s)}}}},pattern_setter:function(t){var e=webix.patterns[t]||t;return"string"==typeof e&&(e={mask:e}),e.allow=e.allow||/[A-Za-z0-9]/g,this.bD(e),e},cD:function(){
...
var e=(new Date).valueOf();this.$view.offsetWidth;(!this.fD||e-this.fD>100)&&(this.fD=e,this.$setValue(this.getText()))},{bind:this}),webix.UE(this.getInputNode(),"blur",function(t){this.Xy()},{bind:this})},bD:function(t){for(var e=t.mask,i={},s="",n=0,a=0;a<e.length;a++)"#"===e[a]?(i[a]=n,n++):(i[a]=!1,
-1===s.indexOf(e[a])&&(s+="\\"+e[a]));this.eD=t.allow,this.dD=new RegExp("["+s+"]","g"),this.gD=i,this.cD()},$C:function(t,e){var i=this.getInputNode(),s=i.value,n=webix.html.getSelectionRange(i),a="";8==e||46==e?n.start==n.end&&(8==e?n.start--:n.end++):(a=String.fromCharCode(e),t.shiftKey||(a=a.toLowerCase())),
s=s.substr(0,n.start)+a+s.substr(n.end),n=this.hD(a,s.length,n.start,e),this.iD=e,this.$setValue(s),webix.html.setSelectionRange(i,n)},hD:function(t,e,i,s){if(t&&t.match(this.eD)||8==s||46==s)i=t?i+1:i,i=this.jD(i,s);else if(e-1==i&&8!==s&&46!==s){var n=this.s.pattern.mask.indexOf("#",i);n>0&&(i+=n)}
return i},jD:function(t,e){var i=t-1*(46!==e);return this.gD[i]===!1?(t+=8==e?-1:1,this.jD(t,e)):this.gD[t]===!1&&8!==e?this.jD(t+1,e)-1:t},_C:function(t){if(this.nH)return this.nH.parse(t);t=t||"";var e=t.toString().match(this.eD)||[];return e.join("").replace(this.dD,"")},aD:function(t){if(this.nH)return this.nH.edit(this.nH.parse(t));
var e=this._C(t),i=this.s.pattern.mask,s=this.s.pattern.mask,n=this.gD,a=!1,r=0,h=0,o=0;for(var l in n)if(n[l]!==!1){if(!a){r=1*l,h=n[l];var c=e[h]||"",u=e[h+1];i=(c?i.substr(0,r):"")+c+(c&&u?i.substr(r+1):""),u||(a=!0)}o++}var d=this.iD;if(d&&8!==d||!d&&o-1===h&&i.length<s.length)if(e){var f=r+1;if("#"!==s.charAt(f)&&i.length<s.length){
...
name:"checklist",templateStart:webix.template('<div webix_l_id="#!id#" {common.aria()} class="{common.classname()}" style="width:{common.widthSize()}; height:{common.heightSize()}; overflow:hidden; white-space:nowrap;">{common.checkbox()}'),checkbox:function(t,e){var i=webix.skin.icon+(t.$checked?"check-square":"square-o");
...
var e=this.getParentView().getParentView();webix.delay(function(){e._y(t)})}}},{view:"button",click:function(){var t=this.getParentView().getParentView();t.setMasterValue({id:t.getValue()}),t.hide()}}]}},_y:function(t,e,i){var s=this.getValue(),n=i||webix.toArray(s?this.getValue().split(this.s.separator):[]),a=webix.$$(this.s.master);
if(i||(n.find(t)<0?n.push(t):n.remove(t)),a)a.setValue(n.join(this.s.separator));else{var r=this.setValue(n);this.ae&&(this.ae.value=r.join(this.s.separator))}if(e){var h=this.getList().getItemNode(t).getElementsByTagName("SPAN");h&&h.length&&h[0].focus()}},Jt:function(t){return t.rows[0]},_d:function(){
...
onItemClick:function(t){for(var e=this.getParentView().getParentView(),i=e.getList(),s=i.data.order,n=0;n<s.length;n++){var a=i.getItem(s[n]);a.$checked=this.getValue()}var r=this.getValue()?[].concat(s):[];e._y(s[0],t,r),i.refresh()},onChange:function(){var t=this.$view.querySelector("label"),e=webix.i18n.combo;
...
i&&this._y(i),t.hide(!0)}else t.show(this.ae);else t.isVisible()&&t.hide(!0)},ke:function(){var t=this.getList();t.select&&t.unselect()},setValue:function(t){var e,i=this.getList(),s=[],n={},a=[];for(t=t||[],webix.isArray(t)?i.config.dataFeed&&(t=this.fB(t)):t=t.toString().split(this.config.separator),
e=0;e<t.length;e++)n[t[e]]=1,i.getItem(t[e])&&(this.dB&&(this.dB[t[e]]=webix.copy(i.getItem(t[e]))),s.push(this.getItemText(t[e])));for(i.data.each(function(t){t.$checked?n[t.id]||(t.$checked=0,a.push(t.id)):n[t.id]&&(t.$checked=1,a.push(t.id))},this,!0),e=0;e<a.length;e++)i.refresh(a[e]);return this.s.value=t.length?t.join(this.config.separator):"",
...
return this.s.master&&(this.setValue(webix.$$(this.s.master).config.value),webix.$$(this.s.master).getInputNode().value||this.isVisible()?(this.getList().refresh(),this.je=!0):this.getList().filter(),t.tagName&&"input"==t.tagName.toLowerCase())?(webix.ui.popup.prototype.show.apply(this,[t.parentNode,e,i]),
!1):void 0});var a=n.getList();return"string"==typeof t?a.load(t):e||a.parse(t),n.be=function(){},n},yy:function(t,e){var i,s,n,a,r,h,o,l,c,u,d,f,b,p,x="",w="top"==this.s.labelPosition;return i="x"+webix.uid(),p=e.Ee(t),n=t.inputAlign||"left",o=this.zy-2*webix.skin.$active.inputPadding-2,r=this.xy||"",
...
this.Dy()):this.vA!=this.getPopup().$height&&this.getPopup().show(this.JA()),s.value.indexOf(this.s.separator)>-1&&this.s.tagMode){var n=s.value.replace(this.s.separator,"");if(n)if(this.s.newValues)this.HA(n);else{var a=this.getPopup().getItemId(n);a&&this.az(a)}this.s.keepText?(this.xy=n,s.value=n,
...
this!=n&&n.Le(t,e,i),s.submenu||n.uH?(this!==n&&!webix.env.touch||"click"!=n.s.openAction||this.Yq(t,i),e.showpopup=!0):(n.Uq(!0),n.$q&&n.hide())}}}),this.attachEvent("onKeyPress",function(t,e){if(9===t)this.getTopMenu().Uq();else if(13===t||32===t){var i,s=this.getSelectedId();s&&(i=this.getItemNode(s)),
...
},this),this.config.width=webix.html.getTextSize(t,this.$view.className).width+16+2+(e?15:0),this.resize()}},getTopMenu:function(){for(var t=this;t.ar;)t=webix.$$(t.ar);return t},Rh:function(t){this.s.autoheight&&(t=this.count());for(var e=this.count(),i=0,s=0;t>s;s++){var n=this.data.pull[this.data.order[s]];
n&&"Separator"==n.$template?(i+=4,this.s.autoheight||t++):i+=this.type.height}return this.Lf(t&&e>t),i},on_mouse_move:{},type:{css:"menu",width:"auto",aria:function(t,e,i){return'role="menuitem"'+(i&&i.webix_selected?' aria-selected="true" tabindex="0"':'tabindex="-1"')+(t.submenu||t.data?'aria-haspopup="true"':"")+(i&&i.webix_disabled?' aria-disabled="true"':"");
...
e.inputPadding=t.inputPadding,e.tabMinWidth=t.tabMinWidth||100,e.tabMoreWidth=t.tabMoreWidth||40},ut:function(){var t,e,i=this.s,s=this.OC||i.options,n=this.we-2*i.tabOffset,a=i.optionWidth||i.tabMinWidth;if(e=s.length,i.tabMinWidth&&a>n/e)return{max:parseInt(n/a,10)||1};if(!i.optionWidth)for(t=0;e>t;t++)s[t].width&&(n-=s[t].width+(t||i.type?0:i.tabMargin),
...
},getPopup:function(){return this.Je(),webix.$$(this.s.tabbarPopup)},moreTemplate_setter:webix.template,popupTemplate_setter:webix.template,defaults:{popupWidth:200,popupTemplate:"#value#",yCount:7,moreTemplate:'<span class="webix_icon '+webix.skin.icon+'ellipsis-h"></span>',template:function(t,e){var i,s,n,a,r,h,o,l,c,u;
...
s+=e.vt(l[n],u),g&&(s+='<div role="button" tabindex="0" aria-label="'+webix.i18n.aria.showTabs+'" class="webix_tab_more_icon" style="width:'+t.tabMoreWidth+'px;">'+t.moreTemplate(t,e)+"</div>",o+=t.tabMoreWidth);a=e.bc-o,a>0&&!t.type&&(s+="<div class='webix_tab_filler' style='width:"+a+"px;'>&nbsp;</div>");
}else s="<div class='webix_tab_filler' style='width:"+e.we+"px; border-right:0px;'></div>";return r="",h=c&&!t.type?"height:"+(e.dc-c)+"px":"",t.topOffset&&!t.type&&(r+="<div class='webix_before_all_tabs' style='width:100%;height:"+t.topOffset+"px'></div>"),r+="<div style='"+h+"' role='tablist' class='webix_all_tabs "+(t.type?"webixtype_"+t.type:"")+"'>"+s+"</div>",
t.bottomOffset&&!t.type&&(r+="<div class='webix_after_all_tabs' style='width:100%;height:"+t.bottomOffset+"px'></div>"),r}},Ie:function(){return this.$view.querySelectorAll(".webix_item_tab")},vt:function(t,e){var i,s="",n=this.config;if(t.id==n.value&&(s=" webix_selected"),t.css&&(s+=" "+t.css),e=t.width||e,
...
this.$ready.push(this.Nv);for(var e=t.cells,i=[],s=e.length-1;s>=0;s--){var n=e[s].body||e[s];n.id||(n.id="view"+webix.uid()),i[s]={value:e[s].header,id:n.id,close:e[s].close,width:e[s].width,hidden:!!e[s].hidden},e[s]=n}var a={view:"tabbar",multiview:!0},r={view:"multiview",cells:e,animate:!!t.animate
};t.value&&(a.value=t.value),t.tabbar&&webix.extend(a,t.tabbar,!0),t.multiview&&webix.extend(r,t.multiview,!0),a.options=a.options||i,t.rows=[a,r],delete t.cells,delete t.tabs},Nv:function(){this.getTabbar().attachEvent("onOptionRemove",function(t){var e=webix.$$(t);if(e){var i=e.getParentView();i&&i.removeView(e);
}})}},webix.ui.layout),webix.protoUI({name:"fieldset",defaults:{borderless:!0,$cssName:"webix_fieldset",paddingX:18,paddingY:30},$init:function(t){this.x.className+=" "+this.defaults.$cssName,this.x.innerHTML="<fieldset><legend"+(t.required?' class="webix_required"':"")+"></legend><div></div></fieldset>";
},label_setter:function(t){return this.x.firstChild.childNodes[0].innerHTML=t,t},getChildViews:function(){return[this.os]},body_setter:function(t){return webix.Xb=this,this.os=webix.ui(t,this.x.firstChild.childNodes[1]),t},getBody:function(){return this.os},resizeChildren:function(){if(this.os){var t=this.$width-this.s.paddingX,e=this.$height-this.s.paddingY,i=this.os.$getSize(0,0);
...
s[1]<s[0]&&(s[1]=s[0]),s[3]<s[2]&&(s[3]=s[2]),s},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&(t=Math.min(this.ps[1],t),e=Math.min(this.ps[3],e),this.os.$setSize(t-this.s.paddingX,e-this.s.paddingY))}},webix.ui.view),webix.protoUI({name:"forminput",defaults:{$cssName:"webix_forminput",
labelWidth:80,labelAlign:"left",paddingY:0,paddingX:0},setValue:function(t){this.os.setValue?this.os.setValue(t):this.os.setValues&&this.os.setValues(t)},focus:function(){this.os.focus&&this.os.focus()},getValue:function(){return this.os.getValue?this.os.getValue():this.os.getValues?this.os.getValues():void 0;
},value_setter:function(t){this.setValue(t)},getBody:function(){return this.os},$skin:function(){this.tF=webix.skin.$active.inputPadding,this.$E=webix.skin.$active.inputSpacing},$init:function(t){this.$ready.push(function(){var t=this.x.firstChild.childNodes[0];t.style.width=this.s.paddingX+"px",t.style.textAlign=this.s.labelAlign,
this.s.labelWidth||(t.style.display="none")});var e=webix.isUndefined(t.labelWidth)?this.defaults.labelWidth:t.labelWidth;t.paddingX=e-2*this.tF+2*this.$E},setBottomText:function(t){var e=this.s;if("undefined"!=typeof t){if(e.bottomLabel==t)return;e.bottomLabel=t}var i=(e.invalid?e.invalidMessage:"")||e.bottomLabel;
this._F&&webix.html.remove(this._F),i&&(this.$view.style.position="relative",this._F=webix.html.create("div",{"class":"webix_inp_bottom_label",role:e.invalid?"alert":"","aria-relevant":"all",style:"position:absolute; bottom:0px; padding:2px; background: white; left:"+this.s.labelWidth+"px; "},i),this.x.appendChild(this._F));
}},webix.ui.fieldset),webix.protoUI({name:"dbllist",defaults:{borderless:!0},$init:function(t){this.uF={},this.vF=webix.bind(function(t){return this.uF[t.id]},this),this.wF=webix.bind(function(t){return!this.uF[t.id]},this),this.$view.className+=" webix_dbllist",this.$ready.unshift(this.HE)},$onLoad:function(t,e){
return this.xF(function(){this.$$("left").data.driver=e,this.$$("left").parse(t),this.$$("right").data.driver=e,this.$$("right").parse(t)}),this.QE(),!0},yF:function(){if(this.s.buttons===!1)return{width:10};var t=webix.i18n.dbllist,e=[this.zF("deselect_all",t.deselectAll),this.zF("select_all",t.selectAll),this.zF("deselect_one",t.deselectOne),this.zF("select_one",t.selectOne)],e={
width:120,template:e.join(""),onClick:{dbllist_button:function(t,e,i){this.getTopParentView().AF(i.getAttribute("action"))}}};return this.s.buttons&&(e.template=this.s.buttons),e},zF:function(t,e){return"<button class='dbllist_button' action='"+t+"'>"+e+"</button>"},BF:function(t,e,i,s){var n={view:"list",
select:"multiselect",multiselect:"touch",id:t,action:e,drag:!0,type:{margin:3,id:t},on:{onBeforeDrop:function(t){var e=t.from,i=t.to,s=e.getTopParentView();if(s===this.getTopParentView()){var n="select_one"!=i.s.action;s.select(t.source,n)}return!1},onItemDblClick:function(){return this.getTopParentView().AF(this.config.action);
...
return i?i.toLowerCase():null}function i(){var e=t(this);return n[e]?n[e](this):n.other(this)}function s(e){var i=t(this);return a[i]?a[i](this,e):a.other(this,e)}var n={radio:function(t){for(var e=0;e<t.length;e++)if(t[e].checked)return t[e].value;return""},input:function(t){var i=e(t,"type");return"checkbox"===i?t.checked:t.value;
},textarea:function(t){return t.value},select:function(t){var e=t.selectedIndex;return t.options[e].value},other:function(t){return t.innerHTML}},a={radio:function(t,e){for(var i=0;i<t.length;i++)t[i].checked=t[i].value==e},input:function(t,i){var s=e(t,"type");"checkbox"===s?t.checked=i?!0:!1:t.value=i;
...
this.elements={};for(var a=0;a<n.length;a++){var r=n[a],h=e(r,"name");if(h){var o="button"===t(r),l=e(r,"type"),c=o||"button"===l||"submit"===l;if("radio"===l){var u=this.elements[h]||[];u.tagName="radio",u.push(r),r=u}this.elements[h]=r,r.getValue=i,r.setValue=s,r.$allowsClear=!c}}return this.elements;
},Te:function(t,e){this.Qe(t,e);var i=this.x.querySelector('[name="'+t+'"]');i&&webix.html.addCss(i,"invalid")},Qe:function(t,e){var i=this.x.querySelector('[name="'+t+'"]');i&&webix.html.removeCss(i,"invalid")}},webix.ui.template,webix.Values)}(),function(){var t,e;webix.protoUI({name:"google-map",$init:function(t){
this.$view.innerHTML="<div class='webix_map_content' style='width:100%;height:100%'></div>",this.w=this.$view.firstChild,this.iF=webix.promise.defer(),this.data.provideApi(this,!0),this.$ready.push(this.render)},getMap:function(t){return t?this.iF:this.eo},aG:function(e){return webix.bind(function(){
"function"==typeof e&&e(),t=t||window.google,this.mE.call(this)},this)},render:function(){if("undefined"==typeof window.google||"undefined"==typeof window.google.maps){if(!e){e=document.createElement("script"),e.type="text/javascript";var t=this.s,i=t.src||"//maps.google.com/maps/api/js";i+=-1===i.indexOf("?")?"?":"&",
t.key&&(i+="&key="+t.key),t.libraries&&(i+="&libraries="+t.libraries),e.src=i,document.getElementsByTagName("head")[0].appendChild(e)}e.onload=this.aG(e.onload)}else this.aG()()},mE:function(){var e=this.config;this.isVisible(e.id)&&(this.eo=new t.maps.Map(this.w,{zoom:e.zoom,center:new t.maps.LatLng(e.center[0],e.center[1]),
mapTypeId:t.maps.MapTypeId[e.mapType]}),this.iF.resolve(this.eo))},center_setter:function(e){return this.eo&&this.eo.setCenter(new t.maps.LatLng(e[0],e[1])),e},mapType_setter:function(e){return this.eo&&this.eo.setMapTypeId(t.maps.MapTypeId[e]),e},zoom_setter:function(t){return this.eo&&this.eo.setZoom(t),
t},layerType_setter:function(t){return"heatmap"==t&&(this.config.libraries="visualization"),this.nE[t]&&(webix.extend(this,this.nE[t],!0),this.data.attachEvent("onStoreUpdated",webix.bind(function(){this.iF.then(webix.bind(function(){this.drawData.call(this,arguments)},this))},this))),t},defaults:{zoom:5,
center:[39.5,-98.5],mapType:"ROADMAP",layerType:"marker"},$setSize:function(){webix.ui.view.prototype.$setSize.apply(this,arguments),this.eo&&t.maps.event.trigger(this.eo,"resize")},$onLoad:function(t){return this.eo?!1:(this.iF.then(webix.bind(function(){this.parse(t)},this)),!0)},nE:{marker:{drawData:function(t,e,i){
switch(i){case"add":e.$marker=this.oE(e);break;case"update":e.$marker=this.oE(e);break;case"delete":e.$marker.setMap(null);break;default:this.data.each(function(t){t.$marker=this.oE(t)},this)}},clearAll:function(t){this.data.each(function(t){t.$marker.setMap(null)}),this.data.clearAll(t)},showItem:function(e){
var i=this.getItem(e);this.eo.setCenter(new t.maps.LatLng(i.lat,i.lng))},oE:function(e){var i={};for(var s in e)i[s]=e[s];i.position=new t.maps.LatLng(e.lat,e.lng),i.map=e.hidden?null:this.eo;var n=e.$marker;return n?e.$marker.setMap(i.map):(n=new t.maps.Marker(i),this.h(n)),this.callEvent("onItemRender",[e]),
n},h:function(t){var e=this;t.addListener("click",function(){e.callEvent("onItemClick",[this.id,this])}),t.getDraggable()&&(t.addListener("dragend",function(){e.pE(this,!0)}),t.addListener("drag",function(){e.pE(this)}))},pE:function(t,e){var i=this.getItem(t.id),s=t.getPosition(),n=e?"onAfterDrop":"onDrag";
...
return this.eo?!1:(this.iF.then(webix.bind(function(){this.parse(t,this.s.datatype)},this)),!0)},wG:function(){if(!this.eo)return void(this.eo||this.iF.then(webix.bind(this.wG,this)));var e=this.fj&&this.fj.length?this.fj:this.yG(),i=[];if(this.data.each(function(t,s){for(var n=[],a=0;a<e.length;a++){
var r=t[e[a].label];"number"==e[a].type?r=1*r:"tooltip"==e[a].role&&(r=this.s.tooltip(t)),n.push(r)}i.push(n)},this),e.length){for(var s=new t.visualization.DataTable,n=0;n<e.length;n++)s.addColumn(e[n]);s.addRows(i);var a=new t.visualization.DataView(s);this.eo.draw(a,this.s.chart)}else this.eo.draw(t.visualization.arrayToDataTable([["",""]]),{});
...
t?this.Jr(!0,t.id,!1,t.status,!1,{text:e,data:i,loader:s}):(this.callEvent("onLoadError",arguments),webix.callEvent("onLoadError",[e,i,s,this]))},Jr:function(t,e,i,s,n,a){var r=this.s.master,h=this.getItemState(e);return h.Hr=!1,t?void(this.callEvent("onBeforeSaveError",[e,s,n,a])&&(h.Er=!0,this.s.undoOnError&&r.s.undo&&(this.ignore(function(){
r.undo(e)}),this.setItemState(e,!1)),this.callEvent("onAfterSaveError",[e,s,n,a]))):(this.setItemState(e,!1),i&&e!=i&&this.s.store.changeId(e,i),n&&"delete"!=s&&this.s.updateFromResponse&&this.ignore(function(){this.s.store.updateItem(i||e,n)}),this.s.undoOnError&&r.s.undo&&r.removeUndo(i||e),this.callEvent("onAfterSave",[n,e,a]),
void this.callEvent("onAfter"+s,[n,e,a]))},processResult:function(t,e,i){var s=e&&("error"==e.status||"invalid"==e.status),n=e?e.newid||e.id:!1;this.Jr(s,t.id,n,t.status,e,i)},xr:function(t,e,i,s){if(this.callEvent("onBeforeSync",[t,e,i,s]),-1===s)this.processResult(t,i,{});else{var n=this.s.url;if(n.$proxy&&n.result)n.result(t,this.s.master,this,e,i,s);else{
var a;e&&(a=i.json(),!e||null!==a&&"undefined"!=typeof a||(a={status:"error"})),this.processResult(t,a,{text:e,data:i,loader:s})}}this.callEvent("onAfterSync",[t,e,i,s])},escape:function(t){return this.s.escape?this.s.escape(t):encodeURIComponent(t)},getState:function(){if(!this.zr.length)return!1;for(var t=this.zr.length-1;t>=0;t--)if(this.zr[t].Hr)return"saving";
...
data:1,rows:1,cols:1,cells:1,elements:1,ui:1,column:1,config:1},Vr:function(t,e,i){var s=this.Xr(t,{});s.name?(e[s.name]=s,delete s.name):s.stack?e[s.stack]=[]:e=s;for(var n=t.childNodes,a=0;a<n.length;a++){var r=null;1==n[a].nodeType&&"config"==n[a].tagName.toLowerCase()&&n[a].attributes.length?r=this.Vr(n[a],s,i):1==n[a].nodeType&&"data"==n[a].tagName.toLowerCase()?(r=this.Ur(n[a],i),
s.stack||(s.data=r)):r=n[a].innerHTML,s.stack&&r&&e[s.stack].push(r)}return e},Tr:function(t,e){if(e)return t.getAttribute(this.attribute+"view")||("config"==t.tagName.toLowerCase()?"config":null);var i=t.tagName.toLowerCase();if(this.namespace){if(0===i.indexOf(this.Qr)||t.scopeName==this.namespace)return i.replace(this.Qr,"");
}else if(webix.ui[i]||this.$r[i])return i;return 0},Ur:function(t,e){for(var i=[],s=t.getElementsByTagName(webix.markup.dataTag),n=0;n<s.length;n++){var a=s[n];if(a.parentNode.parentNode.tagName!=webix.markup.dataTag){var r=this.Wr(a,e);a.className&&(r.$css=a.className),i.push(r)}}return webix.html.remove(t),
i},Yr:function(t,e){return t.style?t.innerHTML:t.firstChild?t.firstChild.wholeText||t.firstChild.data||"":""},Wr:function(t,e){if(!e)return webix.DataDriver.xml.tagToObject(t);var i=this.Xr(t,{},e);return!i.value&&t.childNodes.length&&(i.value=this.Yr(t,e)),i},Xr:function(t,e,i){for(var s=t.attributes,n=0;n<s.length;n++){
var a=s[n].name;if(i){if(0!==a.indexOf(this.attribute))continue;a=a.replace(this.attribute,"").replace(this.Ys,this.Zs)}var r=s[n].value;-1!=r.indexOf("json://")&&(r=JSON.parse(r.replace("json://",""))),this.Lr[a]?r=parseInt(r,10):this.AA[a]&&(r=r&&"false"!==r&&"0"!=r),e[a]=r}return e}},function(){function t(t,e){
var s=t.callback;i(!1),t.box.parentNode.removeChild(t.box),d=t.box=null,s&&s(e,t.details)}function e(e){if(d){e=e||event;var i=e.which||event.keyCode;if(webix.message.keyboard)return(13==i||32==i)&&t(d,!0),27==i&&t(d,!1),e.preventDefault&&e.preventDefault(),!(e.cancelBubble=!0)}}function i(t){i.cover&&i.cover.parentNode||(i.cover=document.createElement("DIV"),
i.cover.onkeydown=e,i.cover.className="webix_modal_cover",document.body.appendChild(i.cover)),i.cover.style.display=t?"inline-block":"none"}function s(t,e,i){return"<div role='button' tabindex='0' aria-label='"+t+"' class='webix_popup_button"+(i?" "+i:"")+"' result='"+e+"' ><div>"+t+"</div></div>"}function n(t){
f.area||(f.area=document.createElement("DIV"),f.area.className="webix_message_area",f.area.style[f.position]="5px",document.body.appendChild(f.area)),f.area.setAttribute("role","alert"),f.area.setAttribute("aria-atomic",!0),f.hide(t.id);var e=document.createElement("DIV");return e.innerHTML="<div>"+t.text+"</div>",
e.className="webix_info webix_"+t.type,e.onclick=function(){f.hide(t.id),t=null},webix.$testmode&&(e.className+=" webix_no_transition"),"bottom"==f.position&&f.area.firstChild?f.area.insertBefore(e,f.area.firstChild):f.area.appendChild(e),t.expire>0&&(f.timers[t.id]=window.setTimeout(function(){f.hide(t.id);
},t.expire)),e.style.height=e.offsetHeight-2+"px",f.pull[t.id]=e,e=null,t.id}function a(e,i,n){var a=document.createElement("DIV");a.className=" webix_modal_box webix_"+e.type,a.setAttribute("webixbox",1),a.setAttribute("role","alertdialog"),a.setAttribute("aria-label",e.title||""),a.setAttribute("tabindex","0");
var r="";if(e.width&&(a.style.width=e.width+(webix.rules.isNumber(e.width)?"px":"")),e.height&&(a.style.height=e.height+(webix.rules.isNumber(e.height)?"px":"")),e.title&&(r+='<div class="webix_popup_title">'+e.title+"</div>"),r+='<div class="webix_popup_text"><span>'+(e.content?"":e.text)+'</span></div><div  class="webix_popup_controls">',
(i||e.ok)&&(r+=s(e.ok||webix.i18n.message.ok,!0,"confirm")),(n||e.cancel)&&(r+=s(e.cancel||webix.i18n.message.cancel,!1)),e.buttons)for(var h=0;h<e.buttons.length;h++)r+=s(e.buttons[h],h);if(r+="</div>",a.innerHTML=r,e.content){var o=e.content;"string"==typeof o&&(o=document.getElementById(o)),"none"==o.style.display&&(o.style.display=""),
a.childNodes[e.title?1:0].appendChild(o)}return a.onclick=function(i){i=i||event;var s=i.target||i.srcElement;if(s.className||(s=s.parentNode),-1!=s.className.indexOf("webix_popup_button")){var n=s.getAttribute("result");n="true"==n||("false"==n?!1:n),t(e,n)}i.cancelBubble=!0},e.box=a,(i||n||e.buttons)&&(d=e),
a}function r(t,s,n){var r=t.tagName?t:a(t,s,n);t.hidden||i(!0),webix.toNode(t.container||document.body).appendChild(r);var h=t.left||Math.abs(Math.floor(((window.innerWidth||document.documentElement.offsetWidth)-r.offsetWidth)/2)),o=t.top||Math.abs(Math.floor(((window.innerHeight||document.documentElement.offsetHeight)-r.offsetHeight)/2));
...
this.mc=0):(t="rows",this.mc=1);var e={borderless:!0,type:"clean"};e[t]=webix.copy(this.s[t]);for(var i=["type","margin","marginX","marginY","padding","paddingX","paddingY"],s={},n=0;n<i.length;n++)this.s[i[n]]&&(s[i[n]]=this.s[i[n]]);webix.extend(e,s,!0),webix.Xb=this,this.Ft=webix.ui.A(e),this.x.appendChild(this.Ft.x),
...
},send:function(t){if("function"==typeof t&&(this.fs=t,t=0),!t){var e=this.files.data.order,i=!0;if(e.length)for(var s=0;s<e.length;s++)i=this.send(e[s])&&i;return void(i&&this.gs())}var n=this.files.getItem(t);if("client"!==n.status)return!1;if(n.status="transfer",this.getSwfObject()){var a=this.rE(n),r=this.s.formData||{};
"function"==typeof r&&(r=r.call(this));var h=webix.extend(n.formData||{},r);this.getSwfObject().upload(t,a,h)}return!0},$beforeAddFileToQueue:function(t,e,i){var s=e.split(".").pop(),n=this.ks(i);return this.callEvent("onBeforeFileAdd",[{id:t,name:e,size:i,sizetext:n,type:s}])},$addFileToQueue:function(t,e,i){
if(this.files.exists(t))return!1;this.s.multiple||this.files.clearAll();var s=e.split(".").pop(),n=this.ks(i),a={name:e,id:t,size:i,sizetext:n,type:s,status:"client"};this.files.add(a),this.callEvent("onAfterFileAdd",[a]),t&&this.s.autosend&&this.send(t)},stopUpload:function(t){this.as(t)},as:function(t){
...
})}},bs:function(t){var e=t.dataTransfer.files,i=t.dataTransfer.items;if(this.callEvent("onBeforeFileDrop",[e,t])){i=i||e;for(var s=0;s<i.length;s++){var n=i[s];n.webkitGetAsEntry&&(n=n.webkitGetAsEntry(),n.isDirectory)?this.lF(n,this,""):this.addFile(e[s])}}this.callEvent("onAfterFileDrop",[e,t])},fileDialog:function(t){
this.ds=new Date,this.es=t;var e=this.x.getElementsByTagName("INPUT");e[e.length-1].click()},send:function(t){if("function"==typeof t&&(this.fs=t,t=0),!t){var e=this.files.data.order,i=!0;if(e.length)for(var s=0;s<e.length;s++)i=!this.send(e[s])&&i;return void(i&&this.gs())}var n=this.files.getItem(t);
if("client"!==n.status)return!1;n.status="transfer";var a=new FormData;a.append(this.config.inputName,n.file,n.name),a.append(this.config.inputName+"_fullpath",n.name);var r={},h=this.s.formData||{};"function"==typeof h&&(h=h.call(this));var o=webix.extend(n.formData||{},h),l=new XMLHttpRequest,c=this.rE(n);
if(webix.callEvent("onBeforeAjax",["POST",c,o,l,r,a])){for(var u in o)a.append(u,o[u]);n.xhr=l,l.upload.addEventListener("progress",webix.bind(function(e){this.$updateProgress(t,e.loaded/e.total*100)},this),!1),l.onload=webix.bind(function(e){l.aborted||this.is(t)},this),l.open("POST",c,!0);for(var u in r)l.setRequestHeader(u,r[u]);
l.send(a)}return this.$updateProgress(t,0),!0},is:function(t){var e=this.files.getItem(t);if(e){var i=null;if(e.xhr.status<400){var s=webix.DataDriver[this.s.datatype||"json"];i=s.toObject(e.xhr.responseText),i&&(i=s.getDetails(i))}i&&"error"!=i.status?this.js(t,i):(e.status="error",delete e.percent,
this.files.updateItem(t),this.callEvent("onFileUploadError",[e,i])),delete e.xhr}},stopUpload:function(t){webix.bind(this.as,this.files)(t)},as:function(t){var e=this.getItem(t);"undefined"!=typeof e.xhr&&(e.xhr.aborted=!0,e.xhr.abort(),delete e.xhr,e.status="client")}}},webix.protoUI({name:"uploader",
defaults:{autosend:!0,multiple:!0,inputName:"upload"},$cssName:"button",$allowsClear:!0,on_click:{webix_hidden_upload:function(){return!1}},send:function(){},fileDialog:function(){},stopUpload:function(){},$init:function(t){var e=webix.UploadDriver.html5;this.files=new webix.DataCollection,this.Ns=[this.files],
(webix.isUndefined(XMLHttpRequest)||webix.isUndefined((new XMLHttpRequest).upload))&&(e=webix.UploadDriver.flash),webix.extend(this,e,!0)},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&this.render()},apiOnly_setter:function(t){return webix.delay(this.render,this),this.$apiOnly=t;
},cs:function(t){for(var e=0;e<t.length;e++)this.addFile(t[e])},link_setter:function(t){return t&&webix.delay(function(){var t=webix.$$(this.s.link);if(!t){var e=this.getTopParentView();e.$$&&(t=e.$$(this.s.link))}t.sync&&t.filter?t.sync(this.files):t.setValues&&this.files.data.attachEvent("onStoreUpdated",function(){
t.setValues(this)}),t.s.uploader=this.s.id},this),t},addFile:function(t,e,i,s){var n=null;"object"==typeof t&&(n=t,t=n.name,e=n.size);var a=this.ks(e);i=i||t.split(".").pop();var r={file:n,name:t,id:webix.uid(),size:e,sizetext:a,type:i,context:this.es,status:"client"};if(n.webkitRelativePath&&(r.name=n.webkitRelativePath),
s&&webix.extend(r,s,!0),this.callEvent("onBeforeFileAdd",[r])){this.s.multiple||this.files.clearAll();var h=this.files.add(r);this.callEvent("onAfterFileAdd",[r]),h&&this.s.autosend&&this.send(h)}return r},rE:function(t){var e=this.s.upload,i=webix.extend(t.urlData||{},this.s.urlData||{});if(e&&i){var s=[];
for(var n in i)s.push(encodeURIComponent(n)+"="+encodeURIComponent(i[n]));s.length&&(e+=(-1==e.indexOf("?")?"?":"&")+s.join("&"))}return e},addDropZone:function(t,e){var i=webix.toNode(t),s="";e&&(s=" "+webix.html.createCss({content:'"'+e+'"'},":before"));var n="webix_drop_file"+s,a=null;webix.UE(i,"dragover",webix.html.preventEvent),
webix.UE(i,"dragover",function(t){webix.html.addCss(i,n,!0),a&&(clearTimeout(a),a=null)}),webix.UE(i,"dragleave",function(t){a=setTimeout(function(){webix.html.removeCss(i,n)},150)}),webix.UE(i,"drop",webix.bind(function(t){return webix.html.removeCss(i,n),this.bs(t),webix.html.preventEvent(t)},this));
...
this.ls=function(){}}},webix.protoUI({name:"slider",$touchCapture:!0,defaults:{min:0,max:100,value:50,step:1,title:!1,moveTitle:!0,template:function(t,e){var i=e.qs="x"+webix.uid(),s="",n="<div class='webix_slider_title"+(t.moveTitle?" webix_slider_move":"")+"'"+(!t.moveTitle&&t.vertical?" style='line-height:"+(t.aheight-2*t.inputPadding)+"px;'":"")+"></div>",a="<div class='webix_slider_left'>&nbsp;</div>",r="<div class='webix_slider_right'></div>",h="<div class='webix_slider_handle' role='slider' aria-label='"+t.label+(t.title?" "+t.title(t):"")+"' aria-valuemax='"+t.max+"' aria-valuemin='"+t.min+"' aria-valuenow='"+t.value+"' tabindex='0' id='"+i+"'>&nbsp;</div>";
return s=t.vertical?"<div class='webix_slider_box'>"+r+a+h+"</div>"+n:n+"<div class='webix_slider_box'>"+a+r+h+"</div>",e.$renderInput(t,s,i)}},type_setter:function(t){this.x.className+=" webix_slider_"+t},title_setter:function(t){return"string"==typeof t?webix.template(t):t},rs:function(){return this.$view.querySelector(".webix_slider_handle");
},oe:function(){var t=this.rs(),e=this.s;if(t){var i=e.vertical?this.dc:this.Ee(e),s=e.value%e.step?Math.round(e.value/e.step)*e.step:e.value,n=e.max-e.min;s=Math.max(Math.min(s,e.max),e.min),s=e.vertical?n-(s-e.min):s-e.min;var a=Math.ceil((i-2*this.mF)*s/n),r=i-2*this.mF-a,h=e.vertical?"top":"left",o=e.vertical?"height":"width";
t.style[h]=this.mF+a-this.nF/2+"px",t.parentNode.style[o]=i+"px",r=Math.min(Math.max(r,2*this.oF),i-2*this.mF-2*this.oF),a=Math.min(Math.max(a,2*this.oF),i-2*this.mF-2*this.oF);var l=t.previousSibling;l.style[o]=r+"px";var c=l.previousSibling;c.style[o]=a+"px",this.BG(t,a,r,h)}},BG:function(t,e,i,s){
var n=this.s;if(this.s.title){var a=t.parentNode[n.vertical?"nextSibling":"previousSibling"];if(a.innerHTML=this.s.title(this.s,this),this.s.moveTitle){var r=0;if(n.vertical)r=e+2*this.oF-this.nF/2;else{var h=a.clientWidth/2,o=h>e?h-e-2*this.oF:0,l=h>i?h-i-2*this.oF-this.nF/2:0;r=this.mF+e-h+o-l}a.style[s]=r+"px";
...
},$skin:function(){this.nF=webix.skin.$active.sliderHandleWidth,this.mF=webix.skin.$active.sliderPadding,this.oF=webix.skin.$active.sliderBorder},tE:function(t){var e=t.keyCode,i=this.s,s=i.value;if(e>32&&41>e){webix.html.preventEvent(t);var n=t.target||t.srcElement,a=/webix_slider_handle_(\d)/.exec(n.className);
if(this.My=a?parseInt(a[1],10):-1,a&&(s=i.value[this.My]),s=s<i.min?i.min:s>i.max?i.max:s,35===e)s=i.min;else if(36===e)s=i.max;else{var r=37===e||40===e||34===e?-1:1;(33===e||34===e||i.step>1)&&(r*=i.step),s=1*s+r}if(a){var h=i.value[this.My?0:1];s=this.My&&h>=s||!this.My&&s>=h?h:s}if(s>=i.min&&s<=i.max){
if(a){for(var o=[],l=0;l<i.value.length;l++)o[l]=l===this.My?s:i.value[l];s=o}this.setValue(s),this.My=-1}}},ss:function(t){var e=t.target||t.srcElement;this.Ky&&this.Ky(t);var i=this.s.value;return webix.isArray(i)&&(i=webix.copy(i)),-1!=e.className.indexOf("webix_slider_handle")?(this.$x=i,this.ts.apply(this,arguments)):void(-1!=e.className.indexOf("webix_slider")&&(this.$x=i,
...
},ys:function(t){var e=this.s,i=e.max-e.min,s=e.vertical?"y":"x",n=webix.html.offset(this.rs().parentNode)[s]+this.mF,a=(e.vertical?this.dc:this.Ee(e))-2*this.mF,r=a?(t-n)*i/a:0;return e.vertical&&(r=i-r),r=Math.round((r+e.min)/e.step)*e.step,Math.max(Math.min(r,e.max),e.min)},De:function(){}},webix.ui.text),
...
n+="<div class='webix_slider_handle webix_slider_handle_1' id='"+e.qs[1]+"' "+s+" aria-valuenow='"+t.value[1]+"'>&nbsp;</div>";var a="<div class='webix_slider_title"+(t.moveTitle?" webix_slider_move":"")+"'"+(!t.moveTitle&&t.vertical?" style='line-height:"+(t.aheight-e.mF-2*t.inputPadding)+"px;'":"")+"></div>";
t.moveTitle&&(a="<div class='webix_slider_title_box'>"+(a+a)+"</div>");var r="<div class='webix_slider_right'>&nbsp;</div><div class='webix_slider_left'></div>",h="";return h=t.vertical?"<div class='webix_slider_box'>"+r+n+"</div>"+a:a+"<div class='webix_slider_box'>"+r+n+"</div>",e.$renderInput(t,h,i);
...
s=i.max-i.min,n=i.value[e]%i.step?Math.round(i.value[e]/i.step)*i.step:i.value[e],n=Math.max(Math.min(n,i.max),i.min),Math.ceil((t-2*this.mF)*(n-i.min)/s)},vH:function(t,e,i){var s=this.mF+e-this.nF/2*(i?-1:1);return s=i?t-s:s,s+"px"},wH:function(t,e,i,s){var n=e+this.mF+2*this.oF;return s&&(n=t-n-i),
n+"px"},oe:function(){var t,e,i,s,n,a,r,h,o,l,c;e=this.rs(0),i=this.rs(1),t=this.s,webix.isArray(t.value)||this.define("value",t.value),e&&(o=t.vertical?"height":"width",c=t.vertical?"top":"left",l=t.vertical?this.dc:this.Ee(t),a=l-2*this.mF-2*this.oF,s=this.Ly(l,0),n=this.Ly(l,1),r=n-s,e.style[c]=this.vH(l,s,t.vertical),
i.style[c]=this.vH(l,n,t.vertical),h=e.parentNode,h.style[o]=l+"px",h.firstChild.style[o]=a+"px",h.childNodes[1].style[o]=r+"px",h.childNodes[1].style[c]=this.wH(l,s,r,t.vertical),this.BG(e,[s,n],a,c))},xH:0,yH:function(t,e){webix.isUndefined(this.xH)||(t[this.xH].style.visibility="visible"),webix.isUndefined(e)||(t[e].style.visibility="hidden",
this.xH=e)},BG:function(t,e,i,s){var n=this.s;if(this.s.title){var a=t.parentNode,r=n.vertical?"nextSibling":"previousSibling";if(n.moveTitle){for(var h=a[r].childNodes,o=[],l=0;2>l;l++)o.push(this.zH(h[l],n.value[l],e[l],i,s,l));var c=n.vertical?o[0]-o[1]-this.nF:o[1]-o[0],u=n.vertical?"clientHeight":"clientWidth";
h[0][u]/2+h[1][u]/2>c?this.yH(h,webix.isUndefined(this.My)?0:this.My?0:1):this.yH(h);for(var l=0;2>l;l++)h[l].style[s]=o[l]+"px"}else a[r].innerHTML=this.s.title(this.s,this)}},zH:function(t,e,i,s,n,a){t.innerHTML=this.s.title({value:e},this);var r=t.clientWidth/2,h=0;return this.s.vertical?h=s-i-this.nF/2-(a?this.mF+this.config.inputPadding:0)+2*this.oF:(h=i+this.nF/2+2*this.oF-r,
h=!a&&r>i?r-i+h:h,h=a&&r+i>s?h-r+(s-i):h),h},sE:function(){for(var t=0;2>t;t++)this.rs(t).setAttribute("aria-valuenow",this.s.value[t])},Ky:function(t){var e=t.target||t.srcElement,i=/webix_slider_handle_(\d)/.exec(e.className);this.My=i?parseInt(i[1],10):-1,i&&this.Ny(this.My)},setValue:function(t){
...
-1==e.className.indexOf("webix_slider_active")&&(e.className+=" webix_slider_active"),i.className=i.className.replace(" webix_slider_active","")},ys:function(t){var e=this.s,i=e.value,s=e.max-e.min,n=e.vertical?"y":"x",a=webix.html.offset(this.rs().parentNode)[n],r=Math.ceil((t-a)*s/(e.vertical?this.dc:this.Ee(e)));
r=Math.round((r+e.min)/e.step)*e.step,e.vertical&&(r=s-r);var h=null,o=webix.html.offset(this.rs(0))[n],l=webix.html.offset(this.rs(1))[n];if(o!=l||e.value[0]!=e.min&&e.value[0]!=e.max)if(this.My>=0)h=this.My;else if(o==l)h=o>t?0:1;else{var c=Math.abs(o-t),u=Math.abs(l-t);h=u>c?0:1,this.My=h}else h=e.value[0]==e.min?1:0,
this.Ny(h);return h?i[h]=Math.max(Math.min(r,e.max),i[0]):i[h]=Math.max(Math.min(r,i[1]),e.min),i}},webix.ui.slider),webix.proxy.offline={$proxy:!0,storage:webix.storage.local,cache:!1,local:!1,data:"",zs:function(){this.cache||webix.env.offline||(webix.callEvent("onOfflineMode",[]),webix.env.offline=!0);
},As:function(){!this.cache&&webix.env.offline&&(webix.env.offline=!1,webix.callEvent("onOnlineMode",[]))},load:function(t,e){var i={error:function(){var i=this.getCache()||this.data,s={responseText:i},n=webix.ajax.prototype.J(s);this.zs(),webix.ajax.$callback(t,e,i,n,s)},success:function(i,s,n){this.As(),
webix.ajax.$callback(t,e,i,s,n),this.setCache(i)}};this.cache&&this.getCache()?i.error.call(this):this.source.$proxy?this.source.load(this,i):webix.ajax(this.source,i,this)},getCache:function(){return this.storage.get(this.Bs())},clearCache:function(){this.storage.remove(this.Bs())},setCache:function(t){
this.storage.put(this.Bs(),t)},Bs:function(){return this.source.$proxy?this.source.source+"_$proxy$_data":this.source+"_$proxy$_data"},save:function(t,e,i,s){this.local||webix.env.offline||(this.source.$proxy?this.source.save(t,e,i,s):webix.ajax().post(this.source,e.data,s))},saveAll:function(t,e,i,s){
this.setCache(t.serialize()),(this.local||webix.env.offline)&&webix.ajax.$callback(t,s,"",e)},result:function(t,e,i,s,n){for(var a=0;a<n.length;a++)i.processResult({id:n[a].id,status:n[a].operation},{},{})}},webix.proxy.cache={init:function(){webix.extend(this,webix.proxy.offline)},cache:!0},webix.proxy.local={
init:function(){webix.extend(this,webix.proxy.offline)},cache:!0,local:!0,data:[]},webix.ActiveContent={$init:function(t){if(t.activeContent){this.$ready.push(this.Ds),this.Es={},this.Fs={},this.Gs={},this.Hs={};for(var e in t.activeContent)if(this[e]=this.Is(e),t.activeContent[e].earlyInit){var i=webix.Xb;
webix.Xb=null,this[e].call(this,{},this,t.activeContent),webix.Xb=i}}},uE:function(){for(var t in this.Hs){var e=this.Hs[t];e.destructor&&e.destructor()}},Ds:function(){if(this.attachEvent("onDestruct",webix.bind(this.uE,this)),webix.UE(this.$view,"blur",function(t){var e=t.target||t.srcElement;if("BUTTON"!=e.tagName){
var i=webix.$$(t);if(i&&i!==this&&i.getValue&&i.setValue){i.getNode(t);var s=i.getValue();s!=i.s.value&&i.setValue(s)}}},{bind:this,capture:!0}),this.filter){for(var t in this.s.activeContent)this.type[t]=this[t],this[t]=this.Js(t);this.attachEvent("onBeforeRender",function(){this.type.masterUI=this}),
this.type.masterUI=this}},Js:function(t){return function(e){for(var i=this.Hs[t],s=i.s.id,n=this.getItemNode(e).getElementsByTagName("DIV"),a=0;a<n.length;a++)if(n[a].getAttribute("view_id")==s){i.x=i.y=n[a];break}return i}},Ks:function(t,e,i){return function(s){if(s)for(var n=s.target||s.srcElement;n;){
if(n.getAttribute&&n.getAttribute("view_id")){if(i.vE(t,n),i.locate){var a=i.locate(n.parentNode),r=i.Gs[e][a];t.s.value=r,t.s.$masterId=a}return n}n=n.parentNode}return t.x}},Ls:function(t,e){return function(i){var s=e.data;if(e.filter){var n=e.locate(this.x.parentNode);s=e.getItem(n),this.refresh(),
e.Fs[t][n]=this.x.outerHTML||(new XMLSerializer).serializeToString(this.x),e.Gs[t][n]=i}s&&(s[t]=i)}},Is:function(t){return function(e,i,s){var n=i.Es?i:i.masterUI;if(!n.Es[t]){var a=document.createElement("DIV");s=s||n.s.activeContent;var r=webix.ui(s[t],a);a.firstChild.setAttribute("onclick","event.processed = true; if (webix.env.isIE8) event.srcElement.w_view = '"+r.s.id+"';"),
...
this.cu=null)},showProgress:function(t){if(!this.cu){t=webix.extend({position:0,delay:2e3,type:"icon",icon:"refresh",hide:!1},t||{},!0);var e="icon"==t.type?webix.skin.icon+t.icon+" fa-spin":"";if(this.cu=webix.html.create("DIV",{"class":"webix_progress_"+t.type,role:"progressbar","aria-valuemin":"0",
"aria-valuemax":"100",tabindex:"0"},"<div class='webix_progress_state "+e+"'></div>"),this.setPosition||(this.x.style.position="relative"),webix.html.insertBefore(this.cu,this.x.firstChild,this.x),this.x.setAttribute("aria-busy","true"),!webix.Touch.$active&&this.getScrollState){var i=this.getScrollState();
this.x.scrollWidth!=this.$width&&(this.cu.style.left=i.x+"px"),this.x.scrollHeight!=this.$height&&("bottom"!=t.type?this.cu.style.top=i.y+"px":this.cu.style.top=i.y+this.$height-this.cu.offsetHeight+"px")}this.du=1}t&&"icon"!=t.type?webix.delay(function(){if(this.cu){var e=t.position||1;if(this.cu.style[webix.env.transitionDuration]===webix.undefined&&t.delay){
var i=0,s=0,n=e/t.delay*30,a=this;this.Oy&&(window.clearInterval(this.Oy),s=this.cu.firstChild.offsetWidth/this.cu.offsetWidth*100),this.Oy=window.setInterval(function(){30*i==t.delay?window.clearInterval(a.Oy):(a.cu&&a.cu.firstChild&&(a.cu.firstChild.style.width=s+i*n*e*100+"%"),i++)},30)}else this.cu.firstChild.style.width=100*e+"%",
...
return t.join(this.config.separator)},$setValue:function(t){if(t=t||"","extra"==this.config.mode)return this.setValueHere(t);this.rH=t;var e=t.split(this.config.separator);if(e.length==this.eu.length+1){this.setValueHere(e[0]);for(var i=0;i<this.eu.length;i++)webix.$$(this.eu[i]).setValueHere(e[i+1]);
return void(this.rH="")}this.removeSection(),this.setValueHere.call(this,e[0]);for(var i=1;i<e.length;i++){this.addSection(e[i])}this.rH=""},yB:function(t){var e=this.config.master?webix.$$(this.config.master):this,i=e.getValue(),s=e.s.value;i!==s&&(e.s.value=i,e.callEvent("onChange",[i,s]))},addSection:function(t){
var e=this.config,i={labelWidth:e.labelWidth,inputWidth:e.inputWidth,width:e.width,label:e.label?"&nbsp;":"",view:this.name,mode:"extra",value:t||"",icon:"minus-circle",suggest:e.suggest||null,master:e.id};webix.extend(i,e.subConfig||{},!0);var s=this.getParentView().addView(i);return webix.$$(s).attachEvent("onChange",this.yB),
...
},jb:function(t){var e=this.pg(t);return this.data.branch[t.id]&&(e+=this._x(t.id)),e},LA:function(){return this.type.listMarginX||this.type.listMarginY},_x:function(t,e){var i,s,n,a,r="",h=this.data.branch[t],o=this.data.Me[t],l=this.getItem(t),c=l?l.$type:!1;if(e=e||0,"list"===c&&(e+=this.type.listMarginX),
t||(this.ay=[],this.$xy={},a=this.$width-2*this.type.padding,this.$xy[0]={totalWidth:a,start:this.type.padding,width:0,height:0,left:a/2,top:this.type.padding||0}),h){n=this.$xy[t],"list"!=c||this.LA()||(r+=this.type.templateListStart.call(this,l,this.type,o));var u=0,d=0;for(i=0;i<h.length;i++){s=h[i],
a=this.by[s];var f=this.getItem(s);f.open==webix.undefined&&(f.open=!0),"list"==c&&this.data.addMark(s,"list_item","",1,!0);var b=this.cy(s);if("list"==c){var p=0;this.LA()?p=this.type.listMarginY:i||(p=this.type.marginY),this.$xy[s]={totalWidth:a,start:n.start,width:this.type.width,height:b,left:n.start+a/2-this.type.width/2+e,
top:i?this.$xy[h[i-1]].top+this.$xy[h[i-1]].height+p+d:n.top+n.height+p},d=this.data.branch[s]?this.GG(s):0}else this.$xy[s]={totalWidth:a,start:n.start+u,width:this.type.width,height:b,left:n.start+u+a/2-this.type.width/2,top:n.top+n.height+(t?this.type.marginY:0)};r+=this.pg(f),u+=a}for(i=0;i<h.length;i++)s=h[i],
this.data.branch[s]&&this.getItem(s).open?r+=this._x(s,e):l&&("list"!=l.$type?this.ay.push(this.$xy[s].top+this.$xy[s].height):i==h.length-1&&this.ay.push(this.$xy[s].top+this.$xy[s].height));var x=0;for(var w in this.$xy){var f=this.$xy[w];x=Math.max(f.left+f.width,x)}this.y.style.width=x+this.type.padding+this.type.marginX/2+"px",
"list"!=c||this.LA()||(r+=this.type.templateListEnd(l,this.type,o))}return r},GG:function(t){for(var e=this.data.branch[t],i=0,s=0;s<e.length;s++)i+=this.cy(e[s])+this.type.listMarginY,this.data.branch[e[s]]&&(i+=this.GG(e[s]));return i+this.type.marginY},cy:function(t){var e=this.getItem(t),i=this.type.height;
...
this.dy.scrollHeight},ey:function(){var t={},e=this.type.width,i=this.type.marginX;return this.data.each(function(s){t[s.id]=e+i;var n=this.getParentId(s.id);if(n&&"list"!=this.getItem(n).$type)for(;n;){var a=this.branch[n];t[n]=0;for(var r=0;r<a.length;r++)t[n]+=t[a[r]]||0;n=this.getParentId(n)}}),this.by=t,
t},getItemNode:function(t){if(this.t)return this.t[t];this.t={};for(var e=this.y.childNodes,i=0;i<e.length;i++){var s=e[i].getAttribute(this.ad);if(s&&(this.t[s]=e[i]),-1!=e[i].className.indexOf("webix_organogram_list")&&!this.LA())for(var n=e[i].childNodes,a=0;a<n.length;a++)s=n[a].getAttribute(this.ad),
...
this.canvas=new webix.Canvas({container:this.y,name:this.name,title:this.s.ariaLabel,width:this.y.offsetWidth,height:this.y.offsetHeight}),this.gy(0)},zo:function(t,e,i,s,n,a,r){t.strokeStyle=a,t.lineCap="square",t.lineWidth=r,t.beginPath(),t.moveTo(e,i),t.lineTo(s,n),t.stroke(),t.lineWidth=1},gy:function(t,e){
var i,s,n,a,r,h,o,l,c,u;this.config.layout;if(e||(e=this.canvas.getCanvas()),this.$xy&&(t=t||0,n=this.data.branch[t],s=this.getItem(t),n&&n.length)){if(a=this.$xy[t],t)if(h=parseInt(a.left+a.width/2,10)+.5,o=parseInt(a.top+a.height,10),l=parseInt(a.top+a.height+this.type.marginY/2,10),"list"==s.$type){
if(!this.LA())return l=parseInt(a.top+a.height+this.type.marginY,10),void this.zo(e,h,o,h,l,this.type.lineColor)}else this.zo(e,h,o,h,l,this.type.lineColor);for(o=parseInt(a.top+a.height+this.type.marginY/2,10)+.5,i=0;i<n.length;i++)t&&(r=this.$xy[n[i]],"list"==s.$type&&this.LA()?(h=parseInt(a.left+this.type.listMarginX/2,10)+.5,
i?i==n.length-1&&(u=h):c=h,l=parseInt(r.top+r.height/2,10),this.zo(e,h,o-this.type.marginY/2,h,l,this.type.lineColor),this.zo(e,h,l,h+this.type.listMarginX/2,l,this.type.lineColor)):(h=parseInt(r.left+r.width/2,10)+.5,i?i==n.length-1&&(u=h):c=h,l=parseInt(r.top,10),this.zo(e,h,o,h,l,this.type.lineColor))),
...
this.$view.innerHTML="",this.fy())},fy:function(){this.canvas=new webix.Canvas({container:this.$view,name:this.name,title:this.s.ariaLabel,width:this.$width,height:this.$height}),this.hy()},hy:function(){var t,e,i,s,n=this.s.value,a=this.s.type;if(!a||!this.types[a]||!n)return!1;if(t=this.type.encode(n),
s=t.length,e=this.canvas.getCanvas(),s){var r=(this.$width-2*this.config.paddingX)/s,h=0;for(i=0;s>i;i++){var o=parseInt(t.charAt(i),10);o?(h++,i==s-1&&this.bp(e,i+1,r,h,s)):h&&(this.bp(e,i,r,h,s),h=0)}this.iy(n,r)}},bp:function(t,e,i,s,n){var a,r,h,o;r=parseInt(e*i+this.config.paddingX,10),a=parseInt(r-s*i,10),
h=this.config.paddingY,o=this.$height-this.config.paddingY-this.config.textHeight,this.jy()&&(4>e||e>n-4||n/2+2>e&&e>n/2-2)&&(o+=this.config.textHeight/2),t.fillStyle=this.config.color,t.beginPath(),t.moveTo(a,h),t.lineTo(r,h),t.lineTo(r,o),t.lineTo(a,o),t.lineTo(a,h),t.fill()},iy:function(t,e){var i,s,n;
if(this.type.template&&(t=this.type.template(t)),this.jy()){if(this.type.firstDigit&&(this.canvas.renderTextAt(!0,"left",this.config.paddingX,this.$height-this.config.paddingY,t.charAt(0)),t=t.slice(1)),s=t.length,this.type.lastDigit&&s--,s){var a=(this.$width-2*this.config.paddingX-11*e)/s;for(i=0;s>i;i++)n=this.config.paddingX+i*a+(s/2>i?3:8)*e+a/2,
this.canvas.renderTextAt(!0,!0,n,this.$height-this.config.paddingY,t.charAt(i));this.type.lastDigit&&(n=this.config.paddingX+s*a+11*e,this.canvas.renderTextAt(!0,!1,n,this.$height-this.config.paddingY,t.charAt(s)))}}else this.canvas.renderTextAt(!0,!0,this.$width/2,this.$height-this.config.paddingY,t);
...
var s=this.q[i],n=s.s,a=s.$getSize(0,0);n.relative?(n.left=n.top=0,s.$setSize(t,e)):s.$setSize(a[0],a[2]);for(var r=s.$view,h=["left","right","top","bottom"],o=0;o<h.length;o++){var l=h[o];l in n&&(r.style[l]=n[l]+"px")}}}},webix.ui.baselayout),webix.protoUI({name:"datalayout",$init:function(){this.data.provideApi(this,!0),
...
this.HG(this.q[i],n)}return this.data.serialize()},HG:function(t,e){var i=t.s.name;if(i){var s=null;t.getValues?s=t.getValues():t.getValue?s=t.getValue():t.serialize&&(s=t.serialize()),"$value"==i?webix.extend(e,s,!0):e[i]=s}else{var n=t.q;if(n)for(var a=0;a<n.length;a++)this.HG(n[a],e)}},sC:function(t,e){
var i,s=t.s.name;if(s)i="$value"==s?e:e[s],t.setValues?t.setValues(i):t.setValue?t.setValue(i):t.parse&&(t.openAll&&(i=webix.copy(i)),t.parse(i));else{var n=t.q;if(n)for(var a=0;a<n.length;a++)this.sC(n[a],e)}},render:function(t,e,i){var s=this.cC.length;if(t&&"update"===i)for(var e=this.getItem(t),n=this.getIndexById(t),a=0;s>a;a++)this.sC(this.q[n*s+a],e);else{
for(var r=this.nc=[],h=this.data.order,a=0;a<h.length;a++)if(s)for(var o=0;s>o;o++)r.push(webix.copy(this.cC[o]));else r.push(this.getItem(h[a]));if(r.length||r.push({}),this.reconstruct(),s)for(var a=0;a<h.length;a++)for(var l=this.getItem(h[a]),o=0;s>o;o++){var c=this.q[a*s+o];this.sC(c,l)}}}},webix.DataLoader,webix.ui.layout),
webix.protoUI({$init:function(){webix.extend(this,webix.FlexLayout,!0)},name:"flexdatalayout"},webix.ui.datalayout),webix.protoUI({name:"gridlayout",defaults:{autoplace:!0,gridColumns:2,gridRows:2,margin:10,padding:10},gridRows_setter:function(t){return this.WG=t},kc:function(){for(var t=0;t<this.nc.length;t++)this.nc[t].Ob={};
...
void(t.y=i);t.x=0,t.y=this.WG}var n=t.x+t.dx-this.s.gridColumns;n>0&&(t.dx-=n)},Qb:function(t,e){this.XG(t.config),this.q.push(t),this.$view.appendChild(t.x),this.$G(t.config,t.config.id),this.pH(!0),this._G||this.callEvent("onChange",[])},ZG:function(t,e,i,s,n){for(var a=e;s>a;a++)for(var r=i;n>r;r++)if(!t[a]||t[a][r])return!1;
...
return 0},dH:function(t,e,i){for(var s=e.y-i.dy;s>=0;s--)if(this.ZG(t,i.x,s,i.x+i.dx,s+i.dy))return i.y-s;return 0},YG:function(t){for(var e=[],i=0;i<this.s.gridColumns;i++)e[i]=[];for(var s=0;s<this.q.length;s++){var n=this.q[s].config;n.id!==t&&this.aH(e,n,n.id)}return e},pH:function(t){(this.kH()||t)&&this.eH();
},kH:function(){if(!this.s.autoplace)return!1;var t=this.s.gridColumns,e=this.WG,i=this.YG(),s=!1;t:for(var n=e-1;n>=0;n--){for(var a=t-1;a>=0;a--)if(i[a][n])continue t;s=!0;for(var r=0;r<this.q.length;r++){var h=this.q[r].config;h.y>=n&&(h.y-=1)}}return s},$G:function(t,e){if(t.x-=Math.max(0,t.x+t.dx-this.s.gridColumns),
!this.s.autoplace)return void(t.y-=Math.max(0,t.y+t.dy-this.s.gridRows));for(var i=[],s=this.YG(e),n=0;n<this.q.length;n++){var a=this.q[n].config;a.id!==e&&a.y<t.y+t.dy&&a.y+a.dy>t.y&&a.x<t.x+t.dx&&a.x+a.dx>t.x&&i.push(a)}for(var r=[],n=0;n<i.length;n++){var a=i[n];this.aH(s,a,0);var h=this.bH(s,t,a);
if(h)a.x+=h;else{var o=this.cH(s,t,a);if(o)a.x-=o;else{var l=this.dH(s,t,a);l?a.y-=l:(a.y=t.y+t.dy,r.push(a))}}this.aH(s,a,a.id)}for(var n=0;n<r.length;n++)this.$G(r[n],r[n].id)},eH:function(){for(var t=this.s.gridRows,e=0;e<this.q.length;e++){var i=this.q[e].config;t=Math.max(t,i.y+i.dy)}this.WG!=t&&(this.WG=t,
this.resize()),this.rc()},moveView:function(t,e){e=webix.extend(webix.$$(t).config,e,!0),this.$G(e,t),this.pH(!0),this.callEvent("onChange",[])},serialize:function(t){for(var e=[],i=0;i<this.q.length;i++)if(t)e.push(t.call(this,this.q[i]));else{var s=this.q[i].config;e.push({id:s.id,name:s.name,x:s.x,
y:s.y,dx:s.dx,dy:s.dy})}return e},clearAll:function(){for(var t=0;t<this.q.length;t++)this.q[t].destructor();this.q=[],this.callEvent("onChange",[])},restore:function(t,e){e=e||this.s.factory,t=webix.copy(t),this._G=!0;for(var i={},s=0;s<t.length;s++){var n,a=t[s],r=webix.$$(a.id);r?(webix.extend(r.config,a,!0),
n=r.config.id):(r=e.call(this,a),n=this.addView(r)),i[n]=1}for(var s=this.q.length-1;s>=0;s--)i[this.q[s].config.id]||(this.q[s].destructor(),this.q.splice(s,1));this.eH(),this._G=!1},$getSize:function(t,e){for(var i=webix.ui.baseview.prototype.$getSize.call(this,0,0),s=0;s<this.q.length;s++)this.q[s].$getSize(0,0);
var n=this.s.cellWidth,a=this.s.cellHeight,r=this.fH(0,0,this.s.gridColumns,this.WG);return n&&(i[0]=r.dx+2*r.x),a&&(i[2]=r.dy+2*r.y),i},fH:function(t,e,i,s){var n=this.s.margin,a=this.s.paddingX||this.s.padding,r=this.s.paddingY||this.s.padding,h=this.s.cellWidth;h||(h=(this.$width-2*a+n)/this.s.gridColumns-n);
var o=this.s.cellHeight;o||(o=(this.$height-2*r+n)/this.WG-n);var l=a+(h+n)*t,c=r+(o+n)*e,u=Math.ceil(h+(h+n)*(i-1)),d=Math.ceil(o+(o+n)*(s-1));return{x:l,y:c,dx:u,dy:d}},rc:function(t,e){for(var i=0;i<this.q.length;i++){var s=this.q[i],n=s.s,a=this.fH(n.x,n.y,n.dx,n.dy);s.$getSize(0,0);s.$setSize(a.dx,a.dy);
var r=s.$view;r.style.left=a.x+"px",r.style.top=a.y+"px"}}},webix.ui.abslayout),webix.protoUI({name:"dashboard",$init:function(){webix.DragControl.addDrag(this.$view,this),webix.DragControl.addDrop(this.$view,this,!0)},gH:function(t){if(!t.getAttribute||t.getAttribute("webix_disable_drag")||t.getAttribute("webixignore"))return!1;
var e=(t.className||"").toString();return-1!=e.indexOf("panel_drag")?t:t.parentNode&&t!=this.$view?this.gH(t.parentNode):!1},$dragCreate:function(t,e){if(e.target){if(!this.gH(e.target))return!1;var i=webix.$$(e);i.$resizeMove||(i=i.queryView(function(t){return!!t.config.dx},"parent"));var s=webix.html.offset(this.$view),n=webix.html.pos(e);
...
s=this.s.factory.call(this,s),this.addView(s)},$dragDestroy:function(t,e,i){e.style.zIndex=1,webix.html.remove(this.iH),this.iH=null,this.eH()},jH:function(t,e){var i=this.s.margin,s=this.s.paddingX||this.s.padding,n=this.s.paddingY||this.s.padding,a=this.s.cellWidth;a||(a=(this.$width-2*s+i)/this.s.gridColumns-i);
var r=this.s.cellHeight;return r||(r=(this.$height-2*n+i)/this.WG-i),t=Math.round(-.2+(t-s)/(a+i/2)),e=Math.round(-.2+(e-s)/(r+i/2)),t=Math.max(0,Math.min(t,this.s.gridColumns)),e=Math.max(0,Math.min(e,this.WG)),{x:t,y:e,width:a,height:r,margin:i,rx:t*a+i*t+s,ry:e*r+i*e+n}},$dragOut:function(){var t=webix.DragControl.Gd;
this.iH&&t.external&&(webix.html.remove(this.iH),this.iH=null)},$dragIn:function(t,e,i){var s=webix.DragControl.Gd;if(!this.iH){s.external=!0;var n=s.from.getItem(s.source);s.dashboard={dx:n.dx,dy:n.dy},this.hH(n.dx,n.dy)}if(s.external){var a=this.iH,r=webix.env.mouse.context(i),h=webix.html.offset(this.$view),o=this.jH(r.x-h.x,r.y-h.y);
webix.extend(s.dashboard,o,!0),a.style.left=o.rx+"px",a.style.top=o.ry+"px"}return!0},$dragPos:function(t,e,i){var s=webix.DragControl.Gd;i.style.left="-10000px";var n=webix.env.mouse.context(e),a=webix.html.offset(this.$view),r=s.dashboard,h=this.jH(n.x-a.x-r.sx,n.y-a.y-r.sy);t.x=n.x-r.sx-a.x,t.y=n.y-r.sy-a.y;
var o=this.iH;o.style.left=h.rx+"px",o.style.top=h.ry+"px",webix.extend(r,h,!0)}},webix.ui.gridlayout),webix.protoUI({name:"panel",$init:function(t){if(t.header&&t.body){var e=t.header;"object"!=typeof e&&(e={template:t.header,type:"header",css:"webix_header"}),t.body=[e,t.body]}webix.html.addCss(this.$view,"panel_drag_view"),
this.$ready.push(this.Py)},Py:function(){var t=this.getChildViews(),e=1===t.length?this:t[1];if(this.s.icon){var i=webix.html.create("div",{"class":"panel_icon"},"<span class='webix_icon "+webix.skin.icon+this.s.icon+" panel_icon_span'></span>");e!=this&&(e.$view.style.position="relative"),e.$view.appendChild(i);
}},body_setter:function(t){return this.rows_setter(webix.isArray(t)?t:[t])},$resizeEnd:function(t){var e=this.getParentView();if(e&&e.jH){var i=e.jH(t.x,t.y),s=(this.s,Math.max(i.x,1)),n=Math.max(i.y,1);e.moveView(this.s.id,{dx:s,dy:n})}},$resizeMove:function(t){var e=this.getParentView();if(e&&e.jH){
var i=e.jH(t.x,t.y);t.x=i.width*i.x+i.margin*(i.x-1),t.y=i.height*i.y+i.margin*(i.y-1)}}},webix.ui.layout,webix.ResizeArea),webix.protoUI({name:"video",$init:function(t){t.id||(t.id=webix.uid()),this.$ready.push(this.Ms)},Ms:function(){var t=this.s;if(this.w=webix.html.create("video",{"class":"webix_view_video",
style:"width:100%;height:100%;",autobuffer:"autobuffer"},""),t.poster&&(this.w.poster=t.poster),t.src){"object"!=typeof t.src&&(t.src=[t.src]);for(var e=0;e<t.src.length;e++)this.w.innerHTML+=' <source src="'+t.src[e]+'">'}t.controls&&(this.w.controls=!0),t.autoplay&&(this.w.autoplay=!0),this.x.appendChild(this.w);
},getVideo:function(){return this.w},defaults:{src:"",controls:!0}},webix.ui.view),webix.protoUI({name:"sidemenu",defaults:{animate:!0,position:"left",width:200,borderless:!0},$init:function(){this.$view.className+=" webix_sidemenu"},$skin:function(){this.defaults.padding=0},position_setter:function(t){
var e=this.s.position;return e&&webix.html.removeCss(this.$view," webix_sidemenu_"+e),webix.html.addCss(this.$view," webix_sidemenu_"+t),t},$getSize:function(){var t=webix.ui.window.prototype.$getSize.apply(this,arguments);return this.MA=t,t},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e),
t=this.bc-2*this.s.padding,e=this.dc-2*this.s.padding,this.w.style.padding=this.s.padding+"px",this.bd.style.display="none",this.ed.style.height=e+"px",this.gd.$setSize(t,e)},show:function(){return this.callEvent("onBeforeShow",arguments)?(this.s.hidden=!1,this.x.style.zIndex=this.s.zIndex||webix.ui.zIndex(),
(this.s.modal||this.my)&&(this.Md(!0),this.my=null),this.x.style.display="block",this.Qd(),this.s.position&&this.Td(),this.Ww=1,webix.delay(function(){this.Ww=0},this,[],webix.env.touch?400:100),this.config.autofocus&&(this.Vd=webix.UIManager.getFocus(),webix.UIManager.setFocus(this)),-1==webix.ui.et.find(this)&&webix.ui.et.push(this),
void this.callEvent("onShow",[])):!1},Td:function(t){var e,i,s,n,a,r=0,h=0,o={};this.$view.style.position="fixed",s=window.innerWidth||document.documentElement.offsetWidth,n=window.innerHeight||document.documentElement.offsetHeight,e=this.MA[0]||s,i=this.MA[2]||n,a=this.s.position,"top"==a?e=s:"right"==a?(i=n,
r=s-e):"bottom"==a?(e=s,h=n-i):i=n,o={left:r,top:h,width:e,height:i,maxWidth:s,maxHeight:n},"function"==typeof this.s.state&&this.s.state.call(this,o),this.NA=o,this.$setSize(o.width,o.height),"undefined"==typeof t&&this.OA()?(webix.html.removeCss(this.$view,"webix_animate",!0),this.Qf[this.s.position].beforeShow.call(this,o),
webix.delay(function(){webix.html.addCss(this.$view,"webix_animate",!0)},this,null,1),webix.delay(function(){this.Qf[this.s.position].show.call(this,o)},this,null,10)):("right"===this.s.position&&(o.left=o.right?s-o.width-o.right:s-o.width),this.setPosition(o.left,o.top))},OA:function(){return webix.animate.isSupported()&&this.s.animate&&!(webix.env.isIE&&-1!=navigator.appVersion.indexOf("MSIE 9"));
},hidden_setter:function(t){return t?this.hide(!0):this.show(),!!t},Qf:{left:{beforeShow:function(t){this.$view.style.left=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.left=t.left?t.left+"px":"0px"},hide:function(t){this.$view.style.left=-t.width+"px"}},right:{beforeShow:function(t){
this.$view.style.left="auto",this.$view.style.right=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.right=t.right?t.right+"px":"0px"},hide:function(t){this.$view.style.right=-t.width+"px"}},top:{beforeShow:function(t){this.setPosition(t.left,t.top),this.$view.style.height="0px",
this.ed.style.height="0px"},show:function(t){this.$view.style.height=t.height+"px",this.ed.style.height=t.height+"px"},hide:function(){this.$view.style.height="0px",this.ed.style.height="0px"}},bottom:{beforeShow:function(t){this.$view.style.left=t.left+"px",this.$view.style.top="auto";var e=t.bottom!=webix.undefined?t.bottom:t.maxHeight-t.top-t.height;
...
this.Vd=null)}this.ny()}}},webix.ui.popup),webix.protoUI({name:"sidebar",defaults:{titleHeight:40,type:"sideBar",activeTitle:!0,select:!0,scroll:!1,collapsed:!1,collapsedWidth:41,position:"left",width:250,mouseEventDelay:10},$init:function(t){this.$ready.push(this.AH),this.$ready.push(this.BH),this.data.qf=function(t){
t.data&&(t.menu=webix.copy(t.data))}},on_context:{},on_mouse_move:{},AH:function(){this.CH=this.config.width,this.attachEvent("onBeforeOpen",function(t){if(!this.config.multipleOpen)for(var e=this.getOpenItems(),i=0;i<e.length;i++)this.getParentId(t)==this.getParentId(e[i])&&this.close(e[i]);return!this.config.collapsed;
}),this.attachEvent("onItemClick",function(t,e,i){this.getPopup()&&!this.getPopup().config.hidden&&(e.showpopup=!0),webix.env.touch&&this.DH(t,i)}),this.attachEvent("onBeforeSelect",function(t){return this.getItem(t).$count?!1:(this.clearCss("webix_sidebar_selected"),!0)}),this.attachEvent("onAfterSelect",function(t){
this.EH(this,t,!0),this.getPopup().FH(t)}),this.attachEvent("onMouseMove",function(t,e,i){this.DH(t,i)}),this.config.collapsed&&this.collapse()},DH:function(t,e){if(this.config.collapsed){var i=this.getPopup();i&&(this.GH(t),this.HH(t),i.show(e,{x:"left"==this.config.position?this.config.collapsedWidth:-i.config.width,
y:-1}))}},GH:function(t){var e=this.getPopup(),i=e.getBody().getChildViews()[0];if(i){var s=this.getSelectedId();i.masterId=t,i.parse(this.getItem(t)),s&&this.getParentId(s)==t?webix.html.addCss(i.$view,"webix_sidebar_selected",!0):webix.html.removeCss(i.$view,"webix_sidebar_selected"),s==t?webix.html.addCss(i.$view,"webix_selected",!0):webix.html.removeCss(i.$view,"webix_selected");
}},HH:function(t){var e=this.getPopup(),i=e.getBody().getChildViews()[1];if(i){i.clearCss("webix_sidebar_selected"),i.masterId=t;var s=this.getSelectedId(),n=this.getItem(t).menu?webix.copy(this.getItem(t).menu):[].concat(webix.copy(this.data.getBranch(t)));i.unselect(),n.length?(i.show(),i.data.importData(n),
i.exists(s)?i.select(s):s&&this.EH(i,s)):i.hide()}},BH:function(){var t,e=this,i=e.config;if(i.popup&&(t=webix.$$(i.popup)),!t){var s="left"==i.position?"webix_sidebar_popup_left":"webix_sidebar_popup_right",n="left"==i.position?"right":"left",a=function(t){var e=t.submenu||t.data?'<div class="webix_icon '+webix.skin.icon+"angle-"+("left"==i.position?"right":"left")+'"></div>':"";
return e+t.value},r={view:"popup",css:"webix_sidebar_popup "+s,autofit:!1,width:this.CH-this.config.collapsedWidth,borderless:!0,padding:0,body:{rows:[{view:"template",borderless:!0,css:"webix_sidebar_popup_title",template:"#value#",height:this.config.titleHeight+2,onClick:{webix_template:function(){
var t=this.masterId;e.getItem(t).$count||e.select(t)}}},{view:"menu",submenu:"data",layout:"y",subMenuPos:n,select:!0,borderless:!0,autoheight:!0,css:"webix_sidebar_popup_list "+s,template:a,type:{subsign:!1},submenuConfig:{padding:0,subMenuPos:n,template:a,select:!0,type:{subsign:!1},css:"webix_sidebar_popup_list "+s,
on:{onShow:function(){this.clearCss("webix_sidebar_selected"),this.unselectAll();var t=e.getSelectedId();t&&this.exists(t)?this.select(t):t&&e.EH(this,t)},onBeforeSelect:function(t){return this.getSubMenu(t)?!1:void 0},onAfterSelect:function(t){for(var i=e.getPopup().queryView({view:"menu"}),s=e.getParentId(t);s;){
var n=i.getMenu(s);n&&(n.unselectAll(),e.EH(n,t)),s=e.getParentId(s)}e.EH(this,t)}}},on:{onBeforeSelect:function(t){return this.getSubMenu(t)?!1:void 0},onMenuItemClick:function(t){this.getSubMenu(t)||e.select(t)}}}]}};webix.extend(r,i.popup||{},!0),t=webix.ui(r),t.FH=function(t){e&&e.getParentId(t)==this.masterId&&webix.html.addCss(this.$view,"webix_sidebar_selected",!0),
e.config.collapsed&&1==e.getItem(t).$level&&webix.html.addCss(this.$view,"webix_selected",!0)},t.queryView({view:"menu"}).uH=!0}t.attachEvent("onBeforeShow",function(){return i.collapsed}),this.Ns=[t],i.popupId=t.config.id,webix.UE(document.body,"mousemove",function(e){var i=e.target||e.srcElement;t.config.hidden||t.$view.contains(i)||this.$view.firstChild.contains(i)||t.queryView({
view:"menu"}).dr||t.hide()},{bind:this})},EH:function(t,e,i){var s="webix_sidebar_selected";t.data.each(function(n){!this.IH(e,n.id)||i&&"0"!=this.getParentId(n.id)?t.hasCss(n.id,s)&&t.removeCss(n.id,s):t.addCss(n.id,s)},this)},IH:function(t,e){var i=this.getParentId(t);return e==i?!0:i?this.IH(i,e):!1;
...
this.closeAll(),this.type.collapsed=!0,webix.html.removeCss(this.$view,"webix_sidebar_expanded")):(e=this.CH,this.type.collapsed=!1,webix.html.addCss(this.$view,"webix_sidebar_expanded",!0)),this.define("width",e),this.resize(),t}},webix.ui.tree),webix.type(webix.ui.tree,{name:"sideBar",height:"auto",
...
}),t.ze=function(){}},ku:function(e){if(t.gu=this,clearTimeout(this.tu),!this.ou&&!t.qu){var i=webix.$$(e);if(!i||i.isEnabled()){var s;if(this.iu){var i=webix.$$(this.iu);if(!i)return;s=t.ju(i)}else s={dx:this.scrollWidth,dy:this.scrollHeight,px:this.clientWidth,py:this.clientHeight},s.ec=s.dx>s.px&&-1!=this.mu.indexOf("x"),
s.cc=s.dy>s.py&&-1!=this.mu.indexOf("y");this.ou=s,s.ec&&(s.uu=t.Om(this,"x",s.dx,s.px,"width","height"),s.vu=s.px-s.uu.offsetWidth-4,s.wu=s.dx-s.px,t.trackBar&&(s.wA=t.xA(this,"x"))),s.cc&&(s.xu=t.Om(this,"y",s.dy,s.py,"height","width"),s.yu=s.py-s.xu.offsetHeight-4,s.zu=s.dy-s.py,t.trackBar&&(s.yA=t.xA(this,"y"))),
t.sk(this)}}},xA:function(t,e){var i=webix.html.create("DIV",{webixignore:"1","class":"webix_c_scroll_bar_"+e},"");return t.appendChild(i),i},ru:function(e,i,s){var n=e.ou,a=e.iu;if(a&&(a=webix.$$(a)),n.uu==e.Au){var r=(s.x-i.x)*n.wu/n.vu;a?a.Zj.scrollTo(a.bk+r):t.Bu(e,"scrollLeft",r)}if(n.xu==e.Au){
var r=(s.y-i.y)*n.zu/n.yu;a?a.Wj.scrollTo(a.jk+r):t.Bu(e,"scrollTop",r)}e.su=s,t.sk(e)},ju:function(t){var e={};return t.Zj&&t.s.scrollX&&(e.dx=t.Zj.getSize(),e.px=t.Zj.Si||1,e.ec=e.dx-e.px>1),t.Wj&&t.s.scrollY&&(e.dy=t.Wj.getSize(),e.py=t.Wj.Si||1,e.cc=e.dy-e.py>1),e},lu:function(){clearTimeout(this.tu),
this.tu=webix.delay(t.pu,this,[],200)},Cu:function(t){t&&(webix.html.remove(t),t.Du&&(webix.eventRemove(t.Du),webix.eventRemove(t.Eu)))},pu:function(){if(this.ou){if(this.Au)return void(this.Fu=!0);var e=this.ou;t.Cu(e.uu),t.Cu(e.xu),webix.html.removeCss(document.body,"webix_noselect"),e.wA&&webix.html.remove(e.wA),
e.yA&&webix.html.remove(e.yA),this.ou=null}},nu:function(e){var i=this.ou,s=e.wheelDelta/-40,n=!0;if(!s&&e.detail&&webix.isUndefined(e.wheelDelta)&&(s=e.detail),i)if(i.uu&&(e.wheelDeltaX||s&&!i.xu)){var a=e.wheelDeltaX/-40||s;n=t.Bu(this,"scrollLeft",a*t.scrollStep)}else s&&i.xu&&(n=t.Bu(this,"scrollTop",s*t.scrollStep));
return t.sk(this),n!==!1?webix.html.preventEvent(e):void 0},Bu:function(e,i,s){var n=e.ou,a="scrollLeft"==i?n.dx-n.px:n.dy-n.py,r=e[i];return r+s>a&&(s=a-r),!s||0>r+s&&0===r?!1:(webix.env.isIE?(t.sk(e,i,s+r),e[i]+=s):e[i]+=s,!0)},Om:function(e,i,s,n,a,r){var h=webix.html.create("DIV",{webixignore:"1",
"class":"webix_c_scroll_"+i},"<div></div>");return h.style[a]=Math.max(n*n/s-7,40)+"px",e.style.position="relative",e.appendChild(h),e.Du=webix.event(h,"mousedown",t.Gu(e)),e.Eu=webix.event(document.body,"mouseup",webix.bind(t.Hu,e)),h},Gu:function(e){return function(i){webix.html.addCss(document.body,"webix_noselect",1),
this.className+=" webix_scroll_active",t.qu=e,e.Au=this,e.su=webix.html.pos(i)}},Hu:function(e){this.Au&&(webix.html.removeCss(document.body,"webix_noselect"),this.Au.className=this.Au.className.toString().replace(" webix_scroll_active",""),this.Au=!1,t.qu=0,this.Fu&&(t.pu.call(this),this.Fu=!1))},sk:function(t,e,i){
var s=t.ou;if(s&&(s.uu||s.xu)){var n=t.iu,a="scrollLeft"==e?i:t.scrollLeft,r=n?webix.$$(n).bk:a,h=n?0:r,o="scrollTop"==e?i:t.scrollTop,l=n?webix.$$(n).jk:o,c=n?0:l;s.uu&&(s.uu.style.bottom=1-c+"px",s.uu.style.left=Math.round(s.vu*r/(s.dx-s.px))+h+1+"px",s.wA&&(s.wA.style.bottom=1-c+"px",s.wA.style.left=h+"px")),
s.xu&&(s.xu.style.right=0-h+"px",s.xu.style.top=Math.round(s.yu*l/(s.dy-s.py))+c+1+"px",s.yA&&(s.yA.style.right=0-h+"px",s.yA.style.top=c+"px"))}},wE:function(e){e.data&&e.data.attachEvent&&e.data.attachEvent("onStoreUpdated",function(){var i=t.gu;i&&e.$view.contains(i)&&t.resize()})}}}(),webix.protoUI({
name:"portlet",defaults:{layoutType:"wide",icon:"bars"},$init:function(t){this.x.style.position="relative",t.header&&t.body&&(t.body=[{template:t.header,type:"header"},t.body]),this.$ready.push(this.Py),webix.attachEvent("onAfterPortletMove",this.xC)},xC:function(t){webix.ui.each(t,function(t){t.Ow&&t.Ow();
})},Py:function(){var t=this.getChildViews();if(t.length>1)webix.DragControl.addDrag(t[0].$view,this);else if(this.s.icon){var e=webix.html.create("div",{"class":"portlet_drag"},"<span class='webix_icon "+webix.skin.icon+this.s.icon+"'></span>");this.x.appendChild(e),webix.DragControl.addDrag(e,this);
}else webix.DragControl.addDrag(this.$view,this)},body_setter:function(t){return this.rows_setter(webix.isArray(t)?t:[t])},markDropArea:function(t,e){return t?(t=webix.$$(t),this.Qy||(this.Qy=webix.html.create("div",null,"&nbsp;")),t.$view.appendChild(this.Qy),void(this.Qy.className="portlet_marker"+e)):webix.html.remove(this.Qy);
},movePortlet:function(t,e){var i=t.getParentView(),s=this.getParentView(),n=i.index(t),a=s.index(this);if(webix.callEvent("onBeforePortletMove",[s,i,this,t,e])){webix.ui.PG=!0;var r=s!=i?1:0,h=i.mc;"top"==e||"bottom"==e?(1!==h&&(i=webix.ui({type:t.s.layoutType,rows:[]},i,n+r),webix.ui(t,i,0),n=0,r=1),
"bottom"==e&&(r+=1)):("left"==e||"right"==e)&&(0!==h&&(i=webix.ui({type:t.s.layoutType,cols:[]},i,n+r),webix.ui(t,i,0),n=0,r=1),"right"==e&&(r+=1)),n>a&&(r-=1),webix.ui(this,i,n+r),"replace"==e&&webix.ui(t,s,a),this.Ry(s),webix.ui.PG=!1;s.getTopParentView();t.resize(),s.resize(),webix.callEvent("onAfterPortletMove",[s,i,this,t,e]);
...
webix.html.remove(e),this.Sy&&(this.movePortlet(this.Sy,this.Ty),this.markDropArea(),this.Sy=null)},WB:function(){return webix.html.offset(this.$view)},$dragPos:function(t,e,i){i.style.left="-10000px";var s=webix.env.mouse.context(e),n=document.body.scrollTop||document.documentElement.scrollTop||0,a=document.body.scrollLeft||document.documentElement.scrollLeft||0,r=document.elementFromPoint(s.x-a,s.y-n),h=null;
r&&(h=webix.$$(r)),this.Sy=this.Uy(h),this.Ty=this.Vy(this.Sy,e),t.x=t.x-this.bc+10,t.y=t.y-20,webix.DragControl.Ed=!0},Vy:function(t,e){var i="",s="";if(e&&t){var n=webix.html.offset(t.$view),a=webix.html.pos(e),r=a.x-n.x-n.width/2,h=a.y-n.y-n.height/2;s=t.s.mode,s||(s=Math.abs(r)*(n.height/n.width)>Math.abs(h)?"cols":"rows"),
"cols"==s?i=r>=0?"right":"left":"rows"==s&&(i=h>=0?"bottom":"top"),this.markDropArea(t,i)}return this.markDropArea(t,i),i||s},Uy:function(t){for(;t;){if(t.movePortlet)return t;t=t.getParentView()}}},webix.ui.layout),webix.UIManager.getState=function(t,e){e=e||!1,t=webix.$$(t);var i={id:t.config.id,width:t.config.width,
...
n&&n.resize()},function(){function t(t,e){return webix.csv.stringify(t)}function e(t,e,i){return!i&&e.format?function(i){return e.format(i[t])}:function(e){return e[t]}}function i(t,i){var s=[],n=0,a=0,r=t.getColumnConfig,h=i.columns,o=!!i.rawValues;if(s.heights={},h){if(!h.length){var l=[];for(var c in h)l.push(webix.extend({
id:c},webix.extend({},h[c])));h=l}}else if(r)h=[].concat(t.fj);else{h=[];var u=t.data.pull[t.data.order[0]];for(var c in u)"id"!==c&&"$"!=c[0]&&h.push({id:c})}if(i.ignore)for(var d=h.length-1;d>=0;d--)i.ignore[h[d].id]&&h.splice(d,1);if(i.id&&s.push({id:"id",width:50,header:" ",template:function(t){return t.id;
...
}for(var g=0;g<h.length;g++){var v=h[g],c=v.id;if(!v.noExport){var m=o&&r,y=t.Aj[c];r&&(!v.template||y&&y.template==v.template||(m=!1),y&&(v=webix.extend(webix.extend({},v),y)));var $={id:v.id,template:m||!v.template?e(c,v,o):v.template,width:(v.width||200)*("excel"===i.export_mode?8.43/70:1),header:v.header!==!1?v.header||c:""
};"excel"===i.export_mode&&webix.extend($,{type:v.exportType||"",format:v.exportFormat||""}),"string"==typeof $.header?$.header=[{text:$.header}]:$.header=webix.copy($.header);for(var d=0;d<$.header.length;d++)$.header[d]=$.header[d]?$.header[d].contentId?"":$.header[d].text:"";if(n=Math.max(n,$.header.length),
t.s.footer){var _=v.footer||"";_="string"==typeof _?[{text:_}]:webix.copy(_);for(var d=0;d<_.length;d++)_[d]?_[d]=_[d].contentId?t.getHeaderContent(_[d].contentId).getValue():_[d].text:_[d]="";$.footer=_,a=Math.max(a,$.footer.length)}s.push($)}}for(var d=0;d<s.length;d++){for(var C=n-s[d].header.length,S=0;C>S;S++)s[d].header.push("");
if(t.s.footer){C=a-s[d].footer.length;for(var S=0;C>S;S++)s[d].footer.push("")}}return s}function s(t,e,i){var s,n,a=!!e.filterHTML,r=/<[^>]*>/gi,h=[];if("excel"===e.export_mode&&e.docHeader&&(h=[[(e.docHeader.text||e.docHeader).toString()],[""]],e.docHeader.height&&(i.heights[0]=e.docHeader.height)),
e.header!==!1&&i.length)for(var o=0;o<i[0].header.length;o++){n=[];for(var l=0;l<i.length;l++)s="",i[l].header[o]&&(s=i[l].header[o],a&&(s=i[l].header[o]=s.replace(r,""))),n.push(s);"excel"!=e.export_mode||!t.fj||e.heights===!1||t.Mt[o]===webix.skin.$active.barHeight&&"all"!=e.heights||(i.heights[h.length]=t.Mt[o]),
"pdf"!==e.export_mode&&(h[h.length]=n)}e.yCorrection=(e.yCorrection||0)-h.length;var c="TreeStore"==t.data.name,u=e.flatTree||e.plainOutput?"":" - ";if(t.data.each(function(s){if(!e.filter||e.filter(s)){for(var n=[],o=0;o<i.length;o++){var l=i[o],d=null;if(e.math&&s["$"+l.id]&&"="==s["$"+l.id].charAt(0)&&!s["$"+l.id].match(/^=(image|link|sparkline)\(/i)&&(d=s["$"+l.id]),
this.Rt){var f=this.getSpan(s.id,l.id);f&&f[4]&&f[0]==s.id&&f[1]==l.id&&(d=f[4],a&&"string"==typeof d&&(d=d.replace(r,"")))}d||(d=l.template(s,t.type,s[l.id],l,o),d||0===d||(d=""),a&&"string"==typeof d&&(c&&(d=d.replace(/<div class=.webix_tree_none.><\/div>/,u)),d=d.replace(r,"")),"string"==typeof d&&"csv"===e.export_mode&&(d=d.trim()),
...
e.footer!==!1)for(var d=i[0].footer?i[0].footer.length:0,f=0;d>f;f++){for(var b=[],l=0;l<i.length;l++){var p=i[l].footer[f];a&&(p=i[l].footer[f]=p.toString().replace(r,"")),b.push(p)}"excel"!=e.export_mode||!t.fj||e.heights===!1||t.Nt[f]===webix.skin.$active.barHeight&&"all"!=e.heights||(i.heights[h.length]=t.Nt[f]),
"pdf"!==e.export_mode&&h.push(b)}return"excel"===e.export_mode&&e.docFooter&&(h=h.concat([[],[(e.docFooter.text||e.docFooter).toString()]]),e.docFooter.height&&(i.heights[h.length-1]=e.docFooter.height)),h}function n(t){for(var e=[],i=0;i<t.length;i++)e.push({wch:t[i].width});return e}function a(t){return Math.round(25569+t/864e5);
}function r(t,e){var i=t.getColumnConfig,s=t.Rt,n=[];if(i){if(e.header!==!1&&(n=h(t,e,"header",n)),s){var a=e.xCorrection||0,r=e.yCorrection||0;for(var o in s){var l=s[o];for(var c in l){var u=t.getColumnIndex(c)-a,d=t.getIndexById(o)-r,f=u+l[c][0]-1,b=d+(l[c][1]-1);n.push({s:{c:u,r:d},e:{c:f,r:b}})}
}}e.footer!==!1&&(n=h(t,e,"footer",n))}return n}function h(t,e,i,s){for(var n=t.config.columns,a=(e.docHeader?2:0)+("header"==i?0:(e.header!==!1?t.Mt.length:0)+t.count()),r=0;r<n.length;r++)for(var h=n[r][i],o=0;o<h.length;o++)h[o]&&(h[o].colspan||h[o].rowspan)&&s.push({s:{c:r,r:o+a},e:{c:r+(h[o].colspan||1)-1,
r:o+(h[o].rowspan||1)-1+a}});return s}function o(t,e,i){return i[t]&&i[t][e]?i[t][e]:""}function l(t){for(var e in t)t[e]={hpx:t[e],hpt:.75*t[e]};return t}function c(t,e,i,s){for(var r={},h={s:{c:1e7,r:1e7},e:{c:0,r:0}},c=0;c!=t.length;++c)for(var u=0;u!=t[c].length;++u){h.s.r>c&&(h.s.r=c),h.s.c>u&&(h.s.c=u),
h.e.r<c&&(h.e.r=c),h.e.c<u&&(h.e.c=u);var d={v:t[c][u]};if(null!==d.v){var f=XLSX.utils.encode_cell({c:u,r:c});if(c>=e[0].header.length&&"="!=d.v.toString().charAt(0)){var b=e[u];b.type&&(d.t=p[b.type]||""),b.format&&(d.z=b.format)}d.v instanceof Date?(d.t=d.t||"n",d.z=d.z||XLSX.SSF[x][14],d.v=a(d.v)):d.t||("boolean"==typeof d.v?d.t="b":"number"==typeof d.v||d.v&&!isNaN(1*d.v)?(d.v=1*d.v,
d.t="n"):"="==d.v.charAt(0)?(d.t="n",d.f=d.v,delete d.v):d.t="s"),s&&(d.s=o(c,u,s)),r[f]=d}}return h.s.c<1e7&&(r["!ref"]=XLSX.utils.encode_range(h)),r["!rows"]=l(e.heights),r["!cols"]=n(e),i.length&&(r["!merges"]=i),r}function u(t){for(var e=new ArrayBuffer(t.length),i=new Uint8Array(e),s=0;s!=t.length;++s)i[s]=255&t.charCodeAt(s);
...
}for(var h=new pdfjs.Document({padding:40,font:i.hB,threshold:256,width:n,height:a}),o=i.header===!1?0:t[0].header.length,l=i.footer!==!1&&t[0].footer?t[0].footer.length:0,c=[],r=0;r<t.length;r++)c[r]=t[r].width;var u=webix.extend(i.table,{borderWidth:1,height:20,lineHeight:1.1,borderColor:15658734,backgroundColor:16777215,
color:6710886,textAlign:"left",paddingRight:10,paddingLeft:10,headerRows:o,widths:c.length?c:["100%"]}),d=h.table(u);if(o)for(var f=webix.extend(i.header,{borderRightColor:11587299,borderBottomColor:11587299,color:4868682,backgroundColor:13820911,height:27,lineHeight:1.2}),r=0;o>r;r++)for(var b=d.tr(f),p=0;p<t.length;p++)b.td(t[p].header[r].toString());
for(var x=0;x<e.length;x++)for(var w=d.tr({}),g=0;g<e[x].length;g++)w.td(e[x][g]);if(l)for(var v=webix.extend(i.footer,{borderRightColor:15658734,borderBottomColor:15658734,backgroundColor:16448250,color:6710886,height:27,lineHeight:1.2}),r=0;l>r;r++)for(var m=d.tr(v),p=0;p<t.length;p++)m.td(t[p].footer[r].toString());
...
s(a,i)});else{var _=h.render();s(_,i)}}var f="non-existing view for export";webix.toPNG=function(t,e){var i=webix.promise.defer();return webix.require(webix.cdn+"/extras/html2canvas.min.js").then(function(){"string"==typeof e&&(e={filename:e}),e=e||{};var s=webix.$$(t);if(s&&s.$exportView&&(s=s.$exportView(e)),
!s)return i.reject(f);var n=s?s.$view:webix.toNode(t),a=(e.filename||"Data")+".png";return window.html2canvas(n).then(function(t){var s=function(s){e.download!==!1&&webix.html.download(s,a),t.remove(),i.resolve(s)};t.msToBlob?s(t.msToBlob()):t.toBlob(s,"image/png")}),i})},webix.toExcel=function(t,e){
e=e||{},e.export_mode="excel",t=webix.isArray(t)?t:[t];for(var n=[],a=0;a<t.length;a++){var h=webix.$$(t[a]);if(h&&h.$exportView&&(h=h.$exportView(e)),h&&(n=n.concat(h)),e.dataOnly){var o=i(h,e);n[a]={scheme:o,exportData:s(h,e,o),spans:e.spans?r(h,e):[]}}}if(e.dataOnly)return n;var l=webix.promise.defer();
return webix.require(webix.cdn+"/extras/xlsx.core.styles.min.js").then(function(){if(!n.length)return l.reject(f);for(var t={SheetNames:[],Sheets:{},Workbook:{WBProps:{},Names:[]}},a=webix.isArray(e.sheets)?e.sheets:[e.name||"Data"],h=0;h<n.length;h++){var o=n[h].scheme||i(n[h],e),d=n[h].exportData||s(n[h],e,o),b=n[h].spans?n[h].spans:e.spans?r(n[h],e):[],p=n[h].ranges||[],x=n[h].styles||[],w=c(d,o,b,x),g=(a[h]||"Data"+h).replace(/[\*\?\:\[\]\\\/]/g,"").replace(/&/g,"&amp;").substring(0,31);
t.SheetNames.push(g),t.Sheets[g]=w,t.Workbook.Names=t.Workbook.Names.concat(p)}var v=XLSX.write(t,{bookType:"xlsx",bookSST:!1,type:"binary"}),m=(e.filename||a.join(","))+".xlsx",y=new Blob([u(v)],{type:"application/xlsx"});return e.download!==!1&&webix.html.download(y,m),l.resolve(y),l})},webix.toCSV=function(e,n){
...
};var b;webix.toPDF=function(t,e){var n=webix.promise.defer();return webix.require(webix.cdn+"/extras/pdfjs.js").then(function(){e=e||{};var a=webix.$$(t);if(a&&a.$exportView&&(a=a.$exportView(e)),!a)return n.reject(f);e.export_mode="pdf",e.hB=b,e.fontName=e.fontName||"pt-sans.regular";var r=i(a,e),h=s(a,e,r),o=function(t,e){
var i=(e.filename||"Data")+".pdf",s=new Blob([t.toString()],{type:"application/pdf"});e.download!==!1&&webix.html.download(s,i),n.resolve(s)};return e.hB?d(r,h,e,o):pdfjs.load(webix.cdn+"/extras/"+e.fontName+".ttf",function(t,i){if(t)throw t;b=e.hB=new pdfjs.TTFFont(i),d(r,h,e,o)}),n})};var p={number:"n",
date:"n",string:"s","boolean":"b"},x="_table"}(),webix.protoUI({name:"pdfviewer",defaults:{scale:"auto"},$init:function(t){this.$view.className+=" webix_pdf";var e=document.createElement("DIV");e.className="canvas_wrapper";var i=document.createElement("canvas");this.uz=this.$view,this.gt=this.$view.appendChild(e),
...
var e=this.data.driver.sheetToArray(this.zA.sheets[t],{spans:this.s.spans}),i=this.s.excelHeader,s="ABCDEFGHIJKLMNOPQRSTUVWXYZ",n={},a={};if(e.sizes)for(var r=0;r<e.sizes.length;r++)"column"==e.sizes[r][0]?n[e.sizes[r][1]]=Math.round(e.sizes[r][2]):"row"==e.sizes[r][0]&&(a[e.sizes[r][1]]=Math.round(e.sizes[r][2]));
if(i)if(i===!0){i=e.data.splice(0,1)[0];for(var r=0;r<i.length;r++)i[r]={header:i[r],id:"data"+r,width:n[r],adjust:!n[r],editor:"text",sort:"string"}}else i=webix.copy(i);else{i=webix.copy(e.data[0]);for(var r=0;r<i.length;r++)i[r]={header:s[r],id:"data"+r,width:n[r],adjust:!n[r],editor:"text",sort:"string"
}}this.config.columns=i,this.refreshColumns(),this.parse(e,this.s.datatype),this.IG=t;var h=this.eG(e.spans),o=this.JG(a),l=this.KG(e.styles,h);(h||o||l)&&this.refresh()},getSheets:function(){return this.zA.names},LG:function(t,e,i,s){for(var n=!1,a=0;a<t.length;a++)if(t[a][0]===e&&t[a][1]===i){t[a][5]=webix.html.createCss(this.MG(s)),
this.addSpan(t[a][0],t[a][1],t[a][2],t[a][3],t[a][4],t[a][5]),n=!0;break}return n},KG:function(t,e){var i=0;if(t&&t.length){for(var s=0;s<t.length;s++){var n=t[s][0]-(this.config.excelHeader?1:0);if(n>=0){var a=this.getIdByIndex(n);if(this.exists(a)){var r=this.getItem(a),h=this.columnId(t[s][1]);h&&(e.length&&this.LG(e,a,h,t[s][2])||(r.$cellCss=r.$cellCss||{},
r.$cellCss[h]=this.MG(t[s][2])),i++)}}}return i}return!1},NG:function(t){return t=t||"000000",8===t.length&&(t=t.substring(2)),"#"+t},MG:function(t){var e={};if(t.fill&&t.fill.fgColor&&(e["background-color"]=this.NG(t.fill.fgColor.rgb)),t.font){var i=t.font;i.name&&(e["font-family"]=i.name),i.sz&&(e["font-size"]=i.sz/.75+"px"),
...
t},sheetToArray:function(t,e){var i=[],s=[],n=[],a=[];if(t&&t["!ref"]){var r,h,o,l,c=XLS.utils.decode_range(t["!ref"]),u=c.s.c,d=c.s.r+(e.rows?e.rows[0]:0);for(r=c.s.r;r<=c.e.r;r++){var f=[];for(h=c.s.c;h<=c.e.c;h++)if(o=XLS.utils.encode_cell({r:r,c:h}),l=t[o]){var b="";b=e.math&&l.f?"="==l.f.charAt(0)?l.f:"="+l.f:"d"==l.t&&webix.isDate(l.v)?webix.i18n.dateFormatStr(l.v):l.v,
f.push(b),l.s&&n.push([r-d,h-u,l.s])}else f.push("");i.push(f)}if(t["!merges"])for(var p=t["!merges"],x=0;x<p.length;x++){var w=p[x].s,g=p[x].e;(!e.rows||w.r-d>=0&&g.r-d<=e.rows[1])&&s.push([w.r-d,w.c-u,g.c-w.c+1,g.r-w.r+1])}if(t["!cols"])for(var v=t["!cols"],x=0;x<v.length;x++)v[x]&&a.push(["column",x-u,Math.round(v[x].wch/(8.43/70))]);
if(t["!rows"])for(var m=t["!rows"],x=0;x<m.length;x++)m[x]&&a.push(["row",x-d,m[x].hpx])}return{data:i,spans:s,styles:n,sizes:a,excel:!0}},zB:function(t){var e=t.split("["),i={};if(i.name=e[0],e[1]){var s=e[1].split(/[^0-9]+/g);s[0]=1*s[0]||0,s[1]=1*s[1]||9999999,i.rows=s}return i}},webix.DataDriver.jsarray),
...
var e=this.getItem(t),i=this.s.headerHeight,s="<div class='webix_treemap_header' style='height:"+i+"px;line-height:"+i+"px;'>";return s+=this.type.header.call(this,e,this.type),s+="</div>"},_x:function(t){var e,i,s,n,a,r=[];if(!this.$width||!this.count())return this.v="",!1;if(t||(t=this.config.branch||0,
...
!isNaN(n)&&n))for(this.$values[t.id]=n,a+=n;e;)this.$values[e]||(this.$values[e]=0),this.$values[e]+=n,e=this.getParentId(e)},this,!1,t)),this.data.eachChild(t,function(t){this.$values[t.id]&&r.push(webix.copy(t))},this),a=a||this.$values[t],r.length&&a){i=this.$xy[t],s={top:i.top,left:i.left,dx:i.width,
dy:i.height,set:[],sum:0},s.dim=Math.min(s.dx,s.dy);var h=s.dx*s.dy/a;for(e=0;e<r.length;e++)r[e].$value=this.$values[r[e].id]*h;r.sort(function(t,e){return t.$value>e.$value?-1:1});for(var o=1/0,e=0;r[e];){var l=this.RA(s,r[e]);if(o>l)s.sum+=r[e].$value,s.set.push(r[e]),o=l,e++;else{this.SA(s);var c={
top:s.top,left:s.left,dx:s.dx,dy:s.dy,set:[],sum:0},h=s.sum/s.dim;s.dx>s.dy?(c.left+=h,c.dx-=h):(c.top+=h,c.dy-=h),s=c,s.dim=Math.min(s.dx,s.dy),o=1/0}}}s&&this.SA(s)},SA:function(t){var e,i,s,n,a=t.top,r=t.left;for(t.mode=t.dy<t.dx,t.contra=t.sum/t.dim,e=0;e<t.set.length;e++)i=t.set[e].id,t.mode?(s=t.contra,
n=t.set[e].$value/t.contra):(s=t.set[e].$value/t.contra,n=t.contra),this.$xy[i]={},this.$xy[i].top=a,this.$xy[i].left=r,t.mode?a+=n:r+=s,this.$xy[i].width=s,this.$xy[i].height=n,this.v+=this.pg(this.getItem(i)),this.s.subRender&&this.data.branch[i]&&this._x(i)},RA:function(t,e){var i=t.sum+e.$value,s=i*i/(t.dim*t.dim*e.$value);
...
n&&this.vC(s.name,{row:s.start.row,column:n},null)}else if(this.getColumnIndex(s.end.column)<0){var n=this.columnId(t-1);n&&this.vC(s.name,null,{row:s.end.row,column:n})}}},gC:function(t,e,i,s){var n,a,r,h,o,l,c,u;if(e){n=this.getColumnIndex(e.start.column),a=this.getColumnIndex(e.end.column),r=this.getIndexById(e.start.row),
h=this.getIndexById(e.end.row),o=this.getColumnIndex(t.column),l=this.getIndexById(t.row),c=this.getIndexById(e.init.row),u=this.getColumnIndex(e.init.column),n>o||"left"==i?"left"===i&&s.ctrl?(n=this.OG(c,n,i),a=u):"left"===i&&a>u?a--:n=o:(o>=a||"right"==i)&&("right"==i&&s.ctrl?(a=this.OG(c,a,i),n=u):"right"==i&&u>n?n++:a=o),
r>l||"up"==i?"up"==i&&s.ctrl?(r=this.OG(r,u,i),h=c):"up"==i&&h>c?h--:r=l:(l>h||"down"==i)&&("down"==i&&s.ctrl?(h=this.OG(h,u,i),r=c):"down"==i&&c>r?r++:h=l);var d={row:this.getIdByIndex(r),column:this.columnId(n)},f={row:this.getIdByIndex(h),column:this.columnId(a)};this.callEvent("onBeforeBlockSelect",[d,f,!0])&&(this.vC(e.name,d,f),
this.callEvent("onSelectChange",[]),this.callEvent("onAfterBlockSelect",[d,f]))}},OG:function(t,e,i){var s=this.config.columns,n=this.data.order,a=this.data.pull[n[t]],r=s[e].id,h=0;if("right"==i)for(var o=e+1;o<s.length;o++){if(a[s[o].id]){h=o;break}h=o}else if("left"==i){for(var o=e-1;o>=0;o--)if(a[s[o].id]){
h=o;break}}else if("down"==i)for(var o=t+1;o<n.length;o++){if(this.getItem(n[o])[r]){h=o;break}h=o}else if("up"==i)for(var o=t-1;o>=0;o--)if(this.getItem(n[o])[r]){h=o;break}return h},vC:function(t,e,i,s){var n=this.kB[t];if(!n)return!1;var a=webix.copy(n),r={start:e||n.start,end:i||n.end};this.oB(r),
webix.extend(n,r,!0),this.refreshSelectArea(),this.qH(a),s&&this.callEvent("onSelectChange",[])},areaselect_setter:function(t){return t&&(this.iB(),this.iB=function(){}),this.define("blockselect",t),t},addSelectArea:function(t,e,i,s,n,a){var r,h,o,l,c;r=this.getIndexById(t.row),h=this.getIndexById(e.row),
o=this.getColumnIndex(t.column),l=this.getColumnIndex(e.column),r>h&&(c=r,r=h,h=c),o>l&&(c=o,o=l,l=c),s=s||this.mB||webix.uid(),this.mB=null;var u={start:{row:this.getIdByIndex(r),column:this.columnId(o)},end:{row:this.getIdByIndex(h),column:this.columnId(l)}};return n&&(u.css=n),(a||a===!1)&&(u.handle=a),
...
},PC:function(){var t=webix.html.create("DIV");return t.className="webix_area_selection_layer",t.style.top=this.ck+"px",t},refreshSelectArea:function(){var t,e,i,s,n,a,r=null,h=null,o=null,l=this.s.prerender;if(this.wk){t=this.Xj(l),e=this.Sj(l===!0),this.rB||(this.rB=this.PC(),this.Vf.childNodes[1].appendChild(this.rB),
...
if(d.r0<=d.r1){if(this.s.topSplit&&n>=this.s.topSplit&&a<this.ak)return!1;c>f&&(h=this.SC(d.r0,f,d.r1,Math.min(b,c-1))),d.c0<=d.c1&&(r=this.SC(d.r0,d.c0,d.r1,d.c1)),u&&b>=this.Fj&&(o=this.SC(d.r0,Math.max(f,this.Fj),d.r1,b)),(h||r||o)&&this.sB(h,r,o,i,s.css,s.handle)}}else this.removeSelectArea(i)}}},
BD:function(t,e,i){var s,n,a,r,h=this.getIndexById(t.start.row),o=this.getIndexById(t.end.row),l=this.getColumnIndex(t.start.column),c=this.getColumnIndex(t.end.column);if(-1===l||-1===c)return null;if(-1===h||-1===o)return null;if(n=Math.min(i[1],o),this.s.topSplit){if(s=h,s>=this.s.topSplit&&(s=Math.max(i[0]-this.s.topSplit,h)),
n>=this.s.topSplit){var u=this.ug(this.getIdByIndex(o),t.end.column),d=this.ug(this.getIdByIndex(this.s.topSplit-1),t.end.column);d.top+d.height>u.top+u.height&&(n=this.s.topSplit-1)}}else s=Math.max(i[0],this.getIndexById(t.start.row));return a=Math.max(e[0],l),r=Math.min(this.Fj?e[1]-1:e[1],c),{r0:s,
r1:n,c0:a,c1:r}},SC:function(t,e,i,s){var n=this.ug(this.getIdByIndex(t),this.columnId(e)),a=this.ug(this.getIdByIndex(i),this.columnId(s));return[n,a]},sB:function(t,e,i,s,n,a){var r,h,o=this.kB[s],l=0;this.s.topSplit&&(l=this.zD(o.start,!0));var c=function(t,e,i,a,r){var h,o,c,u,d,f,b={top:1,right:1,
bottom:1,left:1};a&&delete b.left,r&&delete b.right,o=i.top-e.top+i.height-1,c=i.left-e.left+i.width;for(h in b){u=e.top+l,"bottom"==h&&(u=i.top+i.height),d=e.left,"right"==h&&(d=i.left+i.width),f="top"==h||"bottom"==h,t.appendChild(webix.html.create("DIV",{"class":"webix_area_selection webix_area_selection_"+h+(n?" "+n:""),
...
webix_area_name:s},"")),l&&h.height==l&&(r.lastChild.style.display="none"))},nB:function(t){if(t){var e=function(e){for(var i=e.childNodes,s=i.length-1;s>=0;s--)i[s].getAttribute("webix_area_name")==t&&e.removeChild(i[s])};e(this.rB),e(this.QC),e(this.RC)}},removeSelectArea:function(t){if(t&&this.kB[t]){
...
if(i&&-1!=i.indexOf("webix_area_selection_handle")){var s=e.getAttribute("webix_area_name");this.mB=s;var n=this.kB[s],a=this.ug(n.start.row,n.start.column),r=this.ug(n.end.row,n.end.column),h=this.s.prerender,o=this.getColumnIndex(n.start.column)<this.s.leftSplit?0:this.dk,l=this.getColumnIndex(n.end.column)<this.s.leftSplit?0:this.dk;
return this.ul=[a.left+1+o-this.bk,a.top+1-(h?this.jk:0),{row:n.start.row,column:n.start.column}],this.xl=webix.html.offset(this.Vf),this.Al(t),this.vl=[r.left+1+l-this.bk,r.top+1-(h?this.jk:0)],this.jz(!1,!1),webix.html.preventEvent(t)}},getSelectArea:function(t){return this.kB[t||this.qB]},getAllSelectAreas:function(){
return this.kB},oB:function(t,e){var i,s,n,a,r,h,o,l,c,u,d,f,b,p=!1,x=t.start,w=t.end;for(u=r=this.getIndexById(x.row),d=n=this.getColumnIndex(x.column),f=h=this.getIndexById(w.row),b=a=this.getColumnIndex(w.column),i=r;h>=i;i++){var g=this.getItem(this.getIdByIndex(i));if(g.$row&&!e)p=!0,b=this.fj.length-1;else if(this.config.spans)for(s=n;a>=s;s++)o=this.getSpan(this.getIdByIndex(i),this.columnId(s)),
...
s=this.SB(i)),this.JB.start=s,this.JB.sindex=i):(i<=this.JB.sindex&&(i=this.JB.sindex,s=this.SB(i)),this.JB.end=s,this.JB.eindex=i),this.LB=null}else if(this.MB&&this.MB.lx){var n=this.JB.sindex=this.RB(this.MB.lx-this.kp.x),a=this.JB.eindex=this.RB(this.MB.rx-this.kp.x);this.JB.start=this.SB(n),this.JB.end=this.SB(a),
...
on:{onAfterRender:function(){t.se=!0,webix.UE(t.getInputNode(),"blur",function(){t.CG(this.innerHTML)}),webix.UE(t.getInputNode(),"keyup",function(){t.KE()})}},onClick:{webix_richtext_editor:function(){t.KE()}}},i={view:"toolbar",id:"toolbar",elements:[this.IE("underline"),this.IE("bold"),this.IE("italic"),{}]
...
document.queryCommandState("italic")&&e.$$("italic").setValue(!0))}},refresh:function(){this.se&&(this.getInputNode().innerHTML=this.config.value)},LE:function(t,e){var i,s;if(window.getSelection()?(i=window.getSelection(),s=i.toString().length):(i=document.selection.createRange(),s=i.text.length),s>0)for(var n=0;n<i.rangeCount;++n){
...
},RE:function(t){var e=this.$width,i=.05,s=this.config.value;s=this.sF(s);var n=s-this.config.minRange,a=Math.round(180*n/(this.config.maxRange-this.config.minRange));(0===a||180===a)&&(this.PE.style.paddingTop="3px"),this.OE.style.transformOrigin=e/2-(.5+i)+"px 0 0",this.OE.setAttribute("y1","0"),this.OE.setAttribute("x1",Math.round(e*(.5+i))),
...
this.config.value=t,this.SE(),this.QE()},getValue:function(){return this.config.value}},webix.EventSystem,webix.ui.view),webix.protoUI({name:"bullet",defaults:{color:"#394646",marker:!1,layout:"x",barWidth:40,flowTime:500,labelWidth:150,minRange:0,maxRange:100,stroke:8,value:0,smoothFlow:!0,tickSize:10,
bands:[{value:100,color:"#5be5d6"},{value:80,color:"#fff07e"},{value:60,color:"#fd8b8c"}],scale:{step:10}},label_setter:webix.template,placeholder_setter:webix.template,$init:function(t){var e="undefined"!=typeof t.tickSize?t.tickSize:this.defaults.tickSize;t&&(t.layout&&"x"!==t.layout||t.height||(t.height=t.scale===!1?60:e?76+e:74),
"y"!==t.layout||t.width||(t.width=t.scale===!1?60:e?87+e:87))},scale_setter:function(t){return t.step=t.step||10,t.template=webix.template(t.template||"#value#"),t},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&(this.ME("y"===this.s.layout?e:t),(this.s.value||0===this.s.value)&&this.Qf(0,this.s.value));
...
this.FF!=this.s.value?this.GF=requestAnimationFrame(this.CF.bind(this)):(cancelAnimationFrame(this.GF),this.GF=null),this.HF.setAttribute("width",Math.floor(this.FF*this.JF)),this.HF.style.fill=this.xv()},Qf:function(t,e){this.EF=this.FF=t,this.s.value=this.JB=e,this.isVisible()===!0&&this.s.smoothFlow===!0&&window.requestAnimationFrame?this.GF||(this.GF=requestAnimationFrame(this.CF.bind(this))):(this.HF.setAttribute("width",Math.floor(e*this.JF)),
this.HF.style.fill=this.xv())},xv:function(){var t=this.s.color;return"function"==typeof t?t(this.JB):t},KF:function(t,e,i){for(var s=0;s<e.length;s++)t.setAttribute(e[s],i[s])},LF:function(t,e,i){var s="http://www.w3.org/2000/svg",n=document.createElementNS(s,t);return e&&this.KF(n,e,i),n},SF:function(t){
var e=this.LF(t[0],t[1],t[2]),i=t[3];if(i)for(var s=0;s<i.length;s++)e.appendChild(this.SF(i[s]));return e},MF:function(){var t="d"+webix.uid(),e=this.LF("svg",["class"],["webix_bullet_graph_svg"]),i=this.LF("g"),s=this.LF("g"),n=this.LF("rect",["x","y","width","height","class","style"],[this.IF,this.TF,100,this.s.stroke,"webix_bullet_value","filter:url(#"+t+");fill:"+this.xv()]),a=this.LF("rect",["x","y","width","height","fill"],[0,5,3,this.s.barWidth-10,"rgba(0,0,0,0.5)"]),r=this.LF("g",["stroke","stroke-width","fill"],["#8b94ac","2","none"]),h=this.LF("text",["text-anchor","stroke","fill"],["end","none","#8b94ac"]),o="y"==this.s.layout?"50%":this.IF-10,l="y"==this.s.layout?11:17,c=this.LF("tspan",["x","y","class"],[o,l,"webix_bullet_header"]),u=this.LF("tspan",["x","y","class"],[o,l+17,"webix_bullet_subheader"]),d=this.LF("text",["text-anchor","stroke","class","fill"],["middle","none","webix_bullet_scale","#8b94ac"]),f=this.SF(["filter",["id","x","y","width","height"],[t,"0","-150%","110%","400%"],[["feOffset",["in","dx","dy"],["SourceAlpha",0,0]],["feGaussianBlur",["stdDeviation"],["2"]],["feComponentTransfer",0,0,[["feFuncA",["type","slope"],["linear","0.5"]]]],["feMerge",0,0,[["feMergeNode"],["feMergeNode",["in"],["SourceGraphic"]]]]]]);
e.appendChild(f);var b=document.createElement("div");i.appendChild(s),this.s.marker!==!1&&(a.setAttribute("x",this.IF+this.sF(this.s.marker)*this.JF-2),i.appendChild(a)),i.appendChild(n),h.appendChild(c),h.appendChild(u),e.appendChild(h);var p="y"===this.s.layout,x=this.s.tickSize;if(this.s.scale){for(var w=this.IF,g=this.s.minRange;g<=this.s.maxRange;g+=this.s.scale.step){
var o=Math.floor(g*this.JF-(g?.1:-1)),v=p?(this.$width-this.s.barWidth)/2+(x?2-x:4):o+w,m=p?this.NF+w-o+6:this.s.barWidth+(x?16+x:14),y=p?-4:this.s.barWidth+3+x,$=p?"end":"middle",_=this.LF("tspan",["x","y","text-anchor"],[v,m,$]),C=this.LF("line",["x1","y1","x2","y2","stroke-width"],[o+w,y,o+w,y-x,1]);
b.innerHTML=this.s.scale.template({value:g}),_.appendChild(b.childNodes[0]),d.appendChild(_),r.appendChild(C)}i.appendChild(r),e.appendChild(d)}for(var g=0;g<this.s.bands.length;g++){var S=this.s.bands[g],k=this.LF("path"),n=this.sF(S.value)*this.JF;k.setAttribute("d","M "+this.IF+",0 l "+n+",0 l 0,"+this.s.barWidth+" l -"+n+",0 z"),
k.setAttribute("fill",S.color),s.appendChild(k)}if(e.appendChild(i),"y"===this.s.layout){var I=this.s.scale?this.$width/2-10:0,E=this.$height+this.IF-28;i.setAttribute("transform","translate("+I+", "+E+") rotate(270)"),h.setAttribute("text-anchor","middle"),h.childNodes[0].setAttribute("x","55%"),h.childNodes[1].setAttribute("x","55%"),
d.setAttribute("text-anchor","right")}return e.setAttribute("viewBox","0 0 "+this.$width+" "+this.$height),e},ME:function(t){t=t||("x"==this.s.layout?this.$width:this.$height);var e=this.$view;e.innerHTML="";var i=this.s,s=i.label&&i.label(i)||i.placeholder&&i.placeholder(i);this.IF=s?i.labelHeight||i.labelWidth:7,
this.TF=Math.floor((this.s.barWidth-this.s.stroke)/2),this.NF=t-this.IF-30,this.JF=this.NF/(this.s.maxRange-this.s.minRange);var n=this.MF();n.setAttribute("height",this.$height),n.setAttribute("width",this.$width),e.appendChild(n),this.HF=e.querySelector(".webix_bullet_value");var a=this.s.label;a&&(this.$view.querySelector(".webix_bullet_header").textContent=a(this.s));
var r=this.s.placeholder;r&&(this.$view.querySelector(".webix_bullet_subheader").textContent=r(this.s))},refresh:function(){this.ME(),this.Qf(this.JB,this.s.value)},setValue:function(t){this.s.value!=t&&this.Qf(this.s.value,t)},getValue:function(){return this.s.value}},webix.ui.view),webix.protoUI({name:"switch",
defaults:{template:function(t,e){e.JH();var i=t.name||"x"+webix.uid(),s="";t.labelRight&&(s="<label class='webix_label_right'>"+t.labelRight+"</label>",t.labelWidth&&(t.label=t.label||"&nbsp;"));var n=t.checkValue==t.value,a='aria-label="'+(t.label||t.labelRight||"")+'" role="checkbox" tabindex="0" aria-checked="'+(n?"true":"false")+'" '+(t.readonly?"aria-readonly='true'":"")+'"',r='<div class="webix_switch_box '+(n?" webix_switch_on":"")+'" style="width:'+e.KH+'px"><span class="webix_switch_text">'+((n?t.onLabel:t.offLabel)||"")+'</span><button class="webix_switch_handle" '+a+' style="left:'+(n?e.KH-e.LH:0)+'px;"><input  id="'+i+'" class="webix_switch_toggle" type="checkbox" '+(n?"checked":"")+"></button></div>"+s;
return e.$renderInput(t,r,i)}},$skin:function(){this.LH=webix.skin.$active.switchHeight,this.KH=webix.skin.$active.switchWidth},$setValue:function(t){var e=this.s,i=t==e.checkValue,s=this.$view.querySelector(".webix_switch_box");if(s){var n=s.childNodes[1],a=(i?e.onLabel:e.offLabel)||"";i?webix.html.addCss(s,"webix_switch_on"):webix.html.removeCss(s,"webix_switch_on"),
...
this.KH=Math.max(e,i)+this.LH}},on_click:{webix_switch_box:function(){this.s.readonly||this.toggle()},webix_label_right:function(){this.s.readonly||this.toggle()}}},webix.ui.checkbox),function(){function t(t){if(!t||Array.isArray(t))return t;var e="",i=0;for(var s in t){if(i++,2==i)return t;e=s}return t[e];
}webix.proxy.GraphQL={$proxy:!0,save:function(t){return this.load(t)},load:function(e,i,s){var s={query:this.source};return 1===arguments.length&&(s.variables=e,e=webix),webix.ajax().bind(e).headers({"Content-type":"application/json"}).post(this.url,s).then(function(s){var n=t(s.json().data);return i&&webix.ajax.$callback(e,i,"",n,-1),
n})}}}();
