...
import { backendFileWorkflowService } from '../../../assets/js/services/backend/BackendFileWorkflowService';

//import { dataExplorerImport } from '../../../assets/js/tabs/data-explorer/DataExplorerImport';

declare const webix: any;

@Component({
    selector: 'kosmos-datasources',
        ...
        this._filemanager = webix.ui({
            ...
            on: {
                ...
                onBeforeFileUpload: fileConfig => {
                    this.messageBox.message = ' ' + 'Please contact your system administrator for further help.';
                    this.messageBox.show();
                    backendFileWorkflowService.uploadExcelFile(fileConfig.file).then(f => {
                        console.log('File ', f);
                    });
                    //dataExplorerImport.loadFile(fileConfig);
