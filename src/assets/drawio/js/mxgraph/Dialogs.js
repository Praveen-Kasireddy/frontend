...
var ColorDialog = function(editorUi, color, apply, cancelFn) {
    ...
    // Changed style
    // 23.05.2018 KDEV_FMEXT
    cancelBtn.style.backgroundColor = '282C37';
    cancelBtn.style.color = 'ffffff';
    cancelBtn.style.cssFloat = 'left';
    // cancelBtn.style.textAlign = 'left';
    ...
    // Changed color
    // 23.05.2018 KDEV_FMEXT
    applyBtn.style.backgroundColor = '282C37';
...
var LayersWindow = function(editorUi, x, y, w, h) {
    ...
    function refresh() {
        ...
        removeLink.setAttribute(
            'title',
            mxResources.get('removeIt', [selectionLayer.value || mxResources.get('background')])
        );
        insertLink.setAttribute(
            'title',
            mxResources.get('moveSelectionTo', [selectionLayer.value || mxResources.get('background')])
        );
        duplicateLink.setAttribute(
            'title',
            mxResources.get('duplicateIt', [selectionLayer.value || mxResources.get('background')])
        );
        renameLink.setAttribute(
            'title',
            mxResources.get('renameIt', [selectionLayer.value || mxResources.get('background')])
        );
