	...
	(function()
	{
		...
		Graph.prototype.dblClick = function(evt, cell)
		{
			if (this.isEnabled())
			{
                ...
                // 04.05.2018 KDEV_CT
                // add check if generic container then open popup etc...
                if (cell.value.hasAttribute('GenericContainer'))
                {
                    console.log('Generic Container');
                    console.log('Value:' + cell.value.attributes['label'].nodeValue);
                } 
		...
		mxCellEditor.prototype.installListeners = function(elt)
		{
            ...
            mxEvent.addListener(this.textarea, 'keydown', mxUtils.bind(this, function(event)
				{
		...
		mxCellEditor.prototype.toggleViewMode = function()
		{
			...
			if (!this.codeViewMode)
			{
				...
				{
					content = mxUtils.replaceTrailingNewlines(content, '<p><br></p>');
				}
		...
		mxGraphHandler.prototype.updateHint = function(me)
		{
			if (this.shape != null)
			{
                ...
                // 06.06.2018 KDEV_CT
                // console.log('mxGraphHandler.prototype.updateHint = ' + this.hint.innerHTML);
			}
		};
		...
		mxVertexHandler.prototype.updateHint = function(me)
		{
			if (this.index != mxEvent.LABEL_HANDLE)
			{
                ...
                // 06.06.2018 KDEV_CT
                // console.log('mxVertexHandler.prototype.updateHint = ' + this.hint.innerHTML);
		...
		mxEdgeHandler.prototype.updateHint = function(me, point)
		{
            ...
            // 06.06.2018 KDEV_CT
            // console.log('mxEdgeHandler.prototype.updateHint = ' + this.hint.innerHTML);
